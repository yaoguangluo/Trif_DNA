 ...
 * */
public class X_ {
	//	public void P_Cache(String[] sets, List<IMV_SQI> output
	//			, String tableName, String baseName, IMV_SQI object) {}
	//
	//	//以后优化成统一对象输出, 不需要再转换。2019-1-15 tin
	//	IMV_SQI rowToRowMap(Row row) {}
	//
	//	public void P_Map(String[] sets, List<IMV_SQI> output, String dBTablePath) {}
	//	
	//	//plsql 引擎函数获取表开始检查 罗瑶光 20210405  
	//奇怪了 这是一个没有读 缓存的plsql引擎, 我准备对比下history
	//	//object 指令堆栈
	//	//output 数据行
	//	public void P_Table(String[] sets, List<IMV_SQI> output
	...
	//			, DetaBufferedReader reader, String DBTableRowIndexPath, List<IMV_SQI> output, Row bufferRow
	//			, IMV_SQI rowMap)  {}
