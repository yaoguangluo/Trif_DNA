...
//			BufferedImage bufferedImage= ImageIO.read(file);
			...
			String string= "�ϴ��ɹ������㷽ʽ: ��ͨ����ͳ�Ʒ�ʽ"
					...
					+"; ����������->"+ bc+ ", PCA��->"+ bc/maxc	+ "\r\n"
					+ "\r\n"
					+"; ��ʶ�����������->"+ rp+ ", PCA��->"+ rp/maxc+ ", ICA��->"+ rp/rc+ "\r\n"
					+"; ��ʶ������������->"+ gp+ ", PCA��->"+ gp/maxc+ ", ICA��->"+ gp/gc+ "\r\n"
					+"; ��ʶ������������->"+ bp+ ", PCA��->"+ bp/maxc+ ", ICA��->"+ bp/bc+ "\r\n"
					+ "\r\n"
					+"; �м�ֵ����������->"+ rs+ ", PCA��->"+ rs/maxc+ ", ICA��->"+ rs/rc+ "\r\n"
					+"; �м�ֵ����������->"+ gs+ ", PCA��->"+ gs/maxc+ ", ICA��->"+ gs/gc+ "\r\n"
					+"; �м�ֵ����������->"+ bs+ ", PCA��->"+ bs/maxc+ ", ICA��->"+ bs/bc+ "\r\n"
					+ "\r\n"
					+"; PCA����������->"+ rh+ ", PCA��->"+ rh/maxc+ ", ICA��->"+ rh/rs+ "\r\n"
					+"; PCA����������->"+ gh+ ", PCA��->"+ gh/maxc+ ", ICA��->"+ gh/gs+ "\r\n"
					+"; PCA����������->"+ bh+ ", PCA��->"+ bh/maxc+ ", ICA��->"+ bh/bs+ "\r\n"
					+ "\r\n"
					+"; ǿ�Һ���������->"+ rm+ ", PCA��->"+ rm/maxc+ ", ICA��->"+ rm/rh+ "\r\n"
					+"; ǿ������������->"+ gm+ ", PCA��->"+ gm/maxc+ ", ICA��->"+ gm/gh+ "\r\n"
					+"; ǿ������������->"+ bm+ ", PCA��->"+ bm/maxc+ ", ICA��->"+ bm/bh+ "\r\n"
					+ "\r\n"
					+"; ��ͨ����������->"+ bYellow+ ", PCA��->"+ bYellow/maxc+ "\r\n"
					+";  PCA����������->"+ bmYellow+ ", PCA��->"+ bmYellow/maxc+ ", ICA��->"+ bmYellow/bYellow+ "\r\n"
					+"; ǿ�һ���������->"+ blYellow+ ", PCA��->"+ blYellow/maxc + ", ICA��->"+ blYellow/bYellow;
