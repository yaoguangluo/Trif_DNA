 ...
 * */public class FileUploaderSimpleDNA {
	...
	public static void processPrefix(String string, byte[] bytesIn,
			FileImageOutputStream fileOutputStream, int contentSize) {// �ȶ���
																	  // ��ξͽ��к���ȥ�ص�ʱ�򣬰�sonar��û��ȥӢ�ض�����
																	  // ������
																	  // ����
		try {
...
//			BufferedImage bufferedImage= ImageIO.read(file);
			...
			String string = "�ϴ��ɹ������㷽ʽ: DNAʮ��Ԫ����ʴŨ�� 85%" + "\r\n"
					...
					+ "\r\n" + "; �����ظ�ʴ����->" + bc + ", PCA��->" + bc / maxc
					+ "\r\n" + "\r\n" + "; ��ʶ������ظ�ʴ����->" + rp
					+ ", PCA��->" + rp / maxc + ", ICA��->" + rp / rc + "\r\n"
					+ "; ��ʶ�������ظ�ʴ����->" + gp + ", PCA��->" + gp / maxc
					+ ", ICA��->" + gp / gc + "\r\n" + "; ��ʶ�������ظ�ʴ����->"
					+ bp + ", PCA��->" + bp / maxc + ", ICA��->" + bp / bc
					+ "\r\n" + "\r\n" + "; �м�ֵ�����ظ�ʴ����->" + rs
					+ ", PCA��->" + rs / maxc + ", ICA��->" + rs / rc + "\r\n"
					+ "; �м�ֵ�����ظ�ʴ����->" + gs + ", PCA��->" + gs / maxc
					+ ", ICA��->" + gs / gc + "\r\n" + "; �м�ֵ�����ظ�ʴ����->"
					+ bs + ", PCA��->" + bs / maxc + ", ICA��->" + bs / bc
					+ "\r\n" + "\r\n" + "; PCA�����ظ�ʴ����->" + rh + ", PCA��->"
					+ rh / maxc + ", ICA��->" + rh / rs + "\r\n"
					+ "; PCA�����ظ�ʴ����->" + gh + ", PCA��->" + gh / maxc
					+ ", ICA��->" + gh / gs + "\r\n" + "; PCA�����ظ�ʴ����->"
					+ bh + ", PCA��->" + bh / maxc + ", ICA��->" + bh / bs
					+ "\r\n" + "\r\n" + "; ǿ�Һ����ظ�ʴ����->" + rm + ", PCA��->"
					+ rm / maxc + ", ICA��->" + rm / rh + "\r\n"
					+ "; ǿ�������ظ�ʴ����->" + gm + ", PCA��->" + gm / maxc
					+ ", ICA��->" + gm / gh + "\r\n" + "; ǿ�������ظ�ʴ����->"
					+ bm + ", PCA��->" + bm / maxc + ", ICA��->" + bm / bh
					+ "\r\n" + "\r\n" + "; ��ͨ�����ظ�ʴ����->" + bYellow
					+ ", PCA��->" + bYellow / maxc + "\r\n"
					+ ";  PCA�����ظ�ʴ����->" + bmYellow + ", PCA��->"
					+ bmYellow / maxc + ", ICA��->" + bmYellow / bYellow
					+ "\r\n" + "; ǿ�һ����ظ�ʴ����->" + blYellow + ", PCA��->"
					+ blYellow / maxc + ", ICA��->" + blYellow / bYellow;
			...
			for (int j = 0; j < ps[0].length; j++) {
				...
				Here: for (int k = 0; k < IDUQ.length(); k++) {
					if (IDUQ.charAt(k) == 'U') {// g
						...
						continue Here;
					} else if (IDUQ.charAt(k) == 'A') {// A = V + S, �� = C + E
													   // = P, �� = V + S = A
						if (Math.random() * 100 < VECS) {
							OIQ[0][k] = 'P';
						} else {
						...
						continue Here;
					} else if (IDUQ.charAt(k) == 'O') {// O = E + S, ��= E + E =
													   // E , �� = V + S = A
						if (Math.random() * 100 < VECS) {
							OIQ[0][k] = 'E';
						} else {
						...
						continue Here;
					} else if (IDUQ.charAt(k) == 'P') {// P = E + C, �� = E + C
													   // = P, �� = S + V = A
						if (Math.random() * 100 < VECS) {
							OIQ[0][k] = 'P';
						} else {
						...
						continue Here;
					} else if (IDUQ.charAt(k) == 'M') {// M = C + S, �� = C + E
													   // = P, �� = V + S = A
						if (Math.random() * 100 < VECS) {
							OIQ[0][k] = 'P';
						} else {
						...
						continue Here;
					} else if (IDUQ.charAt(k) == 'F') {// F = E+ C + S, �� = H,
													   // �� = V
						if (Math.random() * 100 < VECS) {
							OIQ[0][k] = 'H';
						} else {
	...
	public static void newADNAMap(App app) {
