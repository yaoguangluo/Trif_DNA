...
//���ߣ� �����⣬���������java sound ���߲��� stackover flows��java sound ��������
//������з��ġ���������Ȩ�˾����ˡ�
/*
 * ����Ȩ�� ������ ������, ���
 ...
 * ����ʡ ����� ����ֵ� ���������� ������·һ��208�� �����԰����С�� ��ʮ��
 * */public class SoundWaveVectorMp3 implements Runnable{
	...
	public Vector getVectorLines(AudioInputStream ais, float sFrameRate){
		...
		audioBytes=null;
		int frameSize= -1 == af.getFrameSize()? 4: af.getFrameSize();
		if (audioBytes == null) {
			try {
				int reg=0;
				audioBytes = new byte[(int) (sFrameRate * frameSize)];
				System.out.flush();System.out.println("audiobyte length:"+audioBytes.length);
				...
				System.out.flush();System.out.println(reg);
			} catch (Exception ex) { 
		...
		int w = d.width;
		int h = d.height-15;
		int sampleSizeInBits= -1== af.getSampleSizeInBits()? 8: af.getSampleSizeInBits();
	...
	public Vector getVectorLines1(AudioInputStream ais) {
		...
		System.out.flush();System.out.println("good1");
		//lvbo
		...
		System.out.flush();System.out.println("good2");
		//xianfu
		...
		System.out.flush();System.out.println("good3");
		return lines;
	}
