...
//����Ȩ�ˣ����ߣ�������
//�Ժ��һ�˼��������ȼ���Ȼ��vpc standard���� �̳�ģʽ��չ��������Ի�ʹ�á�
/*
 * ����Ȩ�� ������ ������, ���
	 ...
	 public static String forward(String string, Map<String, String> data)
		 ...
		 if(string.equalsIgnoreCase("/register")){
			 return VtoV.ObjectToJsonString(RestLoginPortImpl.register(data.get("uEmail")
					 , data.get("uEmailEnsure"), data.get("uName"), data.get("uPassword")
					 , data.get("uPassWDEnsure"), data.get("uAddress"), data.get("uPhone")
					 , data.get("uWeChat"), data.get("uQq"), data.get("uAge")
					 , data.get("uSex")));
		 }
		 if(string.equalsIgnoreCase("/change")){
			 return VtoV.ObjectToJsonString(RestLoginPortImpl.change(data.get("uEmail")
					 , data.get("uChange"), data.get("uChangeEnsure"), data.get("uToken")
					 , data.get("uPassword")));
		 }
		 ...
		 if(string.equalsIgnoreCase("/ask")){
			 return VtoV.ObjectToJsonString(RestAskPortImpl.ask(data.get("ip")
					 , data.get("token"), data.get("message"), data.get("pointIp")));
		 }
		 if(string.equalsIgnoreCase("/feedBack")){
			 return VtoV.ObjectToJsonString(RestAskPortImpl.feedBack(data.get("ip")
					 , data.get("token"), data.get("pointIp")));
		 }
		 ...
		 if(string.equalsIgnoreCase("/dataYL")){
			 System.out.flush();System.out.println(System.currentTimeMillis());
			 System.out.flush();System.out.println("2huaruiji->"+data.get("email"));
			 System.out.flush();System.out.println("2huaruiji->"+data.get("token"));
			 if(null==data.get("token")||null==data.get("email")) {
				 return "";
			 }
			 return RestAskPortImpl.dataYL(data.get("message"), data.get("email")
					 , data.get("token"));
		 }	
