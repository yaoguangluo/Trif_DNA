...
//		}
        ...
        if (string.equalsIgnoreCase("/execDetaPLSQL")) {
            return VtoV.ObjectToJsonString(RestDBPLSQL_E.restDBPLSQLImpl(data.getString("token")
                , data.getString("email"), data.getString("password")
                , data.getString("auth"), data.getString("LYGQuery")
                , data.getString("mod")));
        }
        ...
        if (string.equalsIgnoreCase("/login")) {
            ...
            return VtoV.ObjectToJsonString(RestLoginPort_E.loginDB(data.getString("uEmail")
        ...
        if (string.equalsIgnoreCase("/register")) {
            return VtoV.ObjectToJsonString(RestLoginPort_E.registerDB(data.getString("uEmail")
