 ...
 * */
public class WavePlayOSU_MSQ_OPE_OPC_ECI extends OSU_OPE_OPC_ECI {

    public int value = 0;
    public String filepath;
    Jp jj;

    public WavePlayOSU_MSQ_OPE_OPC_ECI() {
    }

    public void run(final WavePlayOSU_MSQ_AVQ_ASQ_OVQ_OSQ_VSQ
                        _SQ__OVQ_OSQ_VSQ) {
        jj = new Jp(toplygin);
