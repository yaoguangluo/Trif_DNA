...
public class Jpm extends Panel {
    ...
    public class Jpl extends Panel {
        ...
        public void paint(Graphics g) {
            ...
            for (int i = 0; i < N - 1; i++) {
                g2.drawLine(i, (int) ((p[i].real - p[i].image) / 4) + 200
                    , i + 1, (int) ((p[i + 1].real - p[i + 1].image) / 4) + 200);
            }
            c = 0;
            cp[] o = new cp[N * 2];
            ...
            for (int i = 0; i < N - 1; i++) {
                g2.drawLine(i, 500, i
                    , (int) (Math.sqrt(f[i].real * f[i].real
                        + f[i].image * f[i].image) / 3000) + 500);
            }
        }
    }
