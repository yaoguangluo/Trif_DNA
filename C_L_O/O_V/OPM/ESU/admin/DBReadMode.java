...
public class DBReadMode {
	...
	public static void readDBInTXTWay(App_S app, App NE) {
		...
		try {
			...
			app.dic_index = new ZhongYaoDictionaryFromDB()
					.mapToIndex(app.dic_map);
			...
			ObjectCombination.mapCombination(app.dic_xz,
					d.mapToMap_xz(app.dic_map));
			ObjectCombination.mapCombination(app.dic_ya,
					d.mapToMap_ya(app.dic_map));
			ObjectCombination.mapCombination(app.dic_jm,
					d.mapToMap_jm(app.dic_map));
			ObjectCombination.mapCombination(app.dic_xw,
					d.mapToMap_xw(app.dic_map));
			ObjectCombination.mapCombination(app.dic_cy,
					d.mapToMap_cy(app.dic_map));
			ObjectCombination.mapCombination(app.dic_jj,
					d.mapToMap_jj(app.dic_map));
			ObjectCombination.mapCombination(app.dic_zf,
					d.mapToMap_zf(app.dic_map));
			ObjectCombination.mapCombination(app.dic_cj,
					d.mapToMap_cj(app.dic_map));
			ObjectCombination.mapCombination(app.dic_yl,
					d.mapToMap_yl(app.dic_map, app.dic_xw, app.dic_li,
							app.dic_xz, app.dic_jm));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
