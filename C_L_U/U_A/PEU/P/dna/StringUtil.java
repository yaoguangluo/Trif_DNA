...
public class StringUtil {
	public static String encode(String input) {
		String result = null;
		try {
			result = new String(Base64.getEncoder().encode(input
				.getBytes("utf-8")));
	...
	public static String EncoderByMd5(String salt, String pwd,
		int enctimes) throws NoSuchAlgorithmException,
	...
	public static String EncoderByDNA(String key, String uPassword,
		Token token) {
