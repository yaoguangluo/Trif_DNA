...
public class TableSorterZYNK extends AbstractTableModel {
    ...
    //拼音笔画 static 化 用于其他用途 20211002 罗瑶光
    public Map<String, String> pinYin = null;
    public Map<String, Integer> biHua = null;
    ...
    public TableSorterZYNK(App NE) {
        ...
        biHua = ReadPinYinBihua.biHua;
        pinYin = ReadPinYinBihua.pinYin;
        this.mouseListener = new MouseHandler();
        this.tableModelListener = new TableModelHandler();
        this.mouseListener = new MouseHandler();
        this.tableModelListener = new TableModelHandler();
    }
    public TableSorterZYNK(TableModel tableModel, App NE) {
        this(NE);
        setTableModel(tableModel);
    }
    public TableSorterZYNK(TableModel tableModel, JTableHeader tableHeader, App NE) {
        this(NE);
                        ...
                        if (tableName.contains("zybc")) {
                            int returnInt = new LYG10D13D_X_CAS()
                                    .quick4DChineseStringArrayWithSmallInTwoChar3bihuaReturns(new String[]
                                                    {o1.toString().substring(0, o1.toString().length() > 30
                                                            ? 30 : o1.toString().length())
                                                            , o2.toString().substring(0, o2.toString().length() > 30
                                                            ? 30 : o2.toString().length())}
