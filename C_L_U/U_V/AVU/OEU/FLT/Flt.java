...
//
//import I_A.IMS.EUQ.SP.SoundWaveJPanel;
//import I_A.IMS.EUQ.SP.SoundWavePanelVector;
//import U_A.PEU.P.wave.DFT;
//import U_A.PEU.P.wave.copy.Copy_X_copy1d;
//import U_A.PEU.P.wave.maxAndMin.MaxAndMin_X_max_v;
//import U_A.PEU.P.wave.peakStatistic.PeakStatistic_X_fengPaiyY;
//import U_A.PEU.P.wave.peakStatistic.PeakStatistic_X_fengTong1;
//import U_A.PEU.P.wave.proportion.Proportion_X_newX;
//import U_A.PEU.P.wave.proportion.Proportion_X_newXY;
//import U_A.PEU.P.wave.proportion.Proportion_X_newXYBest;
//import U_A.PEU.P.wave.proportion.Proportion_X_newY;
//import U_A.PEU.P.wave.proportion.Proportion_X_newYwithoutBound;
//import U_A.PEU.P.wave.quantification.Quantification_X_liangHuaEqualDelete;
//import U_A.PEU.P.wave.quantification.Quantification_X_liangHuaXiHua; 
//作者： 罗瑶光, 浏阳,
/*
 * 著作权人, 作者 罗瑶光, 浏阳
...
//
//public String clt4(DFT dFT, Vector<Double> lines, SoundWaveJPanel jpt, SoundWavePanelVector jp3
//		, Vector<Double> mlines1,
...
//		Vector<Double> mlines12, int N, double[] [] cos, double[] [] sin, double[]  newdata
//		, double[]  fdata1,
//		Map<String, String> cache_bz, Map<String, String> cache_sj,
//		Vector<Double> forOutput, Graphics graphics, int type)  {
//	double[]  newdata1= newdata;
//	newdata1= U_A.PEU.P.wave.Median.median1d(newdata1, 0);
//	double bili[]= Proportion_X_newYwithoutBound.newYwithoutBound(newdata1, 0.002);
//	double max= MaxAndMin_X_max_v.max_v(bili);
//	double bili0[]= bili;
//	if(max>= 2&& 0== type) {
//		bili0=  Proportion_X_newXYBest.newXYBest(bili0, 1024, 65);
//		bili0= new U_A.PEU.P.wave.Guassian().guassian1d(bili0, 1.6);
//		lines.clear();
...
//	}else if(1== type) {
//		bili0=  Proportion_X_newXY.newXY(bili0, 1024, 100);
...
//	double bili1[]= dft3;
//	double caijian2[]= U_A.PEU.P.wave.Tailor.caiJian1(dft3, 0, dft3.length>> 4);//64
//	//二次傅里叶
//	if(type== 0) {
//		bili1=  Proportion_X_newXY.newXY(caijian2, 256, 100);
//	}else {
//		bili1=  Proportion_X_newXY.newXY(bili1, 1024, 100);
//	}
...
//	} 
//	jp3.paint1(mlines1);
//	double bili2 []= Proportion_X_newXYBest.newXYBest(caijian2, 256, 100);
//	mlines2.clear();
...
//	jp3.paint2(mlines2);
//	//3
//	double guassian3[]= U_A.PEU.P.wave.Median.median1d(bili2, 3);
//	guassian3= new U_A.PEU.P.wave.Guassian().guassian1d(guassian3, 1.6);
//	guassian3= new U_A.PEU.P.wave.Guassian().guassian1d(guassian3, 1.6);
//	double bili3[]=  Proportion_X_newXY.newXY(guassian3, 256, 100);
//	mlines3.clear();
...
//	jp3.paint3(mlines3);
//	//lianghua4
//	double xihua4[]= Quantification_X_liangHuaXiHua.liangHuaXiHua(bili3, 2);
//	mlines4.clear();
...
//	jp3.paint4(mlines4);
//	//5 shehold
//	double shehold5[]=U_A.PEU.P.wave.Shehold.shehold1(xihua4, 25);
//	mlines5.clear();
...
//	double bili_sample[]= Proportion_X_newX.newX(caijian, 32);
//	for(int i= 0; i< bili_sample.length; i++) {
//		sample[i]= bili_sample[i];
//		sample[1024-i-1]= bili_sample[i];
//	}
//	double dft2[]= dFT.ft(sample);
//	dft2=  Copy_X_copy1d.copy1d(dft2, 512);
//	double bili7 []=  Proportion_X_newXYBest.newXYBest(dft2, 256, 100);
//	mlines7.clear();
...
//	jp3.paint7(mlines7);
//	//8 gaosi 
//	double guassian7[]= U_A.PEU.P.wave.Median.median1d(bili7, 0);
//	guassian7= new U_A.PEU.P.wave.Guassian().guassian1d(guassian7, 1.6);
//	mlines8.clear();
...
//	jp3.paint7(mlines8);
//	//8 bili
//	double sihua8[]= Quantification_X_liangHuaXiHua.liangHuaXiHua(guassian7, 2);
...
//		return "";
//	}
//	double bili8[]= U_A.PEU.P.wave.Tailor.caiJian1(guassian7, 0 , r);
//	bili8=  Proportion_X_newXYBest.newXYBest(bili8, 256, 100);
//	mlines8.clear();
...
//	jp3.paint8(mlines8);
//	//9 final
//	double xihua9[]=  Quantification_X_liangHuaXiHua.liangHuaXiHua(bili8, 2);
//	mlines9.clear();
...
//	jp3.paint9(mlines9);
//	//10 shehold
//	double she10[]= U_A.PEU.P.wave.Shehold.shehold1(xihua9, 15);
//	mlines10.clear();
...
//	//gaosi
//	double median11[]= new U_A.PEU.P.wave.Guassian().guassian1d(she10, 1.6);
//	median11=  Proportion_X_newY.newY(median11, 100);
//	mlines11.clear();
