...
//	= new App().getClass().getResourceAsStream(S_File.poscc_lyg);
////    		DetaBufferedReader cReaderc
//	= new DetaBufferedReader(DetaInputStreamReader.E(inputStreamc, "UTF8"));
////    		InputStream inputStreamp
//	= new App().getClass().getResourceAsStream(S_File.poscp_lyg);
////    		DetaBufferedReader cReaderp
//	= new DetaBufferedReader(DetaInputStreamReader.E(inputStreamp, "UTF8"));
////    		//index
...
////    							&&!cInputStringc.contains("数字")
//	&&!cInputStringc.contains("数词")) {
...
////    		strings[0]="dh罗韵律";
////
////    		LYG9DWithChineseMixStringSort9D lYG9DWithChineseMixStringSort9D
//		= new LYG9DWithChineseMixStringSort9D();
