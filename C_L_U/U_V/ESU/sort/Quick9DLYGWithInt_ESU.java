...
public class Quick9DLYGWithInt_ESU extends Quick_7D_luoyaoguang_Sort {
    ...
    //增加了deep
    private void processInt(int[] array, int leftPoint, int rightPoint, int[] sa
        , int deep) {
    ...
    private int partition(int[] array, int leftPoint, int rightPoint, int[] sa) {
        int x = array[leftPoint] <= array[rightPoint] ? array[leftPoint] : array[rightPoint];
        int xString = array[leftPoint] <= array[rightPoint] ? sa[leftPoint] : sa[rightPoint];
