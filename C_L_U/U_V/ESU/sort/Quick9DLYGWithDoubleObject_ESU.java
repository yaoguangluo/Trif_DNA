 ...
 * */
public class Quick9DLYGWithDoubleObject_ESU extends Quick_7D_luoyaoguang_Sort {
    public double[] sort(double[] a, Object[] sa) {
        processDouble(a, 0, a.length - 1, sa, 0);
        return a;
    }

    //增加了deep
    private void processDouble(double[] array, int leftPoint, int rightPoint, Object[] sa
        , int deep) {
    ...
    private int partition(double[] array, int leftPoint, int rightPoint, Object[] sa) {
