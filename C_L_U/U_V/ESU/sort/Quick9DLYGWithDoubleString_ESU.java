 ...
 * */
public class Quick9DLYGWithDoubleString_ESU extends Quick_7D_luoyaoguang_Sort {
    public double[] sort(double[] a, String[] sa) {
        processDouble(a, 0, a.length - 1, sa, 0);
        return a;
    }

    //增加了deep
    private void processDouble(double[] array, int leftPoint, int rightPoint, String[] sa
        , int deep) {
    ...
    private int partition(double[] array, int leftPoint, int rightPoint, String[] sa) {
