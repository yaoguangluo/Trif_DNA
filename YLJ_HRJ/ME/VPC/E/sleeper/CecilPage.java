...
public class CecilPage extends CecilPage_X_S_sListeners {
	...
	public JTextPane data(App NE) throws InterruptedException, IOException {
		...
		buttonPrev = Page_X_S_sButtonsrollback.data_X_rollback(this, 2000, NE);
		buttonNext = Page_X_S_sButtonsrollafter.data_X_rollafter(this, 2000,
				NE);
