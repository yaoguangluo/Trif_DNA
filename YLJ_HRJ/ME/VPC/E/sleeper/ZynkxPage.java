...
*  208号 阳光家园别墅小区 第十栋别墅
 * */
public class ZynkxPage extends ZynkxPage_X_S_sListeners {
    
    public ZynkxPage(JTextPane text, App NE) {
        initPage(text, NE);
        this.setLayout(null);
...
//                , 740, 0, 100, 30, 2000);
        ...
        buttonFJJJ.addActionListener(e -> {
            try {
                int column = 4;
                if (table.getValueAt(row, column).toString().isEmpty()) {
                    column = 3;
                }
                app_S.coAuthorForWord.bootZynkJFlowerForest(
                    table.getValueAt(row, 2).toString()
                    , table.getValueAt(row, column).toString(), true, NE);
...
//163
//���������ע�͵�, ������操作, �Ժ��һ��ÿ�����������tab���������ر��������. ������20210502
//		//�ұ�������URLencoderת����, �Ͳ���Ҫ��@��ʶ@�ˡ��Ժ���¡������Ҵ�TIN god��ʶ��
//				buttonZYFJ= new DetaButton("������ҽ����");
...
//		"culumnValue:ID:"+ table.getValueAt(i, 0).toString()
//.replace(":", "@Tin@")+ ";"+
//		"culumnValue:���:"+ table.getValueAt(i, 1).toString()
//.replace(":", "@Tin@")+ ";"+
//		"culumnValue:��֢ҩ��:"+ new FullDNATokenPDI().initonSect(table.getValueAt(i, 2)
//		.toString()
//.replace(":", "@Tin@"))+ ";"+
////		"culumnValue:��ҩ�ο�:"+ new FullDNATokenPDI().initonSect(table.getValueAt(i, 3)
////		.toString()
//.replace(":", "@Tin@"))+ ";"+
////		"culumnValue:���˴���:"+ new FullDNATokenPDI().initonSect(table.getValueAt(i, 4)
////		.toString()
//.replace(":", "@Tin@"))+ ";"+
////		"culumnValue:��֢:"+ new FullDNATokenPDI().initonSect(table.getValueAt(i, 5)
////		.toString()
//.replace(":", "@Tin@"))+ ";"+
////		"culumnValue:�Ʒ�:"+ new FullDNATokenPDI().initonSect(table.getValueAt(i, 6)
////		.toString()
//.replace(":", "@Tin@"))+ ";"+
////		"culumnValue:Ӧ��:"+ new FullDNATokenPDI().initonSect(table.getValueAt(i, 7)
////		.toString()
//.replace(":", "@Tin@"))+ ";"+
////		"culumnValue:ʹ��:"+ new FullDNATokenPDI().initonSect(table.getValueAt(i, 8)
////		.toString()
//.replace(":", "@Tin@"))+ ";"+
////		"culumnValue:����:"+ new FullDNATokenPDI().initonSect(table.getValueAt(i, 9)
////		.toString()
//.replace(":", "@Tin@"))+ ";"+
////		"culumnValue:����:"+ new FullDNATokenPDI().initonSect(table.getValueAt(i, 10)
////		.toString()
//.replace(":", "@Tin@"))+ ";"+
////		"culumnValue:����:"+ new FullDNATokenPDI().initonSect(table.getValueAt(i, 11)
////		.toString()
//.replace(":", "@Tin@"))+ ";";
////try {
//	if(table.getValueAt(i, 2).toString().contains("����")) {
//		continue Here;
//	}
