...
*  208号 阳光家园别墅小区 第十栋别墅
 * */
public class JzkxPage extends JzkxPage_X_S_sListeners {
    

    public JzkxPage(JTextPane text, App NE) {
        initPage(text, NE);
        this.setLayout(null);
...
//                , 740, 0, 100, 30, 2000);
        ...
        buttonBox.setBounds(155, 370, 1170, 20);
        this.add(buttonBox);
        return data;
    }
