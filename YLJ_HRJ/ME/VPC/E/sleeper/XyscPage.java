...
//                , 740, 0, 100, 30, 2000);
        ...
        buttonKSLJ.addActionListener(e -> {
            ...
            AppButtonUtil_X_DNN_Page.pageDNN(page, sets, currentPage
                , app_S, table, row, key, buttonSum, buttonCrt
                , data, statistic, "中药", NE);
        });
        ...
        buttonBCJ.addActionListener(e -> {
            ...
            for (int i = 0; i < table.getRowCount(); i++) {
                ...
                plsql += "tableName:xybg:insert;" +
                    ...
                    .toString()
                    .replace(":", "@Tin@") + ";" +
                    "culumnValue:药理:" + table.getValueAt(i, 4)
                    .toString()
                    .replace(":", "@Tin@") + ";" +
                    "culumnValue:主要成分:" + table.getValueAt(i, 5)
                    .toString()
                    .replace(":", "@Tin@") + ";" +
                    "culumnValue:用法:" + table.getValueAt(i, 6)
                    .toString()
                    .replace(":", "@Tin@") + ";" +
                    "culumnValue:注意事项:" + table.getValueAt(i, 7)
                    .toString()
                    .replace(":", "@Tin@") + ";" +
                    "culumnValue:适应症:" + table.getValueAt(i, 8)
                    .toString()
                    .replace(":", "@Tin@") + ";" +
                    "culumnValue:不良反应:" + table.getValueAt(i, 9)
                    .toString()
                    .replace(":", "@Tin@") + ";" +
                    "culumnValue:用量:" + table.getValueAt(i, 10)
                    .toString()
                    .replace(":", "@Tin@") + ";" +
                    "culumnValue:药物相互作用:" + table.getValueAt(i, 11)
                    .toString()
                    .replace(":", "@Tin@") + ";" +
