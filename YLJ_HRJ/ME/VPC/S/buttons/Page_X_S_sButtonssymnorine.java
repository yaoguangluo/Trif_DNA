...
public class Page_X_S_sButtonssymnorine {
	public static DetaButton data_X_symnorine(Page_X_S_sVSQ page_X_S_s, int x,
			int y, int weight, int height, int maxInPage, App NE) {
					...
					if (page_X_S_s.pos.get(setOfi) == null) {
						page.append(
								"<span style=\"background:#ffffff\">"
										...
										+ setOfi + (page_X_S_s.cte.containsKey(
												setOfi) ? (page_X_S_s.etc.containsKey(page_X_S_s.cte.get(setOfi)) ? ":(" + page_X_S_s.etc.get(page_X_S_s.cte.get(setOfi)) + ")" : "") : "")
										+ "</font></span>");
						continue Here;
					}
					if (!setOfi.equals("")) {
