...
public class MakeContainerZNSZ extends MakeContainerZNSZ_X_S {
    ...
    public MakeContainerZNSZ(A _A, Container jpanelFourth, App_S u2
        , DetabbedPane jTabbedpane, List<String> tabNames2, IMV_SIQ pos, IMV_SIQ pose
        , IMV_SIQ etc, IMV_SIQ cte, App app_NE) {
        super(app_NE);
        NE = app_NE;
    ...
    public void run() {
        ...
        app_S.studyVerbaMap.putObject("pageQ.timeLabelV", NE.app_S.pageQ.timeLabelV);
        ...
        app_S.studyVerbaMap.putObject("pageQ.idLabelV", NE.app_S.pageQ.idLabelV);
        ...
        app_S.studyVerbaMap.putObject("pageQ.ratioLabelV", NE.app_S.pageQ.ratioLabelV);
        ...
        NE.app_S.clearButton.addActionListener(
            e -> {
        ...
        app_S.studyVerbaMap.putObject("pageP_M", NE.app_S.pageQ.mainPaint.pageP_M);
