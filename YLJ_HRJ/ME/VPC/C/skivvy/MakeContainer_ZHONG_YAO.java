...
public class MakeContainer_ZHONG_YAO extends MakeContainer_X_S_s implements MouseListener {
    ...
    public void start() {
        try {
            ...
            taskMakeCoWorker = new TaskMakeCoWorker(app_S, containerPanel, _AE, pos, NE);
