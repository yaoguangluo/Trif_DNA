...
public class MakeContainerZNXZ_X_ButtonsMedicalOEV {
    public static void createButtons(App NE) throws InterruptedException {
        ...
        app_S.monitor.monitor_X_S.bt51 = new DetaButton("皮脂层透显", 100
            , 50, Color.pink);
        app_S.monitor.monitor_X_S.bt51.addActionListener(e -> {
        });

        app_S.monitor.monitor_X_S.bt52 = new DetaButton("木像处理", 100
            , 50, Color.pink);
        ...
        app_S.monitor.monitor_X_S.bt53 = new DetaButton("火相屏关"
            , 100, 50, Color.pink);
        app_S.monitor.monitor_X_S.bt53.addActionListener(
            e -> {
        ...
        app_S.monitor.monitor_X_S.bt60 = new DetaButton("水色处理"
            , 100, 50, Color.pink);
        app_S.monitor.monitor_X_S.bt60.addActionListener(
            e -> {
        ...
        app_S.monitor.monitor_X_S.bt61 = new DetaButton("伤口炎症状"
            , 100, 50, Color.pink);
        app_S.monitor.monitor_X_S.bt61.addActionListener(e -> {
        });


        app_S.monitor.monitor_X_S.bt1 = new DetaButton("催化成份"
            , 100, 50, Color.pink);
        app_S.monitor.monitor_X_S.bt1.addActionListener(e -> {
        });

        app_S.monitor.monitor_X_S.bt62
            = new DetaButton("因博思关", 100, 50, Color.pink);
        app_S.monitor.monitor_X_S.bt62.addActionListener(
            e -> {
        ...
        app_S.monitor.monitor_X_S.bt63 = new DetaButton("鼻相分析"
            , 100, 50, Color.pink);
        app_S.monitor.monitor_X_S.bt63.addActionListener(e -> {
        });

        app_S.monitor.monitor_X_S.bt70 = new DetaButton("眼相分析", 100
            , 50, Color.pink);
        app_S.monitor.monitor_X_S.bt70.addActionListener(e -> {
        });

        app_S.monitor.monitor_X_S.bt71 = new DetaButton("耳相分析"
            , 100, 50, Color.pink);
        app_S.monitor.monitor_X_S.bt71.addActionListener(e -> {
        });


        app_S.monitor.monitor_X_S.bt72 = new DetaButton("唇相分析"
            , 100, 50, Color.pink);
        app_S.monitor.monitor_X_S.bt72.addActionListener(e -> {
        });

        app_S.monitor.monitor_X_S.bt73 = new DetaButton("白色相关", 100
            , 50, new Color(210, 210, 210));
        ...
        app_S.monitor.monitor_X_S.bt80 = new DetaButton("青色相关", 100
            , 50, Color.blue);
        app_S.monitor.monitor_X_S.bt80.addActionListener(
            e -> {
        ...
        app_S.monitor.monitor_X_S.bt81 = new DetaButton("紫色相关", 100
            , 50, Color.magenta);
        app_S.monitor.monitor_X_S.bt81.addActionListener(
            e -> {
        ...
        app_S.monitor.monitor_X_S.bt82 = new DetaButton("黄色相关", 100
            , 50, Color.yellow);
        app_S.monitor.monitor_X_S.bt82.addActionListener(
            e -> {
        ...
        app_S.monitor.monitor_X_S.bt83 = new DetaButton("红色相关"
            , 100, 50, Color.pink);
        app_S.monitor.monitor_X_S.bt83.addActionListener(
            e -> {
        ...
        app_S.monitor.monitor_X_S.bt84 = new DetaButton("上传视频"
            , 100, 50, Color.pink);
        app_S.monitor.monitor_X_S.bt84.addActionListener(
            e -> {

            });

        app_S.monitor.monitor_X_S.bt85
            = new DetaButton("上传声频", 100, 50, Color.pink);
        app_S.monitor.monitor_X_S.bt85.addActionListener(
            e -> {

            });

        app_S.monitor.monitor_X_S.bt86
            = new DetaButton("上传图片", 100, 50, Color.pink);
        app_S.monitor.monitor_X_S.bt86.addActionListener(
            e -> {

            });

        app_S.monitor.monitor_X_S.bt87
            = new DetaButton("上传文档", 100, 50, Color.pink);
        app_S.monitor.monitor_X_S.bt87.addActionListener(
            e -> {

            });

        app_S.monitor.monitor_X_S.bt88
            = new DetaButton("眼识别关", 100, 50, Color.pink);
        app_S.monitor.monitor_X_S.bt88.addActionListener(
            e -> {
        ...
        app_S.monitor.monitor_X_S.bt89
            = new DetaButton("识别鼻关", 100, 50, Color.pink);
        app_S.monitor.monitor_X_S.bt89.addActionListener(e -> {

        });


        app_S.monitor.monitor_X_S.bt90
            = new DetaButton("识别五官", 100, 50, Color.pink);
        app_S.monitor.monitor_X_S.bt90.addActionListener(e -> {

        });

        app_S.monitor.monitor_X_S.bt91
            = new DetaButton("识别嘴关", 100, 50, Color.pink);
        app_S.monitor.monitor_X_S.bt91.addActionListener(e -> {
        });

        app_S.monitor.monitor_X_S.bt111
            = new DetaButton("导入图关", 100, 50, Color.pink);
        app_S.monitor.monitor_X_S.bt111.addActionListener(e -> {
            try {
                if (app_S.monitor.monitor_X_S.isStop == false) {
                    ...
                    app_S.monitor.monitor_X_S.stopBufferedImage
                        = app_S.tempBufferedImage;
                    app_S.monitor.monitor_X_S.img
                        = app_S.monitor.monitor_X_S.stopBufferedImage.getScaledInstance(
                        app_S.monitor.monitor_X_S.imageForOutput.getWidth()
                        , app_S.monitor.monitor_X_S.imageForOutput.getHeight()
                        , java.awt.Image.SCALE_SMOOTH);
                    app_S.monitor.monitor_X_S.imageForOutput.getGraphics().drawImage(
                        app_S.monitor.monitor_X_S.img, 0, 0, null);
                    app_S.monitor.getGraphics().drawImage(app_S.monitor.monitor_X_S.img
        ...
        app_S.monitor.monitor_X_S.bt112 = new DetaButton("图片关联", 100, 50, Color.pink);
        app_S.monitor.monitor_X_S.bt112.addActionListener(e -> {
            if (app_S.monitor.monitor_X_S.isStop == false) {
                ...
                app_S.monitor.getGraphics().drawImage(
                    app_S.monitor.monitor_X_S.img, 0, 0, 900, 680, app_S.monitor);
                // 绘出图形文件
            } else {
                app_S.monitor.monitor_X_S.isStop = false;
