...
public class MakeContainerZNSZ_X_S extends MakeContainer_X_S_s {
	public MakeContainerZNSZ_X_S(App NE) {
		...
		faSliderPage.addMouseListener(new MouseListener() {
			@Override
		...
		faSliderPage.addKeyListener(new KeyListener() {
			@Override
		...
		paSliderPage.addMouseListener(new MouseListener() {
			@Override
			public void mouseClicked(MouseEvent e) {
			}
		...
		frSliderPage.addMouseListener(new MouseListener() {
			@Override
			public void mouseClicked(MouseEvent e) {
			}
		...
		pdeSliderPage.addMouseListener(new MouseListener() {
			@Override
			public void mouseClicked(MouseEvent e) {
			}
		...
		sliderPage.addMouseListener(new MouseListener() {
			@Override
			public void mouseClicked(MouseEvent e) {
			}
		...
		sliderPage.addKeyListener(new KeyListener() {
			@Override
			public void keyTyped(KeyEvent e) {
			}
	...
	public JSlider frSliderPage = new JSlider(2, 16);// 32 64 128 256 512 1024
													 // 2048 4096
