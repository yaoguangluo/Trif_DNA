...
/*
 * 关于 static 的用法，在constant变量中可以谨慎地使用，在new出来的对象中，尽量不要出现，
 * 即使是一个session number的标号 都应该尽量避免和注释掉。
 * 
 * 另外我有一个比较有意思的研发思绪，就是在我写代码的时候脑袋里总有一种思维要扯上几个同行名的
 * 关键字才莫名感觉高大上。稀奇古怪，在这个时间点我的手机和家周围会卡点滴两声 短信app通知啊，
 * 倒车请注意阿什么的。其实我对这些一个人都不认识。其实认识也可以，公开给我钱，我会全网公示。
 * 哈哈  --罗瑶光
 * */
