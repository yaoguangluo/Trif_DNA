...
*  208号 阳光家园别墅小区 第十栋别墅
 * */
public class AppInit_X_PageLoad {
    public void IV_(App_S app, App NE) {
        ...
        //backend
        new BootVPCSBackEnd(app, NE).start();
        ...
        MakeContainerSJFX makeContainerSJFX = new MakeContainerSJFX(app.tableData_old
            , app.text, containerPanel, NE);
        ...
        //
        //if (app.appConfig.vPCSRestPanel.tabNamesHook[14]) {
        //p3
//        if (app.appConfig.SectionJPanel.jTextPane != null) {
//            String text = app.appConfig.SectionJPanel.jTextPane.getText();
//            text = "\r\n" + "----正在载入 西医处方 页面！" + text;
...
//        makeContainerXYCF.start();
        ...
        MakeContainerQMDJ makeContainerQMDJ = new MakeContainerQMDJ(jpanel5, NE);
        ...
        MakeContainerTemp makeContainerTemp = new MakeContainerTemp(container, NE);
        ...
        if (NE.tempString.contains("测试") || NE.tempString.contains("test")) {
            ...
            MakeContainerZNXZ makeContainerZNXZ = new MakeContainerZNXZ(jpanelThird, NE);
            makeContainerZNXZ.start();
            while (!makeContainerZNXZ.isFinished) {
                DetaThread.sleepDeta(500);
            }
            Component component = jpanelThird;
            app.jTabbedpane.setSelectedComponent(jpanelThird);
            app.makeContainer_ZHONG_YAO.doJump(component, component.getName());
        }
        DetaThread.sleepDeta(300);
        ...
        //if (app.appConfig.vPCSRestPanel.tabNamesHook[6]) {
        //p2
//        if (app.appConfig.SectionJPanel.jTextPane != null) {
//            String text = app.appConfig.SectionJPanel.jTextPane.getText();
//            text = "\r\n" + "----正在载入中医方剂页面！" + text;
...
//        makeContainerZYNKFJ.start();
        ...
        app.appConfig.SectionJPanel.jTextPane.setText(
            app.appConfig.SectionJPanel.jTextPane.getText()
                + "\r\n\r\n" + "cursor inject");
    }

    private void doAmedicinefilter(App NE) {
        App app = NE;
        ...
        app.app_S.jlabel_filter_button.setBounds(972 - 10 - x
            , 8 + y, 50, 22);
        ...
        app.app_S.jlabel_filter_button.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (null == app.app_S.appFilter) {
                    ...
                    app.app_S.frameFilter.setDefaultCloseOperation(JFrame.HIDE_ON_CLOSE);
                } else {
                    app.app_S.frameFilter.setVisible(true);
                    app.app_S.frameFilter.show();
                }
        ...
        app.app_S.jsp_name_filter
            = new JScrollPane(app.app_S.app_XCDX.name_filter(NE));
        app.app_S.jsp_name_filter.setBounds(1020 - 3 - x
            , 8 + y, 580 - 455 - 40, 22);
        ...
        app.app_S.jlabel_filter_not_have.setBounds(719 - x
            , 20 + y, 100, 50);

        app.app_S.jsp_name_filter_not_have = null;
        app.app_S.jsp_name_filter_not_have
            = new JScrollPane(app.app_S.app_XCDX.name_filter_not_have(NE));
        app.app_S.jsp_name_filter_not_have.setBounds(
            779 - x, 6 + 28 + y, 580 - 459, 22);
        ...
        app.app_S.shuming_filter.setBounds(1 + 350 + 100 + 10 - x, -6 + y
            , 100, 50);
        ...
        app.app_S.feel_filter_box.setBounds(60 + 15 + 30 + 580 + 40 - x
            , 8 + y, 20, 20);
        ...
        app.app_S.risk_filter_box.setBounds(10 + 350 + 60 - x, 8 + y
            , 20, 20);
        ...
        HrjButton jbutton_detao_zai_xian = new HrjButton("德塔在线", 100, 50, Color.cyan);
        //jbutton_detao_zai_xian.setBounds(30+60+760+130+130+130-100-50, 6, 100, 50);
