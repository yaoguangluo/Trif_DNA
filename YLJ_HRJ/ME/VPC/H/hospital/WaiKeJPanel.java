...
public class WaiKeJPanel extends JPanel {
	...
	private void I_SecondColomns() {
		...
		// copy tab
		JLabel baiDanBai22 = new JLabel("腺苷脱氨酸ada :");
		...
		JLabel label222 = new JLabel("尖锐湿疣醋酸白实验:");
		...
		JLabel label322 = new JLabel("血渗透压血osm:");
		...
		JLabel label422 = new JLabel("链球菌抗原:");
		...
		JLabel label522 = new JLabel("肌酐清除率cor:");
		...
		JLabel label622 = new JLabel("血（尿）铜cu :");
		...
		// 7
		JLabel label722 = new JLabel("组分区带igg :");
		...
		// 8
		JLabel label6822 = new JLabel("甲状旁腺激素pth :");
		...
		// 9
		JLabel label6922 = new JLabel("尿3-甲氧基4-羟基苦杏仁酸（vma）定量:");
		...
		// 10
		JLabel label61022 = new JLabel("载脂蛋白ap0alap0al:");
		...
		// 11
		JLabel label61122 = new JLabel("传染性虱病镜检lousemicroscopicexamination:");
		...
		// 12
		JLabel label61222 = new JLabel("肌钙蛋白itni:");
		...
		// 13
		JLabel label61322 = new JLabel("氯醋酸萘酚as-d酯酶染色:");
		...
		// 14
		JLabel label61422 = new JLabel("乳酸lact:");
