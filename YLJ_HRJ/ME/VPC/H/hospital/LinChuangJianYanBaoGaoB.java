...
//import M_V.MVQ.label.DetaIndexLabel;
...
//
////著作权人+作者 罗瑶光, 浏阳
//public class LinChuangJianYanBaoGaoB extends JPanel implements MouseListener
...
//        this.add(诊断结果);
//        this.add(诊断结果_box);
//        DetaButton qing_kong = new DetaButton("清空", 100, 50, Color.gray);
//        //JButton 清空= new JButton("清空");
//        qing_kong.setForeground(Color.black);
//        qing_kong.setBounds(10 + 70, 20 + 300 + 90, 100, 30);
//        qing_kong.addActionListener(new ActionListener() {
//            @Override
//            public void actionPerformed(ActionEvent arg0) {
//                //加状态；
//                zhen_duan_jie_guo_box.removeAll();
//            }
//        });
//        this.add(qing_kong);
//        DetaButton 打印 = new DetaButton("打印", 100, 50, Color.pink);
...
//        全血黏度.setBounds(10 + 220 * 0, 32 + 0, 100, 20);
//        全血黏度.indexString = "QXND";
//        jFrameList.add(全血黏度);
...
//        this.add(全血黏度_box);
//
//        DetaLabel zhong_liu_biao_ji_kang_yuan242检测 = new DetaLabel("肿瘤标记抗原242检测ca242:");
//        zhong_liu_biao_ji_kang_yuan242检测.setForeground(Color.WHITE);
//        zhong_liu_biao_ji_kang_yuan242检测.setBounds(10 + 220 * 0, 32 + 25 * 1, 100, 20);
//        zhong_liu_biao_ji_kang_yuan242检测.indexString = "ZLBJKYC";
//        jFrameList.add(zhong_liu_biao_ji_kang_yuan242检测);
//        JTextField zhong_liu_biao_ji_kang_yuan242检测_box = new JTextField();
//        zhong_liu_biao_ji_kang_yuan242检测_box.setBounds(10 + 110 + 220 * 0, 33 + 25 * 1, 80, 20);
//        zhong_liu_biao_ji_kang_yuan242检测_box.addActionListener(new ActionListener() {
//            @Override
//            public void actionPerformed(ActionEvent arg0) {
//                //加状态；
//
//            }
//        });
//        this.add(zhong_liu_biao_ji_kang_yuan242检测);
//        this.add(zhong_liu_biao_ji_kang_yuan242检测_box);
//
//        DetaLabel guo_min_yuan_jian_ce = new DetaLabel("过敏原检测（1）吸入组ⅰ（2）吸入组ⅱ（3）食物组ⅲ（4）食物组ⅳivtivt-ⅰivt-ⅱivt-ⅲivt-ⅳ:");
//        guo_min_yuan_jian_ce.setForeground(Color.WHITE);
//        guo_min_yuan_jian_ce.setBounds(10 + 220 * 0, 32 + 25 * 2, 100, 20);
//        guo_min_yuan_jian_ce.indexString = "GMYJC";
//        jFrameList.add(guo_min_yuan_jian_ce);
//        JTextField guo_min_yuan_jian_ce_box = new JTextField();
//        guo_min_yuan_jian_ce_box.setBounds(10 + 110 + 220 * 0, 33 + 25 * 2, 80, 20);
//        guo_min_yuan_jian_ce_box.addActionListener(new ActionListener() {
//            @Override
//            public void actionPerformed(ActionEvent arg0) {
//                //加状态；
//
//            }
//        });
//        this.add(guo_min_yuan_jian_ce);
//        this.add(guo_min_yuan_jian_ce_box);
//
//        DetaLabel 钙ca = new DetaLabel("钙ca:");
//        钙ca.setForeground(Color.WHITE);
//        钙ca.setBounds(10 + 220 * 0, 32 + 25 * 3, 100, 20);
//        钙ca.indexString = "GCA";
//        jFrameList.add(钙ca);
...
//        巨噬细胞感染趋化因子.setBounds(10 + 220 * 0, 32 + 25 * 4, 100, 20);
//        巨噬细胞感染趋化因子.indexString = "JSXBGRQHYZ";
//        jFrameList.add(巨噬细胞感染趋化因子);
...
//
//        DetaLabel qiang_gu_chun17 = new DetaLabel("尿17-羟固醇17-oh:");
//        qiang_gu_chun17.setForeground(Color.WHITE);
//        qiang_gu_chun17.setBounds(10 + 220 * 0, 32 + 25 * 5, 100, 20);
//        qiang_gu_chun17.indexString = "NQGCOH";
//        jFrameList.add(qiang_gu_chun17);
//        JTextField qiang_gu_chun17_box = new JTextField();
//        qiang_gu_chun17_box.setBounds(10 + 110 + 220 * 0, 33 + 25 * 5, 80, 20);
//        qiang_gu_chun17_box.addActionListener(new ActionListener() {
//            @Override
//            public void actionPerformed(ActionEvent arg0) {
//                //加状态；
//
//            }
//        });
//        this.add(qiang_gu_chun17);
//        this.add(qiang_gu_chun17_box);
//
//        //7
//        DetaLabel 促黄体生成素 = new DetaLabel("促黄体生成素lh:");
//        促黄体生成素.setForeground(Color.WHITE);
//        促黄体生成素.setBounds(10 + 220 * 0, 32 + 25 * 6, 100, 20);
//        促黄体生成素.indexString = "CHTSLH";
//        jFrameList.add(促黄体生成素);
...
//        乙肝表面抗原.setBounds(10 + 220 * 0, 32 + 25 * 7, 100, 20);
//        乙肝表面抗原.indexString = "YGBMKHSAG";
//        jFrameList.add(乙肝表面抗原);
...
//        this.add(乙肝表面抗原_box);
//        //9
//        DetaLabel mao_nang_chong_jing_jiandemo = new DetaLabel("毛囊虫镜检demodexfolliculorumexamination:");
//        mao_nang_chong_jing_jiandemo.setForeground(Color.WHITE);
//        mao_nang_chong_jing_jiandemo.setBounds(10 + 220 * 0, 32 + 25 * 8, 100, 20);
//        mao_nang_chong_jing_jiandemo.indexString = "MNCJDEOXFLURATI";
//        jFrameList.add(mao_nang_chong_jing_jiandemo);
//        JTextField mao_nang_chong_jing_jiandemo_box = new JTextField();
//        mao_nang_chong_jing_jiandemo_box.setBounds(10 + 110 + 220 * 0, 33 + 25 * 8, 80, 20);
//        mao_nang_chong_jing_jiandemo_box.addActionListener(new ActionListener() {
//            @Override
//            public void actionPerformed(ActionEvent arg0) {
//                //加状态；
//
//            }
//        });
//        this.add(mao_nang_chong_jing_jiandemo);
//        this.add(mao_nang_chong_jing_jiandemo_box);
//        //10
//        DetaLabel 促肾上腺皮质激素 = new DetaLabel("促肾上腺皮质激素acth:");
//        促肾上腺皮质激素.setForeground(Color.WHITE);
//        促肾上腺皮质激素.setBounds(10 + 220 * 0, 32 + 25 * 9, 100, 20);
//        促肾上腺皮质激素.indexString = "CSXPZJACTH";
//        jFrameList.add(促肾上腺皮质激素);
...
//        弓形体igm.setBounds(10 + 220 * 0, 32 + 25 * 10, 100, 20);
//        弓形体igm.indexString = "GXTIMKDO";
//        jFrameList.add(弓形体igm);
...
//        载脂蛋白ap0bap0b.setBounds(10 + 220 * 0, 32 + 25 * 11, 100, 20);
//        载脂蛋白ap0bap0b.indexString = "ZDBAPB";
//        jFrameList.add(载脂蛋白ap0bap0b);
...
//        尿酸uric.setBounds(10 + 220 * 0, 32 + 25 * 12, 100, 20);
//        尿酸uric.indexString = "NSURIC";
//        jFrameList.add(尿酸uric);
...
//        胰高糖素.setBounds(10 + 220 * 0, 32 + 25 * 13, 100, 20);
//        胰高糖素.indexString = "YGTS";
//        jFrameList.add(胰高糖素);
...
//        军团菌抗原检测.setBounds(10 + 220 * 1, 32 + 0, 100, 20);
//        军团菌抗原检测.indexString = "JTKYC";
//        jFrameList.add(军团菌抗原检测);
...
//        真菌培养取材.setBounds(10 + 220 * 1, 32 + 25 * 1, 100, 20);
//        真菌培养取材.indexString = "ZJPYQCULTEROFNGI";
//        jFrameList.add(真菌培养取材);
...
//        转肽酶ggt.setBounds(10 + 220 * 1, 32 + 25 * 2, 100, 20);
//        转肽酶ggt.indexString = "ZTMGT";
//        jFrameList.add(转肽酶ggt);
...
//        免疫组化验查.setBounds(10 + 220 * 1, 32 + 25 * 3, 100, 20);
//        免疫组化验查.indexString = "MYZHCimmunohistophathologicstain".toUpperCase();
//        jFrameList.add(免疫组化验查);
...
//        四项诱导血小板聚集功能.indexString = "SXYDBJGNmulitipleagentplateletaggregationtest".toUpperCase();
//        jFrameList.add(四项诱导血小板聚集功能);
...
//        髓鞘碱性蛋白.setBounds(10 + 220 * 1, 32 + 25 * 5, 100, 20);
//        髓鞘碱性蛋白.indexString = "SJXDBMP";
//        jFrameList.add(髓鞘碱性蛋白);
...
//        皮肤病理活检.indexString = "PFBHJdermatopathologicalexamination".toUpperCase();
//        jFrameList.add(皮肤病理活检);
...
//        血尿锌.setBounds(10 + 220 * 1, 32 + 25 * 7, 100, 20);
//        血尿锌.indexString = "XNZN";
//        jFrameList.add(血尿锌);
...
//        尿皮质醇尿皮质醇.setBounds(10 + 220 * 1, 32 + 25 * 8, 100, 20);
//        尿皮质醇尿皮质醇.indexString = "NPZC";
//        jFrameList.add(尿皮质醇尿皮质醇);
...
//        白色念珠菌抗原.setBounds(10 + 220 * 1, 32 + 25 * 9, 100, 20);
//        白色念珠菌抗原.indexString = "BSNZJKY";
//        jFrameList.add(白色念珠菌抗原);
...
//        乙肝两对半hbeab.setBounds(10 + 220 * 1, 32 + 25 * 10, 100, 20);
//        乙肝两对半hbeab.indexString = "YGLDBHEA";
//        jFrameList.add(乙肝两对半hbeab);
...
//        早老素.setBounds(10 + 220 * 1, 32 + 25 * 11, 100, 20);
//        早老素.indexString = "ZLSP";
//        jFrameList.add(早老素);
...
//        总蛋白tp.setBounds(10 + 220 * 1, 32 + 25 * 12, 100, 20);
//        总蛋白tp.indexString = "ZDBTP";
//        jFrameList.add(总蛋白tp);
...
//        肺炎支原体igg.setBounds(10 + 220 * 1, 32 + 25 * 13, 100, 20);
//        肺炎支原体igg.indexString = "FYZTIG";
//        jFrameList.add(肺炎支原体igg);
...
//    }
//
//    public void I_FourthColomns(JTextField 诊断结果_box2, List<DetaLabel> jFrameList) {
//
//        //copy tab
...
//        淋球菌培养取材.indexString = "LQJPYCcultureofneisseriagonorrhoen".toUpperCase();
//        jFrameList.add(淋球菌培养取材);
...
//        尿酸尿.setBounds(10 + 220 * 2, 32 + 25 * 1, 100, 20);
//        尿酸尿.indexString = "NS";
//        jFrameList.add(尿酸尿);
...
//        血小板聚集.setBounds(10 + 220 * 2, 32 + 25 * 2, 100, 20);
//        血小板聚集.indexString = "XBJ";
//        jFrameList.add(血小板聚集);
...
//        谷草转氨酶.setBounds(10 + 220 * 2, 32 + 25 * 3, 100, 20);
//        谷草转氨酶.indexString = "GCZAMST";
//        jFrameList.add(谷草转氨酶);
...
//        甲肝抗体.indexString = "JGKTigmhav".toUpperCase();
//        jFrameList.add(甲肝抗体);
...
//        生长激素gh.setBounds(10 + 220 * 2, 32 + 25 * 5, 100, 20);
//        生长激素gh.indexString = "SZJGH";
//        jFrameList.add(生长激素gh);
...
//        脂肪酶lipase.setBounds(10 + 220 * 2, 32 + 25 * 6, 100, 20);
//        脂肪酶lipase.indexString = "ZFMLIPASE";
//        jFrameList.add(脂肪酶lipase);
...
//        血浆叶酸测定.setBounds(10 + 220 * 2, 32 + 25 * 7, 100, 20);
//        血浆叶酸测定.indexString = "XJYSCDFA";
//        jFrameList.add(血浆叶酸测定);
...
//        同工酶ck_mm.setBounds(10 + 220 * 2, 32 + 25 * 8, 100, 20);
//        同工酶ck_mm.indexString = "TGMCK";
//        jFrameList.add(同工酶ck_mm);
...
//        特异性酯酶双染色.setBounds(10 + 220 * 2, 32 + 25 * 9, 100, 20);
//        特异性酯酶双染色.indexString = "TYXZMSR";
//        jFrameList.add(特异性酯酶双染色);
...
//        铁染色.setBounds(10 + 220 * 2, 32 + 25 * 10, 100, 20);
//        铁染色.indexString = "TRS";
//        jFrameList.add(铁染色);
...
//        钾K.setBounds(10 + 220 * 2, 32 + 25 * 11, 100, 20);
//        钾K.indexString = "JK";
//        jFrameList.add(钾K);
...
//        乙肝两对半hbeag.setBounds(10 + 220 * 2, 32 + 25 * 12, 100, 20);
//        乙肝两对半hbeag.indexString = "YGLDBHEAG";
//        jFrameList.add(乙肝两对半hbeag);
...
//        醋酸萘酚酯酶染色.setBounds(10 + 220 * 2, 32 + 25 * 13, 100, 20);
//        醋酸萘酚酯酶染色.indexString = "CSNFZMR";
//        jFrameList.add(醋酸萘酚酯酶染色);
...
//        血浆同型半胱氨酸.setBounds(10 + 220 * 3, 32 + 0, 100, 20);
//        血浆同型半胱氨酸.indexString = "XJTBGASHCY";
//        jFrameList.add(血浆同型半胱氨酸);
...
//        尿微量白蛋白排泄率.setBounds(10 + 220 * 3, 32 + 25 * 1, 100, 20);
//        尿微量白蛋白排泄率.indexString = "NWLBDPXUAER";
//        jFrameList.add(尿微量白蛋白排泄率);
...
//        氯cl.setBounds(10 + 220 * 3, 32 + 25 * 2, 100, 20);
//        氯cl.indexString = "CL";
//        jFrameList.add(氯cl);
...
//        灌洗液常规检查balf.setBounds(10 + 220 * 3, 32 + 25 * 3, 100, 20);
//        灌洗液常规检查balf.indexString = "GXYCGJCBALF";
//        jFrameList.add(灌洗液常规检查balf);
...
//        呼吸道病毒检测.setBounds(10 + 220 * 3, 32 + 25 * 4, 100, 20);
//        呼吸道病毒检测.indexString = "HXDBJC";
//        jFrameList.add(呼吸道病毒检测);
...
//        肌酐尿.setBounds(10 + 220 * 3, 32 + 25 * 5, 100, 20);
//        肌酐尿.indexString = "JGN";
//        jFrameList.add(肌酐尿);
...
//        免疫球蛋白gigg.setBounds(10 + 220 * 3, 32 + 25 * 6, 100, 20);
//        免疫球蛋白gigg.indexString = "MYQDBGI";
//        jFrameList.add(免疫球蛋白gigg);
...
//        胸水ldh.setBounds(10 + 220 * 3, 32 + 25 * 7, 100, 20);
//        胸水ldh.indexString = "XSLDH";
//        jFrameList.add(胸水ldh);
...
//        促进泡生成素fsm.setBounds(10 + 220 * 3, 32 + 25 * 8, 100, 20);
//        促进泡生成素fsm.indexString = "CJPSFM";
//        jFrameList.add(促进泡生成素fsm);
...
//        d二聚体.setBounds(10 + 220 * 3, 32 + 25 * 9, 100, 20);
//        d二聚体.indexString = "DEJTDIMER";
//        jFrameList.add(d二聚体);
...
//        间接胆红质.setBounds(10 + 220 * 3, 32 + 25 * 10, 100, 20);
//        间接胆红质.indexString = "JDHZIBIL";
//        jFrameList.add(间接胆红质);
...
//        t细胞亚群测定.setBounds(10 + 220 * 3, 32 + 25 * 11, 100, 20);
//        t细胞亚群测定.indexString = "TXBYQCD";
//        jFrameList.add(t细胞亚群测定);
...
//        氧合.setBounds(10 + 220 * 3, 32 + 25 * 12, 100, 20);
//        氧合.indexString = "YH";
//        jFrameList.add(氧合);
...
//        setSet.setBounds(10 + 220 * 3, 32 + 25 * 13, 100, 20);
//        setSet.indexString = "SET";
//        jFrameList.add(setSet);
...
//        胎盘糖旦白胎盘糖旦白.setBounds(10 + 220 * 4, 32 + 0, 100, 20);
//        胎盘糖旦白胎盘糖旦白.indexString = "TPDB";
//        jFrameList.add(胎盘糖旦白胎盘糖旦白);
...
//        单核细胞化学趋化因子.setBounds(10 + 220 * 4, 32 + 25 * 1, 100, 20);
//        单核细胞化学趋化因子.indexString = "DHXBHQHYZMCP";
//        jFrameList.add(单核细胞化学趋化因子);
...
//        骨髓细胞形态学诊断检查.setBounds(10 + 220 * 4, 32 + 25 * 2, 100, 20);
//        骨髓细胞形态学诊断检查.indexString = "GSXBTZDJC";
//        jFrameList.add(骨髓细胞形态学诊断检查);
...
//        髓鞘碱性蛋白抗体.setBounds(10 + 220 * 4, 32 + 25 * 3, 100, 20);
//        髓鞘碱性蛋白抗体.indexString = "SXJDBKTMBP";
//        jFrameList.add(髓鞘碱性蛋白抗体);
...
//        羟丁酸脱氢酶.setBounds(10 + 220 * 4, 32 + 25 * 4, 100, 20);
//        羟丁酸脱氢酶.indexString = "QDSZTMHBDH";
//        jFrameList.add(羟丁酸脱氢酶);
...
//        肽c.setBounds(10 + 220 * 4, 32 + 25 * 5, 100, 20);
//        肽c.indexString = "TCP";
//        jFrameList.add(肽c);
...
//        性病衣原体快速检测.setBounds(10 + 220 * 4, 32 + 25 * 6, 100, 20);
//        性病衣原体快速检测.indexString = "XBYTKSJC";
//        jFrameList.add(性病衣原体快速检测);
...
//        催孔素.setBounds(10 + 220 * 4, 32 + 25 * 7, 100, 20);
//        催孔素.indexString = "CKSPHL";
//        jFrameList.add(催孔素);
...
//        骨髓巨核细胞定量.setBounds(10 + 220 * 4, 32 + 25 * 8, 100, 20);
//        骨髓巨核细胞定量.indexString = "GSJHXBDL";
//        jFrameList.add(骨髓巨核细胞定量);
...
//        血气分析加离子分析.setBounds(10 + 220 * 4, 32 + 25 * 9, 100, 20);
//        血气分析加离子分析.indexString = "XQFXJLZ";
//        jFrameList.add(血气分析加离子分析);
...
//        脑脊液生化糖.setBounds(10 + 220 * 4, 32 + 25 * 10, 100, 20);
//        脑脊液生化糖.indexString = "NJYSHT";
//        jFrameList.add(脑脊液生化糖);
...
//        血管紧张素转化酶.setBounds(10 + 220 * 4, 32 + 25 * 11, 100, 20);
//        血管紧张素转化酶.indexString = "XGJZSHMACE";
//        jFrameList.add(血管紧张素转化酶);
...
//        糖元染色.setBounds(10 + 220 * 4, 32 + 25 * 12, 100, 20);
//        糖元染色.indexString = "TYRS";
//        jFrameList.add(糖元染色);
...
//        脑脊液细胞学检查.setBounds(10 + 220 * 4, 32 + 25 * 13, 100, 20);
//        脑脊液细胞学检查.indexString = "NJYXBJC";
//        jFrameList.add(脑脊液细胞学检查);
...
//    }
//
//    public void printValue(JTextField label612222223_box, String minString, String maxString, String elseString
...
//        if (!DetaLabelS_s.stableImages.target) {
//            return;
//        }
