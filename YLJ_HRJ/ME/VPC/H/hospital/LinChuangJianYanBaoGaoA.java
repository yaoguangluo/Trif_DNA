...
//*  208号 阳光家园别墅小区 第十栋别墅
// * */
//public class LinChuangJianYanBaoGaoA extends JPanel implements MouseListener
...
//        扫描图片.setBounds(800, 20 + 300 + 90, 100, 30);
...
//        蓝牙接收报告.setBounds(920, 20 + 300 + 90, 150, 30);
...
//        baiDanBai.setTag("西医检验：白蛋白ALB->临床意义:鞘内免疫病观测指标鞘内免疫病观测指标->"
//            + "实验室检查:血3350-4765mg/dl脑脊液13.4-23.7mg/dl", true);
...
//        //later in array matrix, to build a format text.
...
//        螨虫镜检.setBounds(10, 32 + 25 * 3, 100, 20);
//        jFrameList.add(螨虫镜检);
...
//        性病支原体.setBounds(10, 32 + 25 * 4, 100, 20);
//        jFrameList.add(性病支原体);
...
//        低密度脂蛋白.setBounds(10, 32 + 25 * 5, 100, 20);
//        jFrameList.add(低密度脂蛋白);
...
//        血氨.setBounds(10, 32 + 25 * 6, 100, 20);
//        jFrameList.add(血氨);
//        血氨.indexString = "XANH";
...
//        胰岛素抗体.setBounds(10, 32 + 25 * 7, 100, 20);
//        jFrameList.add(胰岛素抗体);
...
//        钾尿.setBounds(10, 32 + 25 * 8, 100, 20);
//        jFrameList.add(钾尿);
//        钾尿.indexString = "KAJN";
...
//        氯尿.setBounds(10, 32 + 25 * 10, 100, 20);
//        jFrameList.add(氯尿);
//        氯尿.indexString = "CLN";
...
//        肌钙蛋白.setBounds(10, 32 + 25 * 11, 100, 20);
//        jFrameList.add(肌钙蛋白);
...
//        钠尿.setBounds(10, 32 + 25 * 12, 100, 20);
//        jFrameList.add(钠尿);
//        钠尿.indexString = "NA";
...
//                double temp_double = Double.valueOf(temp);
//                String reportz = "判断是否有大量盐的丢失, 判断呕吐, 腹泻患者的电解质平衡, 中枢神经系统疾病"
//                    + ", 脑出血, 炎症, 肿瘤, 肾小管严重损害患者尿钠增多。";
//                String reportj = "尿钠低。";
//
//                if (temp_double > 260) {
//                    诊断结果_box.setText(诊断结果_box.getText().replace(reportz, ""));
...
//        碱性磷酸酶.setBounds(10, 32 + 25 * 13, 100, 20);
//        jFrameList.add(碱性磷酸酶);
...
//                double temp_double = Double.valueOf(temp);
//                String reportz = "碱性磷酸酶增高：常见于肝癌, 肝硬化, 阻塞性黄疸, 急慢性黄疸型肝炎"
//                    + ", 骨细胞瘤, 骨折及少年儿童。。";
...
//        血渗透压血osm.setBounds(10 + 220 * 4, 32 + 0, 100, 20);
//        jFrameList.add(血渗透压血osm);
...
//        肌酐清除率.setBounds(10 + 220 * 4, 32 + 25 * 1, 100, 20);
//        jFrameList.add(肌酐清除率);
...
//        血尿铜.setBounds(10 + 220 * 4, 32 + 25 * 2, 100, 20);
//        jFrameList.add(血尿铜);
...
//                String reportj = "血（尿）铜 降低：见于先天性铜吸收及肝脏代谢障碍"
//                    + ", 肾病综合症及肝豆状核变性。";
//
//                if (temp_double > 150) {
//                    诊断结果_box.setText(诊断结果_box.getText().replace(reportz, ""));
...
//        组分区带igg.setBounds(10 + 220 * 4, 32 + 25 * 3, 100, 20);
//        jFrameList.add(组分区带igg);
...
//        甲状旁腺激素pth.setBounds(10 + 220 * 4, 32 + 25 * 4, 100, 20);
//        jFrameList.add(甲状旁腺激素pth);
...
//        羟基苦杏仁酸.setBounds(10 + 220 * 4, 32 + 25 * 5, 100, 20);
//        jFrameList.add(羟基苦杏仁酸);
...
//        载脂蛋白ap0.setBounds(10 + 220 * 4, 32 + 25 * 6, 100, 20);
//        jFrameList.add(载脂蛋白ap0);
...
//        肌钙蛋白itni.setBounds(10 + 220 * 4, 32 + 25 * 7, 100, 20);
//        jFrameList.add(肌钙蛋白itni);
...
//        氯醋酸萘酚.setBounds(10 + 220 * 4, 32 + 25 * 8, 100, 20);
//        jFrameList.add(氯醋酸萘酚);
...
//        乳酸lact.setBounds(10 + 220 * 4, 32 + 25 * 9, 100, 20);
//        jFrameList.add(乳酸lact);
...
//                double temp_double = Double.valueOf(temp);
//                String reportz = "乳酸LACT过高。见于缺氧, 酸中毒, 休克, 严重贫血, 肺功能不全"
//                    + ", 肌肉痉挛, 糖尿病, 剧烈运动";
//                String reportj = "";
//
//                if (temp_double > 18) {
...
//        this.add(乳酸lact_box);
//        //11
//        DetaLabel zhong_liu_biao_ji_kang_yuan = new DetaLabel("肿瘤标记抗原242检测ca242:");
//        zhong_liu_biao_ji_kang_yuan.setForeground(Color.WHITE);
//        zhong_liu_biao_ji_kang_yuan.setBounds(10 + 220 * 4, 32 + 25 * 10, 100, 20);
//        jFrameList.add(zhong_liu_biao_ji_kang_yuan);
//        zhong_liu_biao_ji_kang_yuan.indexString = "ZLBJKYCA";
//        JTextField zhong_liu_biao_ji_kang_yuan_box = new JTextField();
//        zhong_liu_biao_ji_kang_yuan_box.setBounds(10 + 110 + 220 * 4, 33 + 25 * 10, 80, 20);
//        zhong_liu_biao_ji_kang_yuan_box.addActionListener(new ActionListener() {
//            @Override
//            public void actionPerformed(ActionEvent arg0) {
//                //加状态；
//                String temp = zhong_liu_biao_ji_kang_yuan_box.getText();
//                double temp_double = Double.valueOf(temp);
//                String reportz = "";
...
//            }
//        });
//        this.add(zhong_liu_biao_ji_kang_yuan);
//        this.add(zhong_liu_biao_ji_kang_yuan_box);
//        //12
//        DetaLabel 钙ca = new DetaLabel("钙ca:");
//        钙ca.setForeground(Color.WHITE);
//        钙ca.setBounds(10 + 220 * 4, 32 + 25 * 11, 100, 20);
//        jFrameList.add(钙ca);
//        钙ca.indexString = "GCA";
...
//                //加状态；
//                printValue(钙ca_box
//                    , "降低：常见于维生素D缺乏, 佝楼病, 软骨病, 小儿手足抽搐症, 老年骨质疏松"
//                        + ", 甲状旁腺功能减退, 慢性肾炎, 尿毒症, 低钙饮食及吸收不良"
...
//        巨噬细胞感染趋化因子.setBounds(10 + 220 * 4, 32 + 25 * 12, 100, 20);
...
//        qiang_gu_chun17.setBounds(10 + 220 * 4, 32 + 25 * 13, 100, 20);
//        jFrameList.add(qiang_gu_chun17);
//        qiang_gu_chun17.indexString = "QGCOH";
//        JTextField qiang_gu_chun17_box = new JTextField();
//        qiang_gu_chun17_box.setBounds(10 + 110 + 220 * 4, 33 + 25 * 13, 80, 20);
//        qiang_gu_chun17_box.addActionListener(new ActionListener() {
//            @Override
//            public void actionPerformed(ActionEvent arg0) {
//                //加状态；
//                printValue(qiang_gu_chun17_box
...
//    }
//
//    public void printValue(JTextField 结核印迹试验_box, String minString, String maxString, String elseString
...
//        try {
//            temp_double = Double.valueOf(temp);
//        } catch (Exception e) {
//            //later~hook
//        }
//        if (temp_double > max) {
...
//    }
//
//    public void I_FourthColomns(JTextField 诊断结果_box, List<DetaLabel> jFrameList) {
//
//        //copy tab
//        DetaLabel ldh同工酶is = new DetaLabel("ldh同工酶is0-ldh:");
//        ldh同工酶is.setForeground(Color.WHITE);
//        ldh同工酶is.setBounds(10 + 220 * 3, 32 + 0, 100, 20);
//        jFrameList.add(ldh同工酶is);
...
//        胰岛素ins.setBounds(10 + 220 * 3, 32 + 25 * 1, 100, 20);
//        jFrameList.add(胰岛素ins);
...
//        同t.setBounds(10 + 220 * 3, 32 + 25 * 2, 100, 20);
//        jFrameList.add(同t);
//        同t.indexString = "T";
...
//        淀粉酶amy.setBounds(10 + 220 * 3, 32 + 25 * 3, 100, 20);
//        jFrameList.add(淀粉酶amy);
...
//        乳酸脱氢酶ldh.setBounds(10 + 220 * 3, 32 + 25 * 4, 100, 20);
//        jFrameList.add(乳酸脱氢酶ldh);
...
//        铁tron.setBounds(10 + 220 * 3, 32 + 25 * 5, 100, 20);
//        jFrameList.add(铁tron);
...
//        酸性磷酸酶和酒石酸.setBounds(10 + 220 * 3, 32 + 25 * 6, 100, 20);
//        jFrameList.add(酸性磷酸酶和酒石酸);
...
//        粒细胞刺激因子.setBounds(10 + 220 * 3, 32 + 25 * 7, 100, 20);
//        jFrameList.add(粒细胞刺激因子);
...
//        雌激素el.setBounds(10 + 220 * 3, 32 + 25 * 8, 100, 20);
//        jFrameList.add(雌激素el);
...
//        同工酶ck_mb.setBounds(10 + 220 * 3, 32 + 25 * 9, 100, 20);
//        jFrameList.add(同工酶ck_mb);
...
//        尿渗透压尿.setBounds(10 + 220 * 3, 32 + 25 * 10, 100, 20);
//        jFrameList.add(尿渗透压尿);
...
//        结核印迹试验.setBounds(10 + 220 * 3, 32 + 25 * 11, 100, 20);
//        jFrameList.add(结核印迹试验);
...
//        腺苷脱氨酸.setBounds(10 + 220 * 3, 32 + 25 * 12, 100, 20);
//        jFrameList.add(腺苷脱氨酸);
...
//        尖锐湿疣醋酸白.setBounds(10 + 220 * 3, 32 + 25 * 13, 100, 20);
//        jFrameList.add(尖锐湿疣醋酸白);
...
//        疥疮镜检sarcoptes.setBounds(10 + 220 * 2, 32 + 0, 100, 20);
//        jFrameList.add(疥疮镜检sarcoptes);
...
//        白色念珠菌抗体.setBounds(10 + 220 * 2, 32 + 25 * 1, 100, 20);
//        jFrameList.add(白色念珠菌抗体);
...
//        总胆红质.setBounds(10 + 220 * 2, 32 + 25 * 2, 100, 20);
//        jFrameList.add(总胆红质);
...
//        直接胆红质.setBounds(10 + 220 * 2, 32 + 25 * 3, 100, 20);
//        jFrameList.add(直接胆红质);
...
//        斑贴试验.setBounds(10 + 220 * 2, 32 + 25 * 4, 100, 20);
//        jFrameList.add(斑贴试验);
...
//        血镁.setBounds(10 + 220 * 2, 32 + 25 * 5, 100, 20);
//        jFrameList.add(血镁);
//        血镁.indexString = "XMG";
...
//        甲肝抗体.setBounds(10 + 220 * 2, 32 + 25 * 6, 100, 20);
//        jFrameList.add(甲肝抗体);
...
//        肌酸激酶.setBounds(10 + 220 * 2, 32 + 25 * 7, 100, 20);
//        jFrameList.add(肌酸激酶);
...
//                printValue(肌酸激酶_box
//                    , "过低"
//                    , "增高：心梗4-6小时开始升高, 18-36小时可达正常值的20-30倍, 为最高峰"
//                        + ", 2-4天恢复正常, 另外, 病毒性心肌炎, 皮肌炎, 肌肉损伤"
...
//        胆固醇.setBounds(10 + 220 * 2, 32 + 25 * 8, 100, 20);
//        jFrameList.add(胆固醇);
//        胆固醇.indexString = "DGC";
...
//        高密度脂蛋白.setBounds(10 + 220 * 2, 32 + 25 * 9, 100, 20);
//        jFrameList.add(高密度脂蛋白);
...
//        rents.setBounds(10 + 220 * 2, 32 + 25 * 10, 100, 20);
//        jFrameList.add(rents);
...
//        肌酐.setBounds(10 + 220 * 2, 32 + 25 * 11, 100, 20);
//        jFrameList.add(肌酐);
...
//        巨细胞病毒.setBounds(10 + 220 * 2, 32 + 25 * 12, 100, 20);
//        jFrameList.add(巨细胞病毒);
...
//        叶酸.setBounds(10 + 220 * 2, 32 + 25 * 13, 100, 20);
//        jFrameList.add(叶酸);
//        叶酸.indexString = "YS";
...
//        磷尿.setBounds(10 + 220 * 1, 32 + 0, 100, 20);
//        jFrameList.add(磷尿);
//        磷尿.indexString = "LN";
...
//        基质细胞源性.setBounds(10 + 220 * 1, 32 + 25 * 1, 100, 20);
//        jFrameList.add(基质细胞源性);
...
//        栽脂蛋白.setBounds(10 + 220 * 1, 32 + 25 * 2, 100, 20);
//        jFrameList.add(栽脂蛋白);
...
//        甘油三酯.setBounds(10 + 220 * 1, 32 + 25 * 3, 100, 20);
//        jFrameList.add(甘油三酯);
...
//        胸水.setBounds(10 + 220 * 1, 32 + 25 * 4, 100, 20);
//        jFrameList.add(胸水);
//        胸水.indexString = "CLXS";
...
//        巨噬细胞感染.setBounds(10 + 220 * 1, 32 + 25 * 5, 100, 20);
//        jFrameList.add(巨噬细胞感染);
...
//        纳na.setBounds(10 + 220 * 1, 32 + 25 * 6, 100, 20);
//        jFrameList.add(纳na);
//        纳na.indexString = "NA";
...
//                        + "2.胃肠道引流, 呕吐及腹泻。3.肮利尿激素过多。"
//                    , "增高：1.严重脱水, 大量出汗, 高烧, 烧伤, 糖尿病性多尿。"
//                        + "2.肾上腺皮质功能亢进, 原发及继发性醛固酮增多病。"
//                    , ""
//                    , 135.0, 145.0, 诊断结果_box
//                    , "");
//            }
//        });
//        this.add(纳na);
...
//        酮类固醇.setBounds(10 + 220 * 1, 32 + 25 * 7, 100, 20);
//        jFrameList.add(酮类固醇);
...
//        胆汁酸.setBounds(10 + 220 * 1, 32 + 25 * 8, 100, 20);
//        jFrameList.add(胆汁酸);
...
//        血浆维生素.setBounds(10 + 220 * 1, 32 + 25 * 9, 100, 20);
//        jFrameList.add(血浆维生素);
...
//        血糖.setBounds(10 + 220 * 1, 32 + 25 * 10, 100, 20);
//        jFrameList.add(血糖);
...
//                printValue(血糖_box
//                    , "过低"
//                    , "增高：某些生理因素（情绪紧张, 饭后1-2小时）及注射肾上腺素后"
//                        + ", 病理性增高见于各种糖尿病, 慢性胰腺炎, 心梗, 甲亢"
//                        + ", 垂体前叶嗜酸性细胞瘤, 颅内出血, 颅外伤等。"
//                    , ""
//                    , 70.0, 110.0, 诊断结果_box
//                    , "");
//            }
...
//        小时合成率.setBounds(10 + 220 * 1, 32 + 25 * 11, 100, 20);
//        jFrameList.add(小时合成率);
...
//        谷丙转氨酶.setBounds(10 + 220 * 1, 32 + 25 * 12, 100, 20);
//        jFrameList.add(谷丙转氨酶);
...
//        胰岛细胞抗体.setBounds(10 + 220 * 1, 32 + 25 * 13, 100, 20);
//        jFrameList.add(胰岛细胞抗体);
