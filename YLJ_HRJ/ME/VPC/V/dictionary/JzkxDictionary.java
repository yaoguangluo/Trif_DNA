...
public class JzkxDictionary extends TxtDictionary {
	@SuppressWarnings("resource")
	public List<String> txtToList() {
		temp_list = new ArrayList<>();
		InputStream in = new BookIndex().getClass()
				.getResourceAsStream(S_File.jzkxPage_txt);
	...
	public IMV_SQI_ mapToMap_zd(IMV_SQI dic_map) {
		dic_zd = new IMV_SQI_();
	...
	public IMV_SQI_ mapToMap_zl(IMV_SQI dic_map) {
		dic_zl = new IMV_SQI_();
		iter = dic_map.keySet().iterator();
		copy = new ArrayList<String>();
		while (iter.hasNext())
	...
	public IMV_SQI_ mapToMap_bf(IMV_SQI dic_map) {
		dic_bf = new IMV_SQI_();
		iter = dic_map.keySet().iterator();
		copy = new ArrayList<String>();
		while (iter.hasNext())
	...
	public IMV_SQI_ mapToMap_jy(IMV_SQI dic_map) {
		dic_jy = new IMV_SQI_();
		iter = dic_map.keySet().iterator();
		copy = new ArrayList<String>();
		while (iter.hasNext())
	...
	public IMV_SQI_ mapToMap_yh(IMV_SQI dic_map) {
		dic_yh = new IMV_SQI_();
		iter = dic_map.keySet().iterator();
		copy = new ArrayList<String>();
		while (iter.hasNext())
	...
	public IMV_SQI_ mapToMap_bl(IMV_SQI dic_map) {
		dic_bl = new IMV_SQI_();
		iter = dic_map.keySet().iterator();
		copy = new ArrayList<String>();
		while (iter.hasNext())
	...
	public IMV_SQI_ mapToMap_wx(IMV_SQI dic_map) {
		dic_wx = new IMV_SQI_();
		iter = dic_map.keySet().iterator();
		copy = new ArrayList<String>();
		while (iter.hasNext())
	...
	public IMV_SQI_ mapToMap_gn(IMV_SQI dic_map) {
		dic_gn = new IMV_SQI_();
		iter = dic_map.keySet().iterator();
		copy = new ArrayList<String>();
		while (iter.hasNext())
