...
public class ZhongYaoDictionary extends Dictionary_S {
    public List<String> txtToList() {
        ...
        DetaBufferedReader cReader = FastReadProjectFile.getDetaBufferedReader(S_File.bcqj_txt
            , "DetaResources/books/", "UTF8");
    ...
    public IMV_SIQ_ listToMap(List<String> dic_list, App NE) {
        ...
        NE.app_S.appConfig.SectionJPanel.jTextPane.setText("录入药食同源共计:"
            + medCount + "味");
        return dic_map;
    }
...
//DetaBufferedReader cReaderp= new DetaBufferedReader(DetaInputStreamReader.E(inputStreamp, "UTF8"));
        ...
        DetaBufferedReader cReaderp = FastReadProjectFile.getDetaBufferedReader(S_File.PinYinCN_lyg
        ...
        while (iter.hasNext()) {
            String index = iter.next().replaceAll(" ", "")
                .replace("〔", "").replace("〕", ":");
            StringBuilder stringBuilder = new StringBuilder();
            for (int l = 0; l < index.length(); l++) {
                if (pinyin.containsKey("" + index.charAt(l))) {
                    stringBuilder.append("" + pinyin.getString("" + index.charAt(l))
    ...
    public IMV_SIQ mapToMap_yw(IMV_SIQ dic_map) {
        ...
        for (int i = 0; i < copy.size(); i++) {
            ...
            if (!dic_yw.containsKey(med_name)) {
                ...
                dic_yw.put(med_name, dic_yw.get(med_name) + "叠加："
                    + temp.replaceAll("\\s*", "")
                    .replace("〔", "").replace("〕", ":"));
            }
        }
    ...
    public IMV_SIQ mapToMap_li(IMV_SIQ dic_map) {
        ...
        for (int i = 0; i < copy.size(); i++) {
            ...
            if (!dic_li.containsKey(med_name)) {
                ...
                dic_li.put(med_name
                    , dic_li.get(med_name) + "叠加：" + temp.replaceAll("\\s*", "")
                        .replace("〔", "").replace("〕", ":"));
            }
        }
        return dic_li;
...
//			}
    ...
    public IMV_SIQ mapToMap_zf(IMV_SIQ dic_map) {
        ...
        for (int i = 0; i < copy.size(); i++) {
            ...
            dic_zf.put(med_name.replaceAll("\\s*", "")
                    .replace("〔", "").replace("〕", ":")
                , temp.replaceAll("\\s*", "")
                    .replace("〔", "").replace("〕", ":"));
        }
    ...
    public IMV_SIQ mapToMap_cj(IMV_SIQ dic_map) {
        ...
        for (int i = 0; i < copy.size(); i++) {
            ...
            dic_cj.put(med_name.replaceAll("\\s*", "")
                    .replace("〔", "").replace("〕", ":")
                , temp.replaceAll("\\s*", "")
                    .replace("〔", "").replace("〕", ":"));
        }
    ...
    public IMV_SIQ mapToMap_jj(IMV_SIQ dic_map) {
        ...
        for (int i = 0; i < copy.size(); i++) {
            ...
            dic_jj.put(med_name.replaceAll("\\s*", "")
                    .replace("〔", "").replace("〕", ":")
                , temp.replaceAll("\\s*", "")
                    .replace("〔", "").replace("〕", ":"));
        }
    ...
    public IMV_SIQ mapToMap_cy(IMV_SIQ dic_map) {
        ...
        for (int i = 0; i < copy.size(); i++) {
            ...
            dic_cy.put(med_name.replaceAll("\\s*", "")
                    .replace("〔", "").replace("〕", ":")
                , temp.replaceAll("\\s*", "")
                    .replace("〔", "").replace("〕", ":"));
        }
    ...
    public IMV_SIQ mapToMap_ya(IMV_SIQ dic_map) {
        ...
        for (int i = 0; i < copy.size(); i++) {
            ...
            dic_ya.put(med_name.replaceAll("\\s*", "")
                    .replace("〔", "").replace("〕", ":")
                , temp.replaceAll("\\s*", "")
                    .replace("〔", "").replace("〕", ":"));
        }
    ...
    public IMV_SIQ mapToMap_jm(IMV_SIQ dic_map) {
        ...
        for (int i = 0; i < copy.size(); i++) {
            ...
            dic_jm.put(med_name.replaceAll("\\s*", "")
                    .replace("〔", "").replace("〕", ":")
                , temp.replaceAll("\\s*", "")
                    .replace("〔", "").replace("〕", ":"));
        }
    ...
    public IMV_SIQ mapToMap_xw(IMV_SIQ dic_map) {
        ...
        for (int i = 0; i < copy.size(); i++) {
            ...
            if (!dic_xw.containsKey(med_name)) {
                ...
                dic_xw.put(med_name, dic_xw.get(med_name) + "叠加："
                    + temp.replaceAll("\\s*", "")
                    .replace("〔", "").replace("〕", ":"));
            }
        }
    ...
    public IMV_SIQ mapToMap_yl(IMV_SIQ dic_map
        , IMV_SIQ dic_xw, IMV_SIQ dic_li
...
//			}
            ...
            if (!dic_yl.containsKey(med_name)) {
                ...
                dic_yl.put(med_name, dic_yl.get(med_name) + "叠加："
                    + temp.replaceAll("\\s*", "")
                    .replace("〔", "").replace("〕", ":"));
            }
        }
