    ...
    public javax.swing.JTable jTable(App_S app, App app_NE) {
        ...
        for (int i = 0; i < app.copy.size(); i++) {
            app.tableData_old[i] = new Object[]{
                ...
                (app.dic_yw.get(app.copy.get(i)) == null ? "" : app.dic_yw
                    .getTrimString(app.copy.get(i))),
                (app.dic_li.get(app.copy.get(i)) == null ? "" : app.dic_li
                    .getTrimString(app.copy.get(i))),
    ...
    public void mouseClicked(MouseEvent arg0) {
        ...
        while (iterator.hasNext()) {
            ...
            if (!setOfi.equals("")) {
                ...
                page.append("<span style=\"background:white\">" + "<font color=\"black\""
                    + " size=\"" + NE.app_S.size_font_rot + "\">"
                    + setOfi + "</font></span>");
            }
        }
        ...
        if (!value_jingmai.equals("")) {
            ...
            if (value_jingmai.contains("手少阴") || value_jingmai.contains("通行十二")
                || value_jingmai.contains("心") || value_jingmai.contains("苦")) {
            ...
            if (value_jingmai.contains("手太阴") || value_jingmai.contains("通行十二")
                || value_jingmai.contains("肺") || value_jingmai.contains("辛")) {
            ...
            if (value_jingmai.contains("足少阴") || value_jingmai.contains("通行十二")
                || value_jingmai.contains("肾") || value_jingmai.contains("咸")
            ...
            if (value_jingmai.contains("足厥阴") || value_jingmai.contains("通行十二")
                || value_jingmai.contains("肝") || value_jingmai.contains("温")) {
