...
public class ZhongYaoDictionaryFromDB {
    ...
    public IMV_SIQ listToMap(IMV_SIQ dic_yw
        , IMV_SIQ dic_li, IMV_SIQ dic_hai
        , IMV_SIQ dic_xz, IMV_SIQ dic_ya
        , IMV_SIQ dic_jm, IMV_SIQ dic_xw
        , IMV_SIQ dic_cy, IMV_SIQ dic_jj
        , IMV_SIQ dic_zf, IMV_SIQ dic_cj
        ...
        while (iter.hasNext()) {
            ...
            for (int l = 0; l < index.length(); l++) {
                if (pinyin.containsKey("" + index.charAt(l))) {
                    stringBuilder.append("" + pinyin.getString(""
                        + index.charAt(l)).toUpperCase().charAt(0));
                }
            }
