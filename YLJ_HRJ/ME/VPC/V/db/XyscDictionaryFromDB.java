...
public class XyscDictionaryFromDB {
    ...
    public void txtToMap(IMV_SIQ dic_yao_ming
        ...
        , IMV_SIQ dic_qi_ta, IMV_SIQ dic_yong_liang
            ...
            if (hashmap.containsKey("rowValue")) {
                ...
                if (rowValue.containsKey("西药名")) {
                    ...
                    keyName = temp.get("culumnValue").toString()
                        .replace("@Tin@", ":");
                    dic_yao_ming.put(keyName, null == temp.get("culumnValue")
                ...
                if (rowValue.containsKey("介绍")) {
                    ...
                    dic_jie_shao.put(keyName, null == temp.get("culumnValue")
                        ? "" : temp.get("culumnValue").toString()
                        .replace("@Tin@", ":"));
                    stringBuilder.append(temp.get("culumnValue").toString());
                }
                if (rowValue.containsKey("药理")) {
                    ...
                    dic_yao_li.put(keyName, null == temp.get("culumnValue")
                        ? "" : temp.get("culumnValue").toString()
                        .replace("@Tin@", ":"));
                    stringBuilder.append(temp.get("culumnValue").toString());
                }
                if (rowValue.containsKey("主要成分")) {
                    ...
                    dic_chengfen_danwei.put(keyName, null == temp.get("culumnValue")
                        ? "" : temp.get("culumnValue").toString()
                        .replace("@Tin@", ":"));
                    stringBuilder.append(temp.get("culumnValue").toString());
                }
                if (rowValue.containsKey("用法")) {
                    ...
                    dic_yong_fa.put(keyName, null == temp.get("culumnValue")
                        ? "" : temp.get("culumnValue").toString()
                        .replace("@Tin@", ":"));
                    stringBuilder.append(temp.get("culumnValue").toString());
                }
                if (rowValue.containsKey("注意事项")) {
                    ...
                    dic_zhu_yi.put(keyName, null == temp.get("culumnValue")
                        ? "" : temp.get("culumnValue").toString()
                        .replace("@Tin@", ":"));
                    stringBuilder.append(temp.get("culumnValue").toString());
                }
                if (rowValue.containsKey("适应症")) {
                    ...
                    dic_shi_ying.put(keyName, null == temp.get("culumnValue")
                        ? "" : temp.get("culumnValue").toString()
                        .replace("@Tin@", ":"));
                    stringBuilder.append(temp.get("culumnValue").toString());
                }
                if (rowValue.containsKey("不良反应")) {
                    ...
                    dic_bu_liang_fan_ying.put(keyName, null == temp.get("culumnValue")
                        ? "" : temp.get("culumnValue").toString()
                        .replace("@Tin@", ":"));
                    stringBuilder.append(temp.get("culumnValue").toString());
                }
                if (rowValue.containsKey("用量")) {
                    ...
                    dic_yong_liang.put(keyName, null == temp.get("culumnValue")
                        ? "" : temp.get("culumnValue").toString()
                        .replace("@Tin@", ":"));
                    stringBuilder.append(temp.get("culumnValue").toString());
                }
                if (rowValue.containsKey("药物相互作用")) {
                    ...
                    dic_yao_wu_xiang_hu_zuo_yong.put(keyName, null == temp.get("culumnValue")
                        ? "" : temp.get("culumnValue").toString()
                        .replace("@Tin@", ":"));
                    stringBuilder.append(temp.get("culumnValue").toString());
                }
                if (rowValue.containsKey("其他")) {
                    ...
                    dic_qi_ta.put(keyName, null == temp.get("culumnValue")
                        ? "" : temp.get("culumnValue").toString()
                        .replace("@Tin@", ":"));
                    stringBuilder.append(temp.get("culumnValue").toString());
                }
