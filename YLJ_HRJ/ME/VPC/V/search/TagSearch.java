...
public class TagSearch extends ScrollPane {
    ...
    public void IV_(JTextField name) {
        ...
        jTabbedpane.addTab("多国语言", new ImageIcon()
            , duo_guo_yu_yuanContainer, "做词汇的解释详细解释。");
        ...
        jTabbedpane.addTab("猜猜我心", new ImageIcon(), cai_cai_wo_xinContainer, "猜猜我心");
        ...
        jTabbedpane.addTab("在线搜索", new ImageIcon(), zai_xian_sou_suoContainer, "在线搜索");
        ...
        jTabbedpane.addTab("词语联想", new ImageIcon(), ci_yu_lian_xiangContainer, "词语联想");
        ...
        jTabbedpane.addTab("多国语音", new ImageIcon(), duo_guo_yu_yinContainer, "多国语音");
