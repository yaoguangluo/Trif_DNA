...
//        骨痛.setBounds(10 + 110, 20 + 75, 100, 50);
//        JCheckBox 骨痛_box = new JCheckBox();
//        骨痛_box.setBounds(10 + 60 + 110, 33 + 75, 20, 20);
...
//
//        //copy tab
//        JLabel 肩膀痛 = new JLabel("肩膀痛:");
//        肩膀痛.setForeground(Color.WHITE);
//        肩膀痛.setBounds(10, 20, 100, 50);
//        JCheckBox 肩膀痛_box = new JCheckBox();
//        肩膀痛_box.setBounds(10 + 60, 33, 20, 20);
//        肩膀痛_box.addActionListener(new ActionListener() {
//            @Override
//            public void actionPerformed(ActionEvent arg0) {
//                if (肩膀痛_box.isSelected()) {
//                    if (!name.getText().contains("肩膀痛")) {
//                        name.setText(name.getText() + " 肩膀痛");
//                    }
//                } else {
//                    if (name.getText().contains("肩膀痛")) {
//                        name.setText(name.getText().replace("肩膀痛", ""));
//                    }
//                }
//
//            }
...
//        this.add(肩膀痛_box);
//
//        //copy tab 稍后我做成loop, 减少代码长度
//        JLabel 肢体痛 = new JLabel("肢体痛:");
//        肢体痛.setForeground(Color.WHITE);
//        肢体痛.setBounds(10 + 110, 20 + 100, 100, 50);
//        JCheckBox 肢体痛_box = new JCheckBox();
//        肢体痛_box.setBounds(10 + 60 + 110, 33 + 100, 20, 20);
//        肢体痛_box.addActionListener(new ActionListener() {
//            @Override
//            public void actionPerformed(ActionEvent arg0) {
//                if (肢体痛_box.isSelected()) {
//                    if (!name.getText().contains("肢体痛")) {
//                        name.setText(name.getText() + " 肢体痛");
//                    }
//                } else {
//                    if (name.getText().contains("肢体痛")) {
//                        name.setText(name.getText().replace("肢体痛", ""));
//                    }
//                }
//
//            }
...
//
//        //copy tab 稍后我做成loop, 减少代码长度
//        JLabel 肌肉酸痛 = new JLabel("肌肉酸痛:");
//        肌肉酸痛.setForeground(Color.WHITE);
//        肌肉酸痛.setBounds(10 + 110, 20 + 150, 100, 50);
//        JCheckBox 肌肉酸痛_box = new JCheckBox();
//        肌肉酸痛_box.setBounds(10 + 60 + 110, 33 + 150, 20, 20);
//        肌肉酸痛_box.addActionListener(new ActionListener() {
//            @Override
//            public void actionPerformed(ActionEvent arg0) {
//                if (肌肉酸痛_box.isSelected()) {
//                    if (!name.getText().contains("肌肉酸痛")) {
//                        name.setText(name.getText() + " 肌肉酸痛");
//                    }
//                } else {
//                    if (name.getText().contains("肌肉酸痛")) {
//                        name.setText(name.getText().replace("肌肉酸痛", ""));
//                    }
//                }
//
//            }
