...
//                    if (!name.getText().contains("痰浓")) {
//                        name.setText(name.getText() + " 痰浓");
//                    }
//                } else {
//                    if (name.getText().contains("痰浓")) {
//                        name.setText(name.getText().replace("痰浓", ""));
//                    }
//                }
//
//            }
...
//                    if (!name.getText().contains("痰黄")) {
//                        name.setText(name.getText() + " 痰黄");
//                    }
//                } else {
//                    if (name.getText().contains("痰黄")) {
//                        name.setText(name.getText().replace("痰黄", ""));
//                    }
//                }
//
//            }
...
//                    if (!name.getText().contains("痰白")) {
//                        name.setText(name.getText() + " 痰白");
//                    }
//                } else {
//                    if (name.getText().contains("痰白")) {
//                        name.setText(name.getText().replace("痰白", ""));
//                    }
//                }
//
//            }
...
//                    if (!name.getText().contains("痰多")) {
//                        name.setText(name.getText() + " 痰多");
//                    }
//                } else {
//                    if (name.getText().contains("痰多")) {
//                        name.setText(name.getText().replace("痰多", ""));
//                    }
//                }
//
//            }
...
//                    if (!name.getText().contains("痰少")) {
//                        name.setText(name.getText() + " 痰少");
//                    }
//                } else {
//                    if (name.getText().contains("痰少")) {
//                        name.setText(name.getText().replace("痰少", ""));
//                    }
//                }
//
//            }
...
//                    if (!name.getText().contains("痰稠")) {
//                        name.setText(name.getText() + " 痰稠");
//                    }
//                } else {
//                    if (name.getText().contains("痰稠")) {
//                        name.setText(name.getText().replace("痰稠", ""));
//                    }
//                }
//
//            }
...
//                    if (!name.getText().contains("痰稀")) {
//                        name.setText(name.getText() + " 痰稀");
//                    }
//                } else {
//                    if (name.getText().contains("痰稀")) {
//                        name.setText(name.getText().replace("痰稀", ""));
//                    }
//                }
//
//            }
