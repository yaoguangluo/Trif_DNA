 ...
 * */
public class ZynkxPage_X_S_sListeners extends ZynkxPage_X_S_s implements MouseListener
    , KeyListener {
    //
    public App NE;
...
//		DictionaryDB
        ...
        for (int i = 0; i < copy.size(); i++) {
            tableData_old[i] = new Object[]{"" + (i + 1)
                ...
                dic_zf.containsKey(copy.get(i)) ? dic_zf.get(copy.get(i))//later..
                    .toString().replace("-", " ") : "",
                dic_chu_fang.containsKey(copy.get(i)) ? dic_chu_fang.get(copy.get(i))
                    .toString().replace("-", " ") : "",
    ...
    public void mouseClicked(MouseEvent arg0) {
        ...
        ZhongYaoSearch.zhongYaoSearch(this.app_S, searchYaos, "", searchYaos, NE);
