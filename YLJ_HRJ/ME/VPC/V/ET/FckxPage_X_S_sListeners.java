 ...
 * */
public class FckxPage_X_S_sListeners extends FckxPage_X_S_s implements MouseListener
    , KeyListener {
    ...
    public javax.swing.JTable jTable(App app_NE) {
        ...
        for (int i = 0; i < copy.size(); i++) {
            tableData_old[i] = new Object[]{"" + (i + 1)
                , "" + 0, copy.get(i).replaceAll("〔+", "〔").trim(),
                dic_map.getTrimString(copy.get(i)).replaceAll("〔+", "〔"),
                dic_zl.getTrimString(copy.get(i)), dic_lc.getTrimString(copy.get(i)),
                dic_by.getTrimString(copy.get(i)), dic_zd.getTrimString(copy.get(i)),
                dic_gn.getTrimString(copy.get(i)), dic_lx.getTrimString(copy.get(i)),
                dic_wx.getTrimString(copy.get(i)), dic_bl.getTrimString(copy.get(i)),
                dic_sy.getTrimString(copy.get(i)), dic_bf.getTrimString(copy.get(i)),
                dic_jy.getTrimString(copy.get(i)), dic_yh.getTrimString(copy.get(i)),
                dic_yf.getTrimString(copy.get(i)), dic_yx.getTrimString(copy.get(i))};
        }
