...
public class RestAskPort_E {// implements RestAskPort {
    ...
    public static IMV_SQI ask(String ip, String token, String message
            , String pointIp) {
        String json = null;
        ...
        IMV_SQI jsonCheckMap;
        boolean jsonCheck = true;
        if (null == json) {
            jsonCheckMap = new IMV_SQI();
        ...
        if (jsonCheck) {
            ...
            if (check) {
                ...
                for (int i = 0; i < jobj.length(); i++) {
                    ...
                    IMV_SQI map = VtoV.JsonObjectToMap(obj);
                    map.put("isRead", "true");
                    newjobj.put(map);
                }
                jobj = newjobj;
    ...
    @SuppressWarnings("deprecation")
    public static IMV_SQI feedBack(String ip, String token
            , String pointIp) {
        String json = null;
    ...
    @SuppressWarnings("deprecation")
    public static IMV_SQI getAskers(String token) {
        String json = null;
        if (null != token) {
            json = DetaFrontEndUtil_X_backEndRequest._E("checkStatus?token="
                    + DetaURLEncoder.encodeDeta(token));
    ...
    public static IMV_SQI recordIp(String string) {
        IMV_SQI out = new IMV_SQI();
        out.put("loginInfo", "success");
