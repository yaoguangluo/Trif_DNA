...
public class Rest_C_Port_E {
    ...
    public static IMV_SIQ startResultsBb(int bb, String token, String auth)
        ...
        try {
            ...
            DetaBufferedReader br = new DetaBufferedReader(DetaInputStreamReader.E(
                (conn.getInputStream())));
            String out = "";
            String out1;
...
//return Response.status(Status.OK).entity(result).build();
	...
	/*
	            if(null== redisTemplate.opsForValue().get("click")){
					...
					click_long += 1;
					redisTemplate.opsForValue().set("click", String.valueOf(click_long)
					, 24000, TimeUnit.HOURS);
				}
				//20230106-System.out.println(1111);
		    	EventDispatcher dispatcher= new EventDispatcher();
		        dispatcher.registerHandler(UserCreatedEvent.class, new UserCreatedEventHandler());
				//20230106-System.out.println(2222);
		        User user= new User("iluwatar");
		        dispatcher.dispatch(new UserCreatedEvent(user));

				//20230106-System.out.println(3333);
		    	 IMV_SIQ result=new IMV_SIQ();
