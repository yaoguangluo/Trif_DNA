...
public class RestDB_IUE {
	public static IMV_SIQ insertRowByTablePath(String tablePath,
		...
		output = IU_Rows_E_X_IU_RowByTablePathAndIndex
				.insertRowByTablePathAndIndex(tablePath, pageIndex,
						jaculumnOfNewRow);
		return output;
	}
	...
	public static IMV_SIQ insertRowByBaseName(String baseName, String tableName,
		...
		JSONObject jaculumnOfNewRow = new JSONObject(culumnOfNewRow);
		output = IU_Rows_E_X_IU_RowByBaseName.insertRowByBaseName(baseName,
				tableName, jaculumnOfNewRow, true);
		return output;
	}
}
