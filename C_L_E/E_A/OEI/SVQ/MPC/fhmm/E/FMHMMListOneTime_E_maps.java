 ...
 * */
public class FMHMMListOneTime_E_maps extends FMHMMListOneTime_E_X_S implements FHMMList {
    ...
    public List<String> englishStringToWordsList(String string) {
        ...
        for (int i = 0; i < string.length(); i++) {
            if (StopSymbol_UTF8.symbol.contains(S_Pos.EMPTY_STRING + string.charAt(i))) {
    ...
    public void index() {
        ...
        while ((cInputString = cReader.readDetaLine()) != null) {
            ...
            if (!(!cInputString.replace(S_Pos.SPACE_STRING
                , S_Pos.EMPTY_STRING).equals(S_Pos.EMPTY_STRING)
                && cInputString.split(S_Pos.NLP_SYMBO_SLASH).length > S_Pos.INT_ONE)) {
                continue Here;
            }
            ...
            if (!S_Maps.liangCi.containsKey(cInputString
                ...
                S_Maps.liangCi.put(cInputString
                        .split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO]
                    , new StringBuilder(cInputString.split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ONE]));
            }
    ...
    public void indexFullEnToCn() {
        ...
        while (listcc.hasNext() && listee.hasNext()) {
            fullEnToCn.put(listee.next().split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO].toLowerCase()
    ...
    public void indexFullCnToEn() {
        ...
        while (listcc.hasNext() && listee.hasNext()) {
            fullCnToEn.put(listcc.next().split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO]
                , listee.next().split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO].toLowerCase());
        }
    }
    ...
    public void indexFullCnToFn() {
        ...
        while (listcc.hasNext() && listfn.hasNext()) {
            fullCnToFn.put(listcc.next().split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO]
                , listfn.next().split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO].toLowerCase());
        }
    }
    ...
    public void indexFullCnToKo() {
        ...
        while (listcc.hasNext() && listko.hasNext()) {
            fullCnToKo.put(listcc.next().split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO]
                , listko.next().split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO].toLowerCase());
        }
    }
    ...
    public void indexFullCnToJp() {
        ...
        while (listcc.hasNext() && listjp.hasNext()) {
            fullCnToJp.put(listcc.next().split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO]
                , listjp.next().split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO].toLowerCase());
        }
    }
    ...
    public void indexFullCnToGm() {
        ...
        while (listcc.hasNext() && listgm.hasNext()) {
            fullCnToGm.put(listcc.next().split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO]
                , listgm.next().split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO].toLowerCase());
        }
    }
    ...
    public void indexFullCnToSp() {
        ...
        while (listcc.hasNext() && listsp.hasNext()) {
            fullCnToSp.put(listcc.next().split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO]
                , listsp.next().split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO].toLowerCase());
        }
    }
    ...
    public void indexFullCnToRs() {
        ...
        while (listcc.hasNext() && listrs.hasNext()) {
            fullCnToRs.put(listcc.next().split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO]
                , listrs.next().split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO].toLowerCase());
        }
    }
    ...
    public void indexFullCnToAb() {
        ...
        while (listcc.hasNext() && listab.hasNext()) {
            fullCnToAb.put(listcc.next().split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO]
                , listab.next().split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO].toLowerCase());
        }
    }
    ...
    public void indexFullCnToPy() {
        ...
        while (listcc.hasNext() && listpy.hasNext()) {
            fullCnToPy.put(listcc.next().split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO]
                , listpy.next().split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO].toLowerCase());
        }
    }
    ...
    public void indexFullCnToTt() {
        ...
        while (listcc.hasNext() && listtt.hasNext()) {
            fullCnToTt.put(listcc.next().split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO]
                , listtt.next().split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO].toLowerCase());
        }
    }
    ...
    public void indexPosEnToCn(App NE) {
        ...
        //InputStream in= getClass().getResourceAsStream(S_Pos.WORDS_SOURSE_LINK_POS_EN_TO_CN);
        DetaBufferedReader cReader
            = FastReadProjectFile.getDetaBufferedReader(S_Pos.WORDS_SOURSE_LINK_POS_EN_TO_CN
        ...
        while (null != (cInputString = cReader.readDetaLine())) {
            ...
            posEnToCn.put(cInputString.split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO].toLowerCase()
                , new StringBuilder(cInputString.split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ONE]));
        }
        cReader.closeDeta();
    }
    ...
    public void indexRs(App NE) {
        ...
        DetaBufferedReader cReader
            = FastReadProjectFile.getDetaBufferedReader(S_Pos.WORDS_SOURSE_LINK_POS_CN_TO_RS
            , NE.resourceTail + "lygs/", S_Pos.UTF8_STRING);
        String cInputString;
        while (null != (cInputString = cReader.readDetaLine())) {
    ...
    public void indexPosEnToEn(App NE) {
        ...
        while (null != (cInputString = cReader.readDetaLine())) {
            ...
            if (!(!cInputString.replace(S_Pos.SPACE_STRING, S_Pos.EMPTY_STRING).equals(S_Pos.EMPTY_STRING)
                && cInputString.split(S_Pos.NLP_SYMBO_SLASH).length > S_Pos.INT_ONE)) {
                continue Here;
            }
            posEnToEn.put(cInputString.split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO].toLowerCase(), cInputString
                .split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ONE].toLowerCase());
        }
        cReader.closeDeta();
    }
    ...
    public void indexEnToCn(App NE) {
        enToCn = new IMV_SIQ();
        DetaBufferedReader cReader = FastReadProjectFile.getDetaBufferedReader(S_Pos.WORDS_SOURSE_LINK_EN_TO_CN
            , NE.resourceTail + "lygs/", S_Pos.UTF8_STRING);
        String cInputString;
        Here:
        while (null != (cInputString = cReader.readDetaLine())) {
            ...
            enToCn.put(cInputString.split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO].toLowerCase(), cInputString
    ...
    public void indexCnToEn(App NE) {
        cnToEn = new IMV_SIQ();
        DetaBufferedReader cReader = FastReadProjectFile.getDetaBufferedReader(S_Pos.WORDS_SOURSE_LINK_CN_TO_EN
            , NE.resourceTail + "lygs/", S_Pos.UTF8_STRING);
        String cInputString;
        Here:
        while (null != (cInputString = cReader.readDetaLine())) {
            ...
            cnToEn.put(cInputString.split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ZERO], cInputString
                .split(S_Pos.NLP_SYMBO_SLASH)[S_Pos.INT_ONE].toLowerCase());
        }
        cReader.closeDeta();
    }
    ...
    public Map<Long, FMHMMNode> loopLoadForest(String cInputString) {
        ...
        for (int i = S_Pos.INT_ZERO; i < cInputString.length(); i++) {
            ...
            if (i + S_Pos.INT_ONE < cInputString.length()) {
                ...
                next.put(S_Pos.EMPTY_STRING + cInputString.charAt(i + S_Pos.INT_ONE), S_Pos.INT_ONE);
    ...
    public Map<Long, FMHMMNode> doNeroPostCognitive(FMHMMNode fFHMMNode, String cInputString, int i) {
        ...
        if (i + S_Pos.INT_ONE < cInputString.length()) {
            HashMap.put(S_Pos.EMPTY_STRING + cInputString.charAt(i + S_Pos.INT_ONE)
                , S_Pos.INT_ONE);
        }
    ...
    public Map<Long, FMHMMNode> doCheckAndRunNeroPostFix(FMHMMNode fFHMMNode, String cInputString, int i) {
        if (!fFHMMNode.getNext().containsKey(S_Pos.EMPTY_STRING + cInputString.charAt(i + S_Pos.INT_ONE))) {
            Map<String, Integer> map = fFHMMNode.getNext();
            map.put(S_Pos.EMPTY_STRING + cInputString.charAt(i + S_Pos.INT_ONE), S_Pos.INT_ONE);
    ...
    public void indexFullNegative() {
        ...
        InputStream in = getClass().getResourceAsStream(S_Pos.WORDS_SOURSE_LINK_POS_NEGATIVE);
        DetaBufferedReader cReader = new DetaBufferedReader(DetaInputStreamReader.E(in, S_Pos.UTF8_STRING));
        String cInputString;
        while (null != (cInputString = cReader.readDetaLine())) {
    ...
    public void indexFullPositive() {
        ...
        InputStream in = getClass().getResourceAsStream(S_Pos.WORDS_SOURSE_LINK_POS_POSITIVE);
    ...
    public Map<Long, IMV_SIQ> getWordsForests() {
        ...
        while (WordTree.hasNext()) {
            ...
            if (0 < treeName.length()) {
                IMV_SIQ treeLeafs;
                if (output.containsKey(Long.valueOf(treeName.charAt(S_Pos.INT_ZERO)))) {
                    treeLeafs = output.get(Long.valueOf(treeName.charAt(S_Pos.INT_ZERO)));
                    treeLeafs.put(treeName, posCnToCn.get(treeName));
                    output.put(Long.valueOf(treeName.charAt(S_Pos.INT_ZERO)), treeLeafs);
                } else {
