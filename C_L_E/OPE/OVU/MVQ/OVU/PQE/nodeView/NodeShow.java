...
public class NodeShow extends NodeShow_X_S {
	...
	public NodeShow(GUISample gUISample, Object[][] tableData_old, JTextPane text
			, PopupMenu popupMenu, App NE) {
		this.text= text;
		...
		link= new LinkOSGI();
		first= new OSI_OSU_ASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSI_register(this.tableData_old
				, this.text, NE).Rigester(first, link, NE);
		U_Tree();
	}
