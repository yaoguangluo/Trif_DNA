...
public class UnicornTreeUI extends BasicTreeUI {
     ...
     */
    public void decodeLineStyle(Object lineStyleFlag) {
    ...
    public boolean isLocationInExpandControl(int row, int rowLevel, int mouseX, int mouseY) {
    ...
    public void paintHorizontalSeparators(Graphics g, JComponent c) {
        ...
        for (int i = beginRow; i <= endRow; ++i) {
            ...
            if (path != null && path.getPathCount() == 2) {
                ...
                if (rowBounds != null) {
                    ...
                    g.drawLine(clipBounds.x, rowBounds.y + 1, clipBounds.x
                        + clipBounds.width, rowBounds.y + 1);

                    g.setColor(Color.orange);
                    g.drawLine(clipBounds.x, rowBounds.y + 2, clipBounds.x
                        + clipBounds.width, rowBounds.y + 2);
                }
            }
        }
    }

    public void paintVerticalPartOfLeg(Graphics g, Rectangle clipBounds
    ...
    public void paintHorizontalPartOfLeg(Graphics g, Rectangle clipBounds,
