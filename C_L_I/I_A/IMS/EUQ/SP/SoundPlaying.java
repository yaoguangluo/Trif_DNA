...
public class SoundPlaying implements Runnable {
    ...
    public void PlayFftArray(AdataFrame af, LYGFileIO cur, Jp jp, Object bootSound)
    ...
    public void run() {
        while (jp.reg == 5) {
            ...
            fft[2] = (double) (cur.makeContainerZNSZ.source2 << 5);
            fft[3] = (double) (cur.makeContainerZNSZ.source3 << 5);
            fft[4] = (double) (cur.makeContainerZNSZ.source4 << 5);
            fft[5] = (double) (cur.makeContainerZNSZ.source5 << 5);
            fft[6] = (double) (cur.makeContainerZNSZ.source6 << 5);
            fft[7] = (double) (cur.makeContainerZNSZ.source7 << 5);
            fft[8] = (double) (cur.makeContainerZNSZ.source8 << 5);
            fft[16] = (double) (cur.makeContainerZNSZ.source16 << 5);
            fft[32] = (double) (cur.makeContainerZNSZ.source32 << 5);
            fft[64] = (double) (cur.makeContainerZNSZ.source64 << 5);
            fft[128] = (double) (cur.makeContainerZNSZ.source128 << 5);
            fft[256] = (double) (cur.makeContainerZNSZ.source256 << 5);
            fft[512] = (double) (cur.makeContainerZNSZ.source512 << 5);
