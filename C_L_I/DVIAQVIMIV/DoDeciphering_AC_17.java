...
//if(filePath.contains("阿洪病")) {
                            ...
                            int[][][] doPDEofSkin
                                    = new DoPDEofSkin().doPDEofSkin_AOPM_VECS_IDUQ_TXH_AC(getSkinBy, 95);
//	new	ReadWritePng().writePNG("C:/Users/yaogu/Desktop
                            ///project/开源门户/deciphering/F_DB_20210820.jpg", doPDEofSkin);
                            double[]  getStatisticCount
                                    = new GetStatisticCount().getStatisticCount(doPDEofSkin, 10, 5, 8);
    ...
    public static void main(String[] args) {
        ...
        doDeciphering.setOutputFilePath("C:/Users/yaogu"
                + "/Desktop/project/开源门户/deciphering/F_DB6_suan_17.txt");
