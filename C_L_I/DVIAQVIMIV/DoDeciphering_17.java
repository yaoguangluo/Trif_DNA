...
public class DoDeciphering_17 {
                ...
                if (file.isFile()) {
                    if (null != file.getPath()) {
                        ...
                        if (filePath.contains(".jpg") || filePath.contains(".jpeg")
                            ...
                            int[][][] doPDEofSkin
                                    = new DoPDEofSkin().doPDEofSkin_AOPM_VECS_IDUQ_TXH(getSkinBy, 95);
                            //new	ReadWritePng().writePNG("C:/Users/yaogu
                            ///Desktop/project/开源门户/deciphering/F_DB.jpg", doPDEofSkin);
                            double[]  getStatisticCount
                                    = new GetStatisticCount().getStatisticCount(doPDEofSkin, 10, 2, 8);
    ...
    public static void main(String[] args) {
        ...
        doDeciphering.setOutputFilePath("C:/Users/yaogu/Desktop/project"
