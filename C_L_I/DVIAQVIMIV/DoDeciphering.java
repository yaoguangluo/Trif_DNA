...
public class DoDeciphering {
    ...
    public void imageDeciphering(String indexFileCategoryPath) {
        //1 输入文件夹字符串
                ...
                if (file.isFile()) {
                    if (null != file.getPath()) {
                        ...
                        if (filePath.contains(".jpg") || filePath.contains(".jpeg")
                            ...
                            ///project/开源门户/deciphering/F_DB.jpg", doPDEofSkin);
                            double[]  getStatisticCount
                                    = new GetStatisticCount().getStatisticCount(doPDEofSkin, 10, 8, 8);
                            double[]  getStatisticRatio
                                    = new GetStatisticRatio().getStatisticRatio(getStatisticCount);
                            //4 训练值进行记录
    ...
    public static void main(String[] args) {
        ...
        doDeciphering.setOutputFilePath("C:/Users/yaogu/Desktop"
                + "/project/开源门户/deciphering/F_DB6.txt");
        doDeciphering.imageDeciphering("D:/bu20210606/搜索图片"
                + "/搜索图片/pgSearch");
