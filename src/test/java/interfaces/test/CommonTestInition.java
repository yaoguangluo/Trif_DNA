...
public class CommonTestInition {
	...
	public void initSort(App_S app_S) {
		...
		app_S.studyVerbalMap.putObject("lYGSortESU9D",
			app_S.lYGSortESU9D);
	}
	...
	public void initOrtho(App_S app_S) {
		...
		app_S.studyVerbalMap.putObject("environmentInit",
			app_S.environmentInit);
		app_S.emotionInit = new EmotionInit();
		app_S.studyVerbalMap.putObject("emotionInit",
			app_S.emotionInit);
		app_S.ratioMap_E = new RatioMap_E();// 350m 70m*/
		app_S.studyVerbalMap.putObject("ratioMap_E",
			app_S.ratioMap_E);
		...
		app_S.studyVerbalMap.putObject("emotionSample",
			app_S.emotionSample);
		app_S.sensingTest = new SensingTest();
		app_S.studyVerbalMap.putObject("sensingTest",
			app_S.sensingTest);
		app_S.successICATest = new SuccessICATest();
		app_S.studyVerbalMap.putObject("successICATest",
			app_S.successICATest);
		app_S.sensingMap_E = new SensingMap_E();
		app_S.studyVerbalMap.putObject("sensingMap_E",
			app_S.sensingMap_E);
		app_S.emotionMap_E = new EmotionMap_E();
		app_S.studyVerbalMap.putObject("emotionMap_E",
			app_S.emotionMap_E);
	...
	public void initCNN(App_S app_S) {
		...
		app_S.studyVerbalMap.putObject("rNN_IDETest",
			app_S.rNN_IDETest);
	}
	...
	public void initInitonRoots(App_S app_S) {
		...
		app_S.studyVerbalMap.putObject("_A.wordsForest",
			app_S._A.wordsForest);
