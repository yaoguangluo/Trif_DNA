...
class Sample_X_I_MapAddPluginTest {
	...
	void _E() throws InterruptedException, IOException {
		...
		App_X NE = new App_X();
		// 设置数据库ini文件地址
		// NE.app_S.dbConfigPath="/Users/luoyaoguang430181198505250014/eclipse-workspace
		/// TRIF_DNA/DetaDB/DBconfig.lyg";
		// 配置 模式为无弹窗
		...
		try {
			...
			// 模式1计算//一键导入文件
			// --文件位置-package
			// test.java.InterfaceTest.tinShell.bootBatchFilePLETL;
			// --tinshell OSGI插件密文-tinshellExample.etl --加密方式-普通物理加密方式。
			// --tinshell OSGI插件密钥-tinshellExample.etl.dna
			// --加密方式-普通物理加密方式。
...
/*
 * //输出-注意测试XLS文件是一个纯文字表格文件，不要有图片和特殊符号。 //tinshel花语拆开封装
 * 入2个节点的 ETL存档执行，输出都正确如下
 * 执行->首先获取一个表，名字是临时XLS1753753458245，如果有这个表，准备下一步选择;条件为:和
 * :功效|DNN搜索|功效|菜谱|4;条件为:和:中药名称|包含|菜谱;条件为:和:风险规避|不包含|孕;条件为
 * :和:性味|不包含|凉;条件为:和:性味|不包含|咸; 列数->16 虾菜谱 鲢鱼菜谱 鳝鱼菜谱 鲂鱼菜谱
 * 马铃薯菜谱 山羊蹄菜谱 鳅鱼菜谱 食物咖喱菜谱 西红柿菜谱 鸡鸭鸽子鹌鹑蛋菜谱
 * 执行->获取列名:中药名称:打分:功效;在输出的数据表中仅展示列名 为中药名称，打分和功效列这三个即可;
 * 操作:0|行至|30;操作:中药名称|颜色标记为|红色; 列数->3 <div
 * style="background:black"> <fontcolor="red"><div
 * style="background:black"> <font color="red"><div
 * style="background:black"><font color="red"> <div
 * style="background:black"><font color="red"><div
 * style="background:black"> <font color="red"><div
 * style="background:black"><font color="red"> <div
 ...
 * style="background:black"> <font color="red"><div
 * style="background:black"><font color="red"> <div
 * style="background:black"><font
 * color="red">虾菜谱</font></div></font></div>
 * </font></div></font></div></font></div></font></div></
 * font></div></font></ div> </font></div></font></div> <div
 * style="background:black"><font color="red"><div
 * style="background:black"> <font color="red"><div
 * style="background:black"><font color="red"> <div
 * style="background:black"><font color="red"><div
 ...
 * style="background:black"><font color="red"> <div
 * style="background:black"><font
 * color="red">鲢鱼菜谱</font></div></font></div>
 * </font></div></font></div></font></div></font></div></
 * font></div></font></ div> </font></div></font></div> <div
 * style="background:black"><font color="red"><div
 * style="background:black"> <font color="red"><div
 ...
 * style="background:black"><font color="red"> <div
 * style="background:black"><font
 * color="red">鳝鱼菜谱</font></div></font></div>
 * </font></div></font></div></font></div></font></div></
 * font></div></font></ div> </font></div></font></div> <div
 * style="background:black"><font color="red"><div
 * style="background:black"> <font color="red"><div
 ...
 * style="background:black"><font color="red"> <div
 * style="background:black"><font
 * color="red">鲂鱼菜谱</font></div></font></div>
 * </font></div></font></div></font></div></font></div></
 * font></div></font></ div> </font></div></font></div> <div
 * style="background:black"><font color="red"><div
 * style="background:black"> <font color="red"><div
 ...
 * style="background:black"><font color="red"> <div
 * style="background:black"><font
 * color="red">马铃薯菜谱</font></div></font>
 * </div></font></div></font></div></font></div></font></div
 * ></font></div></ font> </div></font></div></font></div>
 * <div style="background:black"><font color="red"><div
 * style="background:black"> <font color="red"><div
 * style="background:black"><font color="red"> <div
 * style="background:black"><font color="red"><div
 * style="background:black"> <font color="red"><div
 ...
 * style="background:black"><font color="red"> <div
 * style="background:black"><font
 * color="red">鳅鱼菜谱</font></div></font></div>
 * </font></div></font></div></font></div></font></div></
 * font></div></font></ div> </font></div></font></div> <div
 * style="background:black"><font color="red"><div
 * style="background:black"> <font color="red"><div
 ...
 * style="background:black"><font color="red"> <div
 * style="background:black"><font
 * color="red">食物咖喱菜谱</font></div></font>
 * </div></font></div></font></div></font></div></font></div
 * ></font></div></ font> </div></font></div></font></div>
 * <div style="background:black"><font color="red"><div
 * style="background:black"> <font color="red"><div
