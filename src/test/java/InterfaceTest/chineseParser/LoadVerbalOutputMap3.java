...
class LoadVerbalOutputMap3 {
    void exec(Map<String, String>[] verbal, String[] ss, String[] ss1) {
		...
		ss1[62] = "新闻-数据-香-*-*-*-学-将来-合-*-*-中-进行-招生-宣传-今年-在-皖-招-8-人-"
				+ "万-家-热线-安徽-第一-门户-";
		ss1[63] = "微-博-数据-补-了-battle-赛-峰-暴-班-的-两个-弟弟-妹妹-@-杨-宝-心-@-修-儿-一个是"
				+ "-我-很-挺-的-好-弟-弟-一个是-我-推荐-进-好-*-音-的-妹子-虽然-都-在-battle-阶段-"
				+ "都-下来-了-但是-我-依然-像-之前-那样-觉得-你们-非常-棒-"
				+ "";
		ss1[64] = "汽车-论坛-舒适-性-胎-噪-风-噪-偏大-硬-过-坎-弹跳-明显-";
		ss1[65] = "餐-饮-点-评-根-闺-蜜-在-西-单-逛-街-想-吃-寿-司-了-在-西-单-没-搜-到-其他-的-"
				+ "日-料-店-就-来-了-禾-绿-了-我们-俩-都-觉-得-没-以前-好了-";
		/*
		...
		--罗瑶光
		*/
		ss1[66] = "在-伦敦-奥运会-上-将-可能-有-一位-沙-特-阿拉伯-的-女子-";
		//
        for (int i = 52; i < 67; i++) {
