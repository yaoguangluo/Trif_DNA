...
public class LYG9DWithFloatTopSort5D {
	...
	//增加了deep
	private void processFloat(float[] array, int leftPoint,
		int rightPoint, int deep) {
	...
	private int partition(float[] array, int leftPoint,
		int rightPoint) {
		float x = array[leftPoint] <= array[rightPoint]
			? array[leftPoint]
			: array[rightPoint];
