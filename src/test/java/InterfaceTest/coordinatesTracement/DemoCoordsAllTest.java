...
class DemoCoordsAllTest {
	public static void main(String[] argv) {
		DemoCoordsAllTest demoCoordsAllTest = new DemoCoordsAllTest();
		demoCoordsAllTest.testBoot();
	}
	...
	void testBoot() {
		...
		S_logger.Log.logger.info("" + 
			"//处理Distance_X_findPascalMeanDistanceByEachPositions2D");
		DemoCoordsTest._E(inputs);
		S_logger.Log.logger.info("" + "//处理 side end SideEnd_X_getSideEnd2D");
		DemoCoords1Test._E_(inputs);
		S_logger.Log.logger.info("" + "//处理fissile Fissile_X_fissilePosition2D");
		DemoCoords2Test._E(inputs);
		S_logger.Log.logger.info("" + "//处理处理商旅森林 isolation "
			+ "Forest_X_getTSPForestIsolationGroups2D");
		DemoCoords3Test._E(inputs);
		S_logger.Log.logger.info("" + 
			"//处理商旅簇 isolation Isolation_X_getTSPIsolationGroups2D");
		DemoCoords4Test._E(inputs);
		S_logger.Log.logger.info("" + 
			"//处理fusion 先 fissile 采样 Fissile_X_fissilePosition2D");
		DemoCoords5Test._E(inputs);
		S_logger.Log.logger.info("" + "//处理fusion 先 fissile 采样 然后fusion 1 "
		...
		S_logger.Log.logger.info("" + "//处理Classification "
