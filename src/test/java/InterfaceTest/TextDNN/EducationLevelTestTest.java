...
class EducationLevelTestTest {
	public static void main(String[] argv) {
		EducationLevelTestTest educationLevelTestTest = new EducationLevelTestTest();
		educationLevelTestTest.main();
	}
	...
	/*
	 * 这是一个 用于文本的词汇比重计算教育程度的德塔图灵分词个人著作权中的权重内核模块计算 
	 ...
	 * 示输出，方便集成，对程序员友好。系统需要 jdk1.8以上的java环境，本人会把测试的输入
