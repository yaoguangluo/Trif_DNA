 ...
 * */
class Page_X_S_sButtonsenglishTest {

    @Test
    void testData_X_english() {
        DetaButton result = Page_X_S_sButtonsenglish.data_X_english(new Page_X_S_sVSQ(), 0, 0, 0, 0, 0, new App());
