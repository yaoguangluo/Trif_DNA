 ...
 * */
class Page_X_S_sButtonsrollafterTest {

    @Test
    void testData_X_rollafter() {
        DetaButton result = Page_X_S_sButtonsrollafter.data_X_rollafter(new Page_X_S_sVSQ(), 0, new App());
