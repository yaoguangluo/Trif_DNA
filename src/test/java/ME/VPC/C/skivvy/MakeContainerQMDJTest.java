...
class MakeContainerQMDJTest {
    ...
    @InjectMocks
    MakeContainerQMDJ makeContainerQMDJ;
    ...
    @Test
    void testRun() {
        makeContainerQMDJ.run();
    }

    @Test
    void testMouseDragged() {
        makeContainerQMDJ.mouseDragged(null);
    }

    @Test
    void testMouseMoved() {
        makeContainerQMDJ.mouseMoved(null);
    }
}
