...
class CecilDictionaryTest {
    ...
    IMV_SIQ dic_fg;
    @InjectMocks
    CecilDictionary cecilDictionary;
    ...
    void testTxtToListName() {
        List<String> result = cecilDictionary.txtToListName();
        // mock trif Assertions.assertEquals(new ArrayList<>(Arrays.asList("String")), result);
    }

    @Test
    void testListNameToMap() {
        // mock trif IMV_SIQ_ result = cecilDictionary.listNameToMap(new ArrayList<>(Arrays.asList("String")));
        // mock trif Assertions.assertEquals(new IMV_SIQ_(), result);
    }
}
