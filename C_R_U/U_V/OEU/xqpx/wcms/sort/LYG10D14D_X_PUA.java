...
//public class LYG10D14D_X_PUA extends LYG10D13D_X_PA
...
//                int pos = partition2D(kernel, leftPosition
//                        , rightPosition, scale, point, culumn);
//                if (leftPosition < pos - 1) {
//                    processQS4DLYG9D2D(kernel, leftPosition
//                            , pos - 1, scale, point, deep + 1, culumn);
//                }
//                if (pos + 1 < rightPosition) {
//                    processQS4DLYG9D2D(kernel, pos + 1, rightPosition
//                            , scale, point, deep + 1, culumn);
//                }
//                return;
//            }
//            processSort2D(kernel, leftPosition
//                    , rightPosition, scale, point, culumn);
//            return;
//        }
//    }
...
//        String[] x = findSmall2D(array, scale, point, leftPosition
//                , rightPosition, rightPosition, culumn)
