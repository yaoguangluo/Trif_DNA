...
*  208号 阳光家园别墅小区 第十栋别墅
 * */
public class DetaDBBufferToXls {
    ...
    public void main(String[] argv) {
        ...
        //init
        //int cellPhoneColumn= 6;
        String outputXlsFilePath = "C:\\Users\\yaogu\\Desktop\\tolehao\\out202309181.xls";
    ...
    public boolean detaDBBufferToXlsWithTableName(DB db, String outputFile
            , String baseName, String tableName) {
            ...
            for (int i = 0; i < rowLines; i++) {
                ...
                for (int j = 0; j < columnLines; j++) {
                    ...
                    if (specsType[j].equalsIgnoreCase("String")) {
                        String temp = cell.getCellStringValue();
                        hSSFCell.setCellType(CellType.STRING);
                        hSSFCell.setCellValue(temp);
                        ...
                        hSSFCell.setCellValue(longTemp);
                        ...
                        hSSFCell.setCellType(CellType.NUMERIC);
                        hSSFCell.setCellValue(doubleTemp);
