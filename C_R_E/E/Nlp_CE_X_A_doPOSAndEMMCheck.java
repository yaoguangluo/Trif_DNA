...
public class Nlp_CE_X_A_doPOSAndEMMCheck
	...
	public int ofThree(int countLength, List<String> outputList,
		...
		if (S_Maps.shiTaiCi.containsKey(strings[S_Pos.INT_ZERO])) {
			countLength = pos_X_P.P_ShiTaiCiOfThree(outputList, countLength,
					strings, prefixWord);
			return countLength;
		}
		...
		if (B) {
			countLength = pos_X_P.P_FuCiOfThree(outputList, countLength,
					strings, prefixWord);
			return countLength;
		}
	...
	public int ofThreeForMap(int countLength, IMV_SIQ_SS outputList,
		...
		if (S_Maps.zhuCi.containsKey(strings[S_Pos.INT_ZERO])) {
			countLength = pos_X_P.P_ZhuCiOfThreeForMap(outputList, countLength,
					strings, prefixWord, NE);
			return countLength;
		}
		if (S_Maps.liangCi.containsKey(strings[S_Pos.INT_ZERO])) {
			countLength = pos_X_P.P_LiangCiOfThreeForMap(outputList,
					countLength, strings, prefixWord, NE);
			return countLength;
		}
		if (S_Maps.jieCi.containsKey(strings[S_Pos.INT_ZERO])) {
			countLength = pos_X_P.P_JieCiOfThreeForMap(outputList, countLength,
					strings, prefixWord, NE);
			return countLength;
		}
		if (S_Maps.lianCi.containsKey(strings[S_Pos.INT_ZERO])) {
			countLength = pos_X_P.P_LianCiOfThreeForMap(outputList, countLength,
					strings, prefixWord, NE);
			return countLength;
		}
		StringBuilder stringsBuilder = new StringBuilder();
