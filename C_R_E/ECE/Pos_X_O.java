...
public class Pos_X_O extends XCE_XAS implements X_O_parserFirst {
    public int charOfTwo(int countLength, List<String> outputList
        ...
        String postNext = S_Pos.EMPTY_STRING + strings[S_Pos.INT_ONE].charAt(S_Pos.INT_ONE);
...
//三个字中拆分
    public int charOfThree(int countLength, List<String> outputList, String[] strings
    ...
    public int charOfThreeForMap(int countLength, IMV_SIQ_SS outputList
        ...
        if (outputList.containsKey(strings[S_Pos.INT_TWO])) {
            ...
            newWordFrequency.I_frequency(newWordFrequency.get_frequency() + S_Pos.INT_ONE);
        } else {
