...
public class FullTokenPDI {
    ...
    public void run(String[] argv) {
        ...
        //		+ pDE_RNA_FullFormular.pdedsKey+ pDE_RNA_FullFormular.pdeieKey
...
/////INITONS SWAP	
    ...
    private Initon doIncrementE(Initon InitonPDE, InitonLinkDNA initonLinkDNA
        ...
        initonLinkDNA.I_InitonLink(InitonPDE);
        InitonPDE = new PDE_Increment_FullFormular().PDE_IncrementE_DU(initonLinkDNA
    ...
    private Initon doIncrementS(Initon InitonPDE, InitonLinkDNA initonLinkDNA
        ...
        initonLinkDNA.I_InitonLink(InitonPDE);
        InitonPDE = new PDE_Increment_FullFormular().PDE_IncrementS_IQ(initonLinkDNA
    ...
    private Initon doDecrementE(Initon InitonPDE, InitonLinkDNA initonLinkDNA
        ...
        initonLinkDNA.I_InitonLink(InitonPDE);
        InitonPDE = new PDE_Decrement_FullFormular().PDE_DecrementE_DU(initonLinkDNA
            , pDE_RNA_FullFormular, bYS);
        while (InitonPDE.hasPrev()) {
            InitonPDE = InitonPDE.prev;
        }
    ...
    private Initon doDecrementS(Initon InitonPDE, InitonLinkDNA initonLinkDNA
        ...
        initonLinkDNA.I_InitonLink(InitonPDE);
        InitonPDE = new PDE_Decrement_FullFormular().PDE_DecrementS_IQ(initonLinkDNA
            , pDE_RNA_FullFormular, bYS);
        while (InitonPDE.hasPrev()) {
            InitonPDE = InitonPDE.prev;
        }
