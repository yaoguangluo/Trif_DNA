...
public class RangePDI {
    public static void main(String[] argv) {
        ////20230106-System.out.println(new RangePDI().IOE(16, 20));
    }
    ...
    public static double[] Double_IPE_AOPM_VECS_IDUQ_TXH_AC(double[] ps, App NE) {
    ...
    public static String PDS_P_USQ_ECP_I_17(int P_VSQ, int MSP) {
        String ISQ = "";
        while (P_VSQ >= MSP) {
            ISQ += S_MapsInitons.initonsCode.get(S_MapsInitons.initonsSet.get(""
                + P_VSQ / MSP));// P_VSQ;
            P_VSQ %= MSP;
        }
        ISQ += S_MapsInitons.initonsCode.get(S_MapsInitons.initonsSet.get(""
