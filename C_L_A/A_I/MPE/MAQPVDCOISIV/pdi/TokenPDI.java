...
public class TokenPDI {
	...
	public static void main(String[] argv) {	
		...
		//20230106-System.out.println("肽锁:"+ pDE_RNA_Formular.lock);
		//20230106-System.out.println("散列肽语:"+ pDE_RNA_Formular.code);
		...
		//20230106-System.out.println("静态肽展降元概率钥匙E: "+ pDE_RNA_Formular.pdedeKey);
		//20230106-System.out.println("静态肽展降元概率钥匙S: "+ pDE_RNA_Formular.pdedsKey);
		//20230106-System.out.println("静态肽展降元: "+ pDE_RNA_Formular.pds);

		//20230106-System.out.println("静态肽展增元概率钥匙E: "+ pDE_RNA_Formular.pdeieKey);
		//20230106-System.out.println("静态肽展增元概率钥匙S: "+ pDE_RNA_Formular.pdeisKey);
		...
		//20230106-System.out.println("开始Session解析： " + pDE_RNA_Formular.session_key);
		//20230106-System.out.println("开始概率钥匙解析：" + pDE_RNA_Formular.pdedeKey
		...
		//20230106-System.out.println("观测：" + pDE_RNA_Formular.code);
		...
		//20230106-System.out.println(pDE_RNA_Formular.pde.equals(pDE_RNA_Formular1.pde)? "正确": "失败");
		...
		//20230106-System.out.println("准备计算元基DNA序列："+ pDE_RNA_Formular1.pde);
		pDE_RNA_Formular2.doSessionKeyUnPress(pDE_RNA_Formular1.pde, pDE_RNA_Formular2, true);
		//20230106-System.out.println("得到原续降元元基DNA序列："+ pDE_RNA_Formular1.pds);
		//20230106-System.out.println("得到后续降元元基DNA序列："+ pDE_RNA_Formular2.pds);
		//20230106-System.out.println("验证正确？");
		//20230106-System.out.println(pDE_RNA_Formular1.pds.equals(pDE_RNA_Formular2.pds)? "正确": "失败");	
	}
