...
public interface X_O_parserFirst {
    int charOfTwo(int countLength, List<String> outputList, String[] strings
        , StringBuilder[] fixWord);

    int charOfThree(int countLength, List<String> outputList, String[] strings
        , StringBuilder[] fixWord);
