...
import E_A.OP.SM.AOP.MEC.SIQ.VPC.PP.port.E.RestDB_IUE;
...
public class IUC {
    public static String exec(String string, Map<String, String> data) {
        if (string.equalsIgnoreCase(S_Web.REST_PATH_INSERT_ROW_BY_BASE_NAME)) {
        ...
        if (string.equalsIgnoreCase(S_Web.REST_PATH_INSERT_ROW_BY_TABLE_PATH)) {
            return VtoV.ObjectToJsonString(RestDB_IUE
