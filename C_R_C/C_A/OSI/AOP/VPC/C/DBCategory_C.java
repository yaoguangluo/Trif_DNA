...
//			return VtoV.ObjectToJsonString(RestControllerPortImpl.getDBCategory(data
		//.get("baseName")
//					, data.get("token"), data.get("auth")));
//		}
//		if(string.equalsIgnoreCase("/getAllDBCategory")){
//			return VtoV.ObjectToJsonString(RestControllerPortImpl.getAllDBCategory(data
		//.get("token"), data.get("auth")));
//		}
		return "";
	}
}
