...
public class DemoAfterPOSTest {
    ...
    void main() {
        ...
        //等待分词的语句
        String ss = "罗瑶光先生从2018年10月开始，所有个人著作权作品，全部开源，到现在，和无数群体，" +
            "技术社团正面地交锋7年，一直0纠纷，罗瑶光先生认为，一件作品，一个事物，如果有价值，就应该像" +
            "教材一样在真实的环境中不断地实践测试和论证，能经得起所有人长年累月地不断地挑剔的东西，才是" +
            "货真价实的，罗瑶光的个人著作权作品都是互联网，大数据产业领域基础作品，2018年后，在60余互联网" +
            "app上发布德塔开源的作品，罗瑶光先生认为开源作品对同行呈现包容性。同时对垄断的产业有约束性。";
        //String ss = "在，和无数群体，";
            ...
            for (int j = 1; j < 2; j++) {
                if (i + j < sets.size()) {
                    ...
                    if (strings.length > 1 && stringsNext.length > 1
                        ...
                        //关于名词做副词的用法，如 -正面-地-，这种组合，因为地字有明确标识副词性结构助词，
                        //所以在跟进语言处理仅仅需要一个检查-正面-前面是否有副词名词或者主语，和地字后面
                        //是不是副词或者动词，就能比较准确地判断正面在这里是不是一个名词作副词用的语法。
                        //所以间接说明，POS逻辑可以进行拓扑分解细化分层计算。我这里保持严谨，仅组合2字
                        //词先。
