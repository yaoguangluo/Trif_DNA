...
public class DemoPOSTest {
    ...
    void main() {
        ...
        String ss = "罗瑶光先生从2018年10月开始，所有个人著作权作品，全部开源，到现在，和无数群体，" +
            ...
            "货真价实的，罗瑶光的个人著作权作品都是互联网，大数据产业领域基础作品，2018年后，在60余互联" +
            "网app上发布德塔开源的作品，罗瑶光先生认为开源作品对同行呈现包容性。同时对垄断的产业有约束性。";
...
//(正面在我词库中是名词，所以没有参与形容词副词区别分析，后面的地已经表明了副词结构助词，说明了正面这里是名词作副词用)
