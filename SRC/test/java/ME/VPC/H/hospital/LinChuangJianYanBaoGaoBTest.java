 ...
 * */
class LinChuangJianYanBaoGaoBTest {
    @Mock
    List<DetaLabel> jFrameList;
    @Mock
    JTextField 诊断结果_box;
    @Mock
    ...
    //@InjectMocks
    //LinChuangJianYanBaoGaoB linChuangJianYanBaoGaoB;
    ...
    @Test
    void testI_FourthColomns() {
        List<DetaLabel> strings = new ArrayList<>();
        strings.add(new DetaLabel("name"));

        //linChuangJianYanBaoGaoB.I_FourthColomns(null, new ArrayList<>(strings));
    }

    @Test
    void testActionPerformed() {

        //linChuangJianYanBaoGaoB.actionPerformed(null);
    }

    @Test
    void testKeyPressed() {

        //linChuangJianYanBaoGaoB.keyPressed(null);
    }

    @Test
    void testKeyReleased() {

        //linChuangJianYanBaoGaoB.keyReleased(null);
    }

    @Test
    void testKeyTyped() {

        //linChuangJianYanBaoGaoB.keyTyped(null);
    }

    @Test
    void testMouseClicked() {

        //linChuangJianYanBaoGaoB.mouseClicked(null);
    }

    @Test
    void testMouseEntered() {

        //linChuangJianYanBaoGaoB.mouseEntered(null);
    }

    @Test
    void testMouseExited() {

        //linChuangJianYanBaoGaoB.mouseExited(null);
    }

    @Test
    void testMousePressed() {

        //linChuangJianYanBaoGaoB.mousePressed(null);
    }

    @Test
    void testMouseReleased() {

        //linChuangJianYanBaoGaoB.mouseReleased(null);
    }

    @Test
    void testPrintValue() {
        //mock trif   linChuangJianYanBaoGaoB.printValue(null, "minString", "maxString", "elseString", Double.valueOf(0), Double.valueOf(0), null, "yinyang");
    }

    @Test
    void testMouseDragged() {

        //linChuangJianYanBaoGaoB.mouseDragged(null);
    }

    @Test
    void testMouseMoved() {
        //mock trif  linChuangJianYanBaoGaoB.mouseMoved(null);
    }
}
