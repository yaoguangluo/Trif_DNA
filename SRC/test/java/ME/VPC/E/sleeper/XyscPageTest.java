...
class XyscPageTest {
    ...
    @Test
    void testData() {
        JTextPane result = xyscPage.data(new App());
        //todo trif Assertions.assertEquals(null, result);
    }

    @Test
    void testStatistic() {
        JTextPane result = xyscPage.statistic();
        //todo trif Assertions.assertEquals(null, result);
    }

    @Test
    void testName() {
        JTextField result = xyscPage.name();
        //todo trif Assertions.assertEquals(null, result);
    }

    @Test
    void testJTable() {
       // JTable result = xyscPage.jTable(new App());
        //todo trif Assertions.assertEquals(null, result);
    }

    @Test
    void testMouseClicked() {
        xyscPage.mouseClicked(null);
    }

    @Test
    void testMouseEntered() {
        xyscPage.mouseEntered(null);
    }

    @Test
    void testMouseExited() {
        xyscPage.mouseExited(null);
    }

    @Test
    void testMousePressed() {
        xyscPage.mousePressed(null);
    }

    @Test
    void testMouseReleased() {
        xyscPage.mouseReleased(null);
    }

    @Test
    void testKeyPressed() {
        xyscPage.keyPressed(null);
    }
    ...
    void testDoFwaArrangement() {
        ...
        IMV_SIQ_S_ result = xyscPage.doFwaArrangement(new IMV_SIQ_SS(), new App());
        //todo trif Assertions.assertEquals(new IMV_SIQ_S_(), result);
    }

    @Test
    void testInitPage() {
        xyscPage.initPage(null, new App());
    }
    ...
    void testTableSections() {
        xyscPage.tableSections(new App());
    }
}
