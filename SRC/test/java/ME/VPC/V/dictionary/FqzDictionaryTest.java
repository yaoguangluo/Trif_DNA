...
class FqzDictionaryTest {
    ...
    void testTxtToListName() {
        List<String> result = fqzDictionary.txtToListName();
        // mock trif   Assertions.assertEquals(new ArrayList<>(Arrays.asList("String")), result);
    }

    @Test
    void testListNameToMap() {
        // mock trif  IMV_SIQ_ result = fqzDictionary.listNameToMap(new ArrayList<>(Arrays.asList("String")));
