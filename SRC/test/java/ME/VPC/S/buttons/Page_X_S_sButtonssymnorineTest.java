 ...
 * */
class Page_X_S_sButtonssymnorineTest {

    @Test
    void testData_X_symnorine() {
        DetaButton result = Page_X_S_sButtonssymnorine.data_X_symnorine(new Page_X_S_sVSQ(), 0, 0, 0, 0, 0, new App());
