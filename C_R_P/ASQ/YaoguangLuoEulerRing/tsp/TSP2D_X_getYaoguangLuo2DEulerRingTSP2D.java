 ...
 * */
public class TSP2D_X_getYaoguangLuo2DEulerRingTSP2D {
    //Foundation: Euler
    //Theory: Yaoguang.Luo
    ...
    public static List<Line2D> _E(List<AMV_MVS_VSQ_2D> AMV_MVS_VSQs) {
        ...
        while (iteratorOuter.hasNext()) {
            ...
            for (Object _AMV_MVS_VSQ2DInner : _AMV_MVS_VSQs) {
                AMV_MVS_VSQ_2D AMV_MVS_VSQ2DInner = (AMV_MVS_VSQ_2D) _AMV_MVS_VSQ2DInner;
                ...
                if (!(!Objects.equals(AMV_MVS_VSQ2DOuter.getX(), AMV_MVS_VSQ2DInner.getX())
        ...
        //3 sort line2D
        double[] distance = new double[linesMap.size()];
