...
*  208号 阳光家园别墅小区 第十栋别墅
 * */
public class TSP2D_X_getYaoguangLuo3DEulerRingTSP2D {
    //Foundation: Euler
    //Theory: Yaoguang.Luo
    ...
    public static List<Line3D> _E(List<AMV_MVS_VSQ_3D> AMV_MVS_VSQs) {
        ...
        while (iteratorOuter.hasNext()) {
            ...
            while (iteratorInner.hasNext()) {
                ...
                if (!(!Objects.equals(AMV_MVS_VSQ3DOuter.getX(), AMV_MVS_VSQ3DInner.getX())
                    || !Objects.equals(AMV_MVS_VSQ3DOuter.getY(), AMV_MVS_VSQ3DInner.getY())
                    || !Objects.equals(AMV_MVS_VSQ3DOuter.getZ(), AMV_MVS_VSQ3DInner.getZ()))) {
                    continue;
                }
                IMV_SIQ map;
                if (indexMap.containsKey(AMV_MVS_VSQ3DOuter.getTag())) {
                    map = indexMap.getStringMap(AMV_MVS_VSQ3DOuter.getTag());
                } else {
                    map = new IMV_SIQ();
                }
