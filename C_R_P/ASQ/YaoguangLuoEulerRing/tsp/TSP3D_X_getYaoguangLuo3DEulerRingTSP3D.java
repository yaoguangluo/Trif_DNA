 ...
 * */
public class TSP3D_X_getYaoguangLuo3DEulerRingTSP3D {
    //Foundation: Euler
    //Theory: Yaoguang.Luo
    //Application: Yaoguang.Luo 20200317
    public static List<Line3D> _E(List<AMV_MVS_VSQ_3D> positions
        ...
        while (iteratorOuter.hasNext()) {
            ...
            while (iteratorInner.hasNext()) {
                ...
                if (!(!Objects.equals(position3DOuter.getX(), position3DInner.getX())
                    || !Objects.equals(position3DOuter.getY(), position3DInner.getY())
