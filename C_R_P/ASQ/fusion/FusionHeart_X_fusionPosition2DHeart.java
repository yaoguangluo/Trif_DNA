...
*  208号 阳光家园别墅小区 第十栋
// * */
//public class FusionHeart_X_fusionPosition2DHeart{
//	public static AMV_MVS_VSQ_2D _E(
//			Map<Double, List<AMV_MVS_VSQ_2D>> groups){
//		List<AMV_MVS_VSQ_2D> hearts= new ArrayList<>();
//		for (double value : groups.keySet()) {
//			AMV_MVS_VSQ_2D AMV_MVS_VSQHeart = Euclid_X_findHeartPosition2D._E(groups.get(value));
//			hearts.add(AMV_MVS_VSQHeart);
//		}
//		return Euclid_X_findHeartPosition2D._E(hearts);
//	}
//}
//
