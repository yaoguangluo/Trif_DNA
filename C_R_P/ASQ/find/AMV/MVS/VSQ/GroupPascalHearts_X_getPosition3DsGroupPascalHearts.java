...
import ASQ.demension.AMV.MVS.VSQ.FindHeart_X_getPosition3DGroupsHearts;
 ...
 * */
public class GroupPascalHearts_X_getPosition3DsGroupPascalHearts {
    ...
    public static Map<Double, AMV_MVS_VSQ_3D> _E(
        ...
        return (Map<Double, AMV_MVS_VSQ_3D>) FindHeart_X_getPosition3DGroupsHearts._E(pascalGroups);
    }
}
