 ...
 * */
public class GroupPascalHearts_X_getPosition3DsGroupPascalDirection {
    ...
    public static Map<Double, Line3D> _E(ArrayList<AMV_MVS_VSQ_3D> groups
        , double scale) {
        return _E(
            GroupPascalHearts_X_getPosition3DsGroupPascalHearts._E(groups, scale)
            , GroupPascalHearts_X_getPosition3DsGroupPascalMids._E(groups, scale));
    }
