...
*  208号 阳光家园别墅小区 第十栋
 * */
public class ByHearts_X_trackTracePosition3DByHearts {
    ...
    //作者 罗瑶光
    public static List<AMV_MVS_VSQ_3D> _E(List<AMV_MVS_VSQ_3D> hearts) {
        ...
        while (iterator.hasNext()) {
            ...
            //add section 1234
            AMV_MVS_VSQ_3D newPosition3D
                = new AMV_MVS_VSQ_3D(heartPostion.getX() * 2 - lastPosition3D.getX()
