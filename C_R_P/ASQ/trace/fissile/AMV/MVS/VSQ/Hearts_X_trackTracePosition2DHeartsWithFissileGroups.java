...
*  208号 阳光家园别墅小区 第十栋
 * */
public class Hearts_X_trackTracePosition2DHeartsWithFissileGroups {
    ...
    _E(List<AMV_MVS_VSQ_2D> coods, double distanceScale) {
        ...
        while (iterator.hasNext()) {
            ...
            if (distanceGroups.isEmpty()) {
                ...
                //
                List<AMV_MVS_VSQ_2D> listHeartsTrace = output.get_List_AMV_MVS_VSQ_2D(i);
                ...
                while (iteratorScale.hasNext()) {
                    ...
                    AMV_MVS_VSQ_2D currenctHeart = output.get_List_AMV_MVS_VSQ_2D(doubleScale)
                        .get(output.get_List_AMV_MVS_VSQ_2D(doubleScale).size() - 1);
                    ...
                    if (distance < distanceScale) {
                        ...
                        //删除当前重心数据, 更新重心数据轨迹
                        List<AMV_MVS_VSQ_2D> listHeartsTrace = output.get_List_AMV_MVS_VSQ_2D(doubleScale);
