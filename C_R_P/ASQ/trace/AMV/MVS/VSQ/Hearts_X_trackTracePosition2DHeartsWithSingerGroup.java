...
*  208号 阳光家园别墅小区 第十栋
 * */
public class Hearts_X_trackTracePosition2DHeartsWithSingerGroup {
    //Source: 《2维 3维 坐标集 切裂 重心 轨迹 跟踪算法JAVA源码》
    //出版日期2019 年 12 月 21 日  作品说明Gitee, Github, DetaOSS
    //作品说明适用于 坐标团 动态分析, 增量轨迹分析, 熵增信息单元记录。
    //作者 罗瑶光
    public static List<AMV_MVS_VSQ_2D> _E(List<AMV_MVS_VSQ_2D> coods) {
        ...
        while (iterator.hasNext()) {
            if (isFirst) {
                ...
                AMV_MVS_VSQ_2D CryptHeart
                    = Euclid_X_findCryptionPosition2D._E(hearts.get(hearts.size() - 1), position2D);
