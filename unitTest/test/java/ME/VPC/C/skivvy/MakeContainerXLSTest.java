...
import ME.VPC.C.skivvy.MakeContainerXLS;
...
class MakeContainerXLSTest {
    @Mock
    CommonXls jpanelSecond;
    @Mock
    App_S u;
    @Mock
    ...
    @InjectMocks
    MakeContainerXLS makeContainerXLS;
    ...
    @Test
    void testRun() {
        makeContainerXLS.run();
    }

    @Test
    void testAOP_VEC_SQ() {
        makeContainerXLS.AOP_VEC_SQ("input");
    }
}
