package test.java.ME.VPC.C.skivvy;
...
class MakeContainer_ZHONG_YAOTest {
    @Mock
    ZhongYaoTableSimple zhongYaoTableSimple;
    @Mock
    ...
    JPanel panel_bg;
    @Mock
    TaskMakeCoWorker taskMakeCoWorker;
    @Mock
    AE _A;
    @Mock
    IMV_SIQ pos;
    ...
    ANNTest aNNTest;
    @Mock
    RNN_IDETest rNN_IDETest;
    @Mock
    Container jpanelFourth;
    @Mock
    ...
    @InjectMocks
    MakeContainer_ZHONG_YAO makeContainer_ZHONG_YAO;
    ...
    void testMouseClicked() {
        makeContainer_ZHONG_YAO.mouseClicked(null);
    }

    @Test
    void testMouseEntered() {
        makeContainer_ZHONG_YAO.mouseEntered(null);
    }

    @Test
    void testMouseExited() {
        makeContainer_ZHONG_YAO.mouseExited(null);
    }

    @Test
    void testMousePressed() {
        makeContainer_ZHONG_YAO.mousePressed(null);
    }

    @Test
    void testMouseReleased() {
        makeContainer_ZHONG_YAO.mouseReleased(null);
    }
}
