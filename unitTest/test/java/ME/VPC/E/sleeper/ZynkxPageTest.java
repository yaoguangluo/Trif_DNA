...
//
//    @Test
//    void testPageButtons() {
//        zynkxPage.PageButtons();
//    }
//
//    @Test
//    void testData() {
//        JTextPane result = zynkxPage.data(new App());
//        //mock trifAssertions.assertEquals(null, result);
//    }
//
//    @Test
//    void testStatistic() {
//        JTextPane result = zynkxPage.statistic();
//        //mock trif Assertions.assertEquals(null, result);
//    }
//
//    @Test
//    void testName() {
//        JTextField result = zynkxPage.name();
//        //mock trifAssertions.assertEquals(null, result);
//    }
//
//    @Test
//    void testJTable() {
//        JTable result = zynkxPage.jTable(new App());
//        //mock trif Assertions.assertEquals(null, result);
//    }
//
//    @Test
//    void testMouseClicked() {
//        when(_A.parserMixedString(anyString())).thenReturn(
//            new ArrayList<String>(Arrays.asList("String"))
//        );
//
//        //mock trif zynkxPage.mouseClicked(null);
//    }
//
//    @Test
//    void testMouseEntered() {
//        zynkxPage.mouseEntered(null);
//    }
//
//    @Test
//    void testMouseExited() {
//        zynkxPage.mouseExited(null);
//    }
//
//    @Test
//    void testMousePressed() {
//        zynkxPage.mousePressed(null);
//    }
//
//    @Test
//    void testMouseReleased() {
//        zynkxPage.mouseReleased(null);
//    }
//
//    @Test
//    void testKeyPressed() {
//        zynkxPage.keyPressed(null);
//    }
//
//    @Test
...
//
//        //mock trif zynkxPage.keyReleased(null);
//    }
//
//    @Test
//    void testKeyTyped() {
//        zynkxPage.keyTyped(null);
//    }
//
//    @Test
//    void testDoFwaArrangement() {
//        when(_A.sortWordFrequencyMapToSortMap(any())).thenReturn(new IMV_SQI_S_());
////mock trif
////        IMV_SQI_S_ result = zynkxPage.doFwaArrangement(new IMV_SQI_SS(), new App());
////        Assertions.assertEquals(new IMV_SQI_S_(), result);
//    }
//
//    @Test
//    void testInitPage() {
//        //mock trif zynkxPage.initPage(null, new App());
//    }
//
//    @Test
//    void testSimpleClicked() {
//        when(_A.sortWordFrequencyMapToSortMap(any())).thenReturn(new IMV_SQI_S_());
//        when(_A.parserMixedString(anyString())).thenReturn(new ArrayList<String>(Arrays.asList("String")));
//
//        //mock trif zynkxPage.simpleClicked(new App());
//    }
//
//    @Test
//    void testTableSections() {
//        zynkxPage.tableSections(new App());
//    }
//}
//
