...
//    @Test
//    void testData() {
//        JTextPane result = fqzPage.data(new App());
//        //Assertions.assertEquals(null, result);
//    }
//
//    @Test
//    void testStatistic() {
//        JTextPane result = fqzPage.statistic();
//        //Assertions.assertEquals(null, result);
//    }
//
//    @Test
//    void testName() {
//        JTextField result = fqzPage.name();
//        //Assertions.assertEquals(null, result);
//    }
//
//    @Test
...
//
//        JTable result = fqzPage.jTable(new App());
//       // Assertions.assertEquals(null, result);
//    }
//
//    @Test
//    void testMouseClicked() {
//        fqzPage.mouseClicked(null);
//    }
//
//    @Test
//    void testMouseEntered() {
//        fqzPage.mouseEntered(null);
//    }
//
//    @Test
//    void testMouseExited() {
//        fqzPage.mouseExited(null);
//    }
//
//    @Test
//    void testMousePressed() {
//        fqzPage.mousePressed(null);
//    }
//
//    @Test
//    void testMouseReleased() {
//        fqzPage.mouseReleased(null);
//    }
//
//    @Test
//    void testKeyPressed() {
//        fqzPage.keyPressed(null);
//    }
//
//    @Test
//    void testKeyReleased() {
//        when(_A.parserMixStringByReturnFrequencyMap(anyString(), any())).thenReturn(new IMV_SQI_SS());
...
//
//        //fqzPage.keyReleased(null);
//    }
//
//    @Test
//    void testKeyTyped() {
//        fqzPage.keyTyped(null);
//    }
//
//    @Test
...
//
//        IMV_SQI_S_ result = fqzPage.doFwaArrangement(new IMV_SQI_SS(), new App());
//        //Assertions.assertEquals(new IMV_SQI_S_(), result);
//    }
//
//    @Test
//    void testInitPage() {
//        fqzPage.initPage(null, new App());
//    }
//
//    @Test
...
//        //when(_A.parserMixedString(anyString())).thenReturn(List.of("String"));
//
//        fqzPage.simpleClicked(new App());
//    }
//
//    @Test
//    void testTableSections() {
//        fqzPage.tableSections(new App());
//    }
//}
//
