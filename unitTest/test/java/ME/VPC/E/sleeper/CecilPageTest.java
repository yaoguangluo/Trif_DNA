...
//
//        JTextPane result = cecilPage.data(new App());
//        //Assertions.assertEquals(null, result);
//    }
//
//    @Test
//    void testStatistic() {
//        JTextPane result = cecilPage.statistic();
//        //Assertions.assertEquals(null, result);
//    }
//
//    @Test
//    void testName() {
//        JTextField result = cecilPage.name();
//        //Assertions.assertEquals(null, result);
//    }
//
//    @Test
//    void testJTable() {
//        JTable result = cecilPage.jTable(new App());
//        //Assertions.assertEquals(null, result);
//    }
//
//    @Test
...
//        when(dic_yx.getString(anyString())).thenReturn("getStringResponse");
//
//        cecilPage.mouseClicked(null);
//    }
//
//    @Test
//    void testMouseEntered() {
//        cecilPage.mouseEntered(null);
//    }
//
//    @Test
//    void testMouseExited() {
//        cecilPage.mouseExited(null);
//    }
//
//    @Test
//    void testMousePressed() {
//        cecilPage.mousePressed(null);
//    }
//
//    @Test
//    void testMouseReleased() {
//        cecilPage.mouseReleased(null);
//    }
//
//    @Test
//    void testKeyPressed() {
//        cecilPage.keyPressed(null);
//    }
//
//    @Test
...
//        when(dic_yx.getString(anyString())).thenReturn("getStringResponse");
//
//        cecilPage.keyReleased(null);
//    }
//
//    @Test
//    void testKeyTyped() {
//        cecilPage.keyTyped(null);
//    }
//
//    @Test
...
//
//        IMV_SQI_S_ result = cecilPage.doFwaArrangement(new IMV_SQI_SS(), new App());
//        //Assertions.assertEquals(new IMV_SQI_S_(), result);
//    }
//
//    @Test
//    void testInitPage() {
//        cecilPage.initPage(null, new App());
//    }
//
//    @Test
...
//        //when(_A.parserMixedString(anyString())).thenReturn(List.of("String"));
//
//        cecilPage.simpleClicked(new App());
//    }
//
//    @Test
//    void testTableSections() {
//        cecilPage.tableSections(new App());
//    }
//}
//
