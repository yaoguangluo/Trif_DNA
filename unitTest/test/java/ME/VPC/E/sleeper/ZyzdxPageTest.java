...
//        zyzdxPage.PageButtons(new App());
//    }
//
//    @Test
//    void testData() {
//        JTextPane result = zyzdxPage.data(new App());
//        //mock trif Assertions.assertEquals(null, result);
//    }
//
//    @Test
//    void testStatistic() {
//        JTextPane result = zyzdxPage.statistic();
//        //mock trif Assertions.assertEquals(null, result);
//    }
//
//    @Test
//    void testName() {
//        JTextField result = zyzdxPage.name();
//        //mock trif Assertions.assertEquals(null, result);
//    }
//
//    @Test
//    void testJTable() {
//        JTable result = zyzdxPage.jTable(new App());
//        //mock trif  Assertions.assertEquals(null, result);
//    }
//
//    @Test
//    void testMouseClicked() {
//        //mock trif  zyzdxPage.mouseClicked(null);
//    }
//
//    @Test
//    void testMouseEntered() {
//        zyzdxPage.mouseEntered(null);
//    }
//
//    @Test
//    void testMouseExited() {
//        zyzdxPage.mouseExited(null);
//    }
//
//    @Test
//    void testMousePressed() {
//        zyzdxPage.mousePressed(null);
//    }
//
//    @Test
//    void testMouseReleased() {
//        zyzdxPage.mouseReleased(null);
//    }
//
//    @Test
//    void testKeyPressed() {
//        zyzdxPage.keyPressed(null);
//    }
//
//    @Test
//    void testKeyReleased() {
//        //mock trif zyzdxPage.keyReleased(null);
//    }
//
//    @Test
//    void testKeyTyped() {
//        zyzdxPage.keyTyped(null);
//    }
//
//    @Test
...
//
//        //mock trif IMV_SQI_S_ result = zyzdxPage.doFwaArrangement(new IMV_SQI_SS(), new App());
//        //mock trif  Assertions.assertEquals(new IMV_SQI_S_(), result);
//    }
//
//    @Test
//    void testInitPage() {
//        //mock trif  zyzdxPage.initPage(null, new App());
//    }
//
//    @Test
...
//
//        //mock trif  zyzdxPage.simpleClicked(new App());
//    }
//
//    @Test
//    void testTableSections() {
//        zyzdxPage.tableSections(new App());
//    }
//}
//
