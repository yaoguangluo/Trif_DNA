 ...
 * */
class LinChuangJianYanBaoGaoATest {
    @Mock
    ...
    //@InjectMocks
    //LinChuangJianYanBaoGaoA linChuangJianYanBaoGaoA;
    ...
    @Test
    void testPrintValue() {
        //mock trif  linChuangJianYanBaoGaoA.printValue(null, "minString", "maxString", "elseString", Double.valueOf(0), Double.valueOf(0), null, "yinyang");
    }
    ...
    void testI_FourthColomns() {
        ...
        //linChuangJianYanBaoGaoA.I_FourthColomns(null, new ArrayList<>(strings));
    }

    @Test
    void testActionPerformed() {

        //linChuangJianYanBaoGaoA.actionPerformed(null);
    }

    @Test
    void testMouseClicked() {

        //linChuangJianYanBaoGaoA.mouseClicked(null);
    }

    @Test
    void testMouseEntered() {
        //linChuangJianYanBaoGaoA.mouseEntered(null);
    }

    @Test
    void testMouseExited() {
        //linChuangJianYanBaoGaoA.mouseExited(null);
    }

    @Test
    void testMousePressed() {
        //linChuangJianYanBaoGaoA.mousePressed(null);
    }

    @Test
    void testMouseReleased() {
        //linChuangJianYanBaoGaoA.mouseReleased(null);
    }

    @Test
    void testMouseDragged() {
        //linChuangJianYanBaoGaoA.mouseDragged(null);
    }

    @Test
    void testMouseMoved() {
       //mock trif linChuangJianYanBaoGaoA.mouseMoved(null);
    }
}
