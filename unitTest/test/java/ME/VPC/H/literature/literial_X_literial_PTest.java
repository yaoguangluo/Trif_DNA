 ...
 * */
class literial_X_literial_PTest {
    @Mock
    ...
    @Test
    void testLiterial_P() {
        when(literialVerbalBaseMap.getString(anyString())).thenReturn("getStringResponse");

        String result = literial_X_literial_P.literial_P(new App_S(), "input");
