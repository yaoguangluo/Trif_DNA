 ...
 * */
class Page_X_S_sButtons_zhong_yao_DNNTest {

    @Test
    void testdata_X_zhong_yao_DNN() {
        DetaButton result = Page_X_S_sButtons_zhong_yao_DNN.data_X_zhong_yao_DNN(new Page_X_S_sVSQ(), 0, 0, 0, 0, 0, 0, new App());
