 ...
 * */
class Page_X_S_sButtonschineseTest {

    @Test
    void testData_X_chinese() {
        DetaButton result = Page_X_S_sButtonschinese.data_X_chinese(new Page_X_S_sVSQ(), 0, 0, 0, 0, 0, new App());
