...
import ME.VPC.E.sleeper.PageButtons;
import ME.VPC.E.sleeper.PageUtil;
 ...
 * */
public class CommonXls extends CommonXlsPage_X_S_sListeners implements MouseListener {
    //

    public CommonXls(JTextPane text, String fileType, String pageName, App app_NE) {
        NE = app_NE;
        this.emotionSample = NE.app_S.emotionSample;
        this.ratioMap = NE.app_S.ratioMap_E;
        this.ratioMap_E = NE.app_S.ratioMap_E;
        this.sensingTest = NE.app_S.sensingTest;
        this.pageName = pageName;
        this.xlsFilePath = NE._I_U.tempString;
        app_S = NE.app_S;
        initPage(text, NE);
        this.setLayout(null);
        ...
        JScrollPane jsp = new JScrollPane(this.jTable(fileType, NE));
    ...
    public JTextPane data(App NE) {
        ...
        buttonKSLJ.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                AppButtonUtil_X_DNN_Page.pageDNN(page
                    , sets, currentPage, app_S, table, row, key
                    , buttonSum, buttonCrt, data, statistic, "中药", NE);
            }
        });
            ...
            new ChangeListener() {
                public void stateChanged(ChangeEvent event) {
                    ...
                    AppButtonUtil_X_DNN_Classify.classifyDNN(page
                        , sets, currentPage, table, row, key, buttonSum
                        , buttonCrt, data, statistic, "西药", NE);
                }
            });
