...
public class StaticFunctionMapA_IDUQ_E extends StaticFunctionMapCASE
	...
	public static void main(String[] argv) {
		...
		NE._I_U.pDE_RNA_FullFormular_X = StaticFunctionMapA_IDUQ_C
			.doPDE(NE);
		NE._I_U.pDE_RNA_FullFormularNew = StaticFunctionMapA_IDUQ_C
			.doPrefixPDE(NE);
		PDI_X_ pDE_RNA_FullFormular2 = StaticFunctionMapA_IDUQ_C
			.doPostfixPDE(NE);
		PDI_X_ pDE_RNA_FullFormular3 = StaticFunctionMapA_IDUQ_C
			.doSurffixPDE(NE);
	}
}
