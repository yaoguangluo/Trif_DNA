...
public class StaticFunctionMapU_AOPM_E implements StaticFunctionMapU_AOPM_C {
	...
	// public double[] [] GO(int[][] kener, int[][] refG, int[]
	// size){
	// return null;};
	...
	// public String EncoderByMd5(String salt, String pwd, int
	// enctimes)
	// throws NoSuchAlgorithmException
	// {};
	// public String EncoderByMd5(String salt, String pwd)
	// throws NoSuchAlgorithmException
	// {};
	...
	public boolean fileToZip(App NE) {
		...
		return false;
		// return BootBackup.fileToZip(sourceFilePath._S_,
		// zipFilePath._S_, fileName._S_);
	}
