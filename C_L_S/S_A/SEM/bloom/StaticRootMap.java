...
public class StaticRootMap {
    ...
    //20230207 走统计新陈代谢
    public static Map<String, Long> staticBloomingTimes = new IMV_SIQ();//需要 new
    public static Map<String, Long> staticBloomingTime = new IMV_SIQ();//需要 new 稍后分出去，先用来做只执行固定次数的函数统计
    public static Map<String, Long> staticBloomingDuration = new IMV_SIQ();//需要 new
    ...
    public static void tinShellV006(String[] shellCommands, IMV_SIQ shellOutput, App NE) {
        tinShellV005(shellCommands, shellOutput, NE);
        //+++++later
    }

    @SuppressWarnings("static-access")
    public static void tinShellV005(String[] shellCommands, IMV_SIQ shellOutput, App NE) {
...
//			doQ_VECS_Case(StaticRootMap.staticRootMap, string, output, NE);
    ...
    private static void doA_VECS_Case(Map<String, StaticClassMap> staticRootMap, String string
        , IMV_SIQ output, App NE) {
        StaticFunctionMapA_VECS_E staticFunctionMapA_VECS_C
            = (StaticFunctionMapA_VECS_E) StaticRootMap.staticClassMap.get("A_VECS");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doA_VECS_CaseFunction(new CallFunctionKey(callFunctionKey), string
                    , staticFunctionMapA_VECS_C, output, NE);
                StaticRootMap.staticBloomingTimes.put(callFunctionKey
                    , StaticRootMap.staticBloomingTimes.get(callFunctionKey) + 1);
            }
        }
    }

    private static void doP_VECS_Case(Map<String, StaticClassMap> staticRootMap, String string
        , IMV_SIQ output, App NE) {
        StaticFunctionMapP_VECS_E staticFunctionMapP_VECS_C
            = (StaticFunctionMapP_VECS_E) StaticRootMap.staticClassMap.get("P_VECS");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doP_VECS_CaseFunction(new CallFunctionKey(callFunctionKey), string
    ...
    private static void doO_IDUQ_Case(Map<String, StaticClassMap> staticRootMap, String string
        , IMV_SIQ output, App NE) {
        StaticFunctionMapO_IDUQ_E staticFunctionMapO_IDUQ_C
            = (StaticFunctionMapO_IDUQ_E) StaticRootMap.staticClassMap.get("O_IDUQ");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doO_IDUQ_CaseFunction(new CallFunctionKey(callFunctionKey), string
    ...
    private static void doO_VECS_Case(Map<String, StaticClassMap> staticRootMap
        ...
        StaticFunctionMapO_VECS_E staticFunctionMapO_VECS_C
            = (StaticFunctionMapO_VECS_E) StaticRootMap.staticClassMap.get("O_VECS");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doO_VECS_CaseFunction(new CallFunctionKey(callFunctionKey), string
    ...
    private static void doA_IDUQ_Case(Map<String, StaticClassMap> staticRootMap
        ...
        StaticFunctionMapA_IDUQ_E staticFunctionMapA_IDUQ_C
            = (StaticFunctionMapA_IDUQ_E) StaticRootMap.staticClassMap.get("A_IDUQ");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doA_IDUQ_CaseFunction(new CallFunctionKey(callFunctionKey), string
    ...
    private static void doU_VECS_Case(Map<String, StaticClassMap> staticRootMap
        , String string, IMV_SIQ output, App NE) {
        StaticFunctionMapU_VECS_E staticFunctionMapU_VECS_C
            = (StaticFunctionMapU_VECS_E) StaticRootMap.staticClassMap.get("U_VECS");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doU_VECS_CaseFunction(new CallFunctionKey(callFunctionKey), string
    ...
    private static void doP_IDUQ_Case(Map<String, StaticClassMap> staticRootMap
        ...
        StaticFunctionMapP_IDUQ_E staticFunctionMapP_IDUQ_C
            = (StaticFunctionMapP_IDUQ_E) StaticRootMap.staticClassMap.get("P_IDUQ");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doP_IDUQ_CaseFunction(new CallFunctionKey(callFunctionKey), string
    ...
    private static void doM_VECS_Case(Map<String, StaticClassMap> staticRootMap
        ...
        StaticFunctionMapM_VECS_E staticFunctionMapM_VECS_C
            = (StaticFunctionMapM_VECS_E) StaticRootMap.staticClassMap.get("M_VECS");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doM_VECS_CaseFunction(new CallFunctionKey(callFunctionKey), string
                    , staticFunctionMapM_VECS_C, output, NE);
                StaticRootMap.staticBloomingTimes.put(callFunctionKey
                    , StaticRootMap.staticBloomingTimes.get(callFunctionKey) + 1);//later fix..20241017
            }
        }
    }
//稍后全部走归纳计算模式。
    ...
    private static void doM_IDUQ_Case(Map<String, StaticClassMap> staticRootMap
        ...
        StaticFunctionMapM_IDUQ_E staticFunctionMapM_IDUQ_C
            = (StaticFunctionMapM_IDUQ_E) StaticRootMap.staticClassMap.get("M_IDUQ");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doM_IDUQ_CaseFunction(new CallFunctionKey(callFunctionKey), string
    ...
    private static void doV_AOPM_Case(Map<String, StaticClassMap> staticRootMap
        ...
        StaticFunctionMapV_AOPM_E staticFunctionMapV_AOPM_C
            = (StaticFunctionMapV_AOPM_E) StaticRootMap.staticClassMap.get("V_AOPM");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doV_AOPM_CaseFunction(new CallFunctionKey(callFunctionKey), string
    ...
    private static void doV_IDUQ_Case(Map<String, StaticClassMap> staticRootMap
        ...
        StaticFunctionMapV_IDUQ_E staticFunctionMapV_IDUQ_C
            = (StaticFunctionMapV_IDUQ_E) StaticRootMap.staticClassMap.get("V_IDUQ");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doV_IDUQ_CaseFunction(new CallFunctionKey(callFunctionKey), string
    ...
    private static void doE_AOPM_Case(Map<String, StaticClassMap> staticRootMap
        ...
        StaticFunctionMapE_AOPM_E staticFunctionMapE_AOPM_C
            = (StaticFunctionMapE_AOPM_E) StaticRootMap.staticClassMap.get("E_AOPM");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doE_AOPM_CaseFunction(new CallFunctionKey(callFunctionKey), string
    ...
    private static void doE_IDUQ_Case(Map<String, StaticClassMap> staticRootMap
        ...
        StaticFunctionMapE_IDUQ_E staticFunctionMapE_IDUQ_C
            = (StaticFunctionMapE_IDUQ_E) StaticRootMap.staticClassMap.get("E_IDUQ");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doE_IDUQ_CaseFunction(new CallFunctionKey(callFunctionKey), string
    ...
    private static void doC_AOPM_Case(Map<String, StaticClassMap> staticRootMap
        ...
        StaticFunctionMapC_AOPM_E staticFunctionMapC_AOPM_C
            = (StaticFunctionMapC_AOPM_E) StaticRootMap.staticClassMap.get("C_AOPM");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doC_AOPM_CaseFunction(new CallFunctionKey(callFunctionKey), string
    ...
    private static void doC_IDUQ_Case(Map<String, StaticClassMap> staticRootMap
        ...
        StaticFunctionMapC_IDUQ_E staticFunctionMapC_IDUQ_C
            = (StaticFunctionMapC_IDUQ_E) StaticRootMap.staticClassMap.get("C_IDUQ");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doC_IDUQ_CaseFunction(new CallFunctionKey(callFunctionKey), string
    ...
    private static void doS_AOPM_Case(Map<String, StaticClassMap> staticRootMap
        ...
        StaticFunctionMapS_AOPM_E staticFunctionMapS_AOPM_C
            = (StaticFunctionMapS_AOPM_E) StaticRootMap.staticClassMap.get("S_AOPM");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doS_AOPM_CaseFunction(new CallFunctionKey(callFunctionKey), string
    ...
    private static void doS_IDUQ_Case(Map<String, StaticClassMap> staticRootMap
        ...
        StaticFunctionMapS_IDUQ_E staticFunctionMapS_IDUQ_C
            = (StaticFunctionMapS_IDUQ_E) StaticRootMap.staticClassMap.get("S_IDUQ");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doS_IDUQ_CaseFunction(new CallFunctionKey(callFunctionKey), string
    ...
    private static void doI_AOPM_Case(Map<String, StaticClassMap> staticRootMap
        ...
        StaticFunctionMapI_AOPM_E staticFunctionMapI_AOPM_C
            = (StaticFunctionMapI_AOPM_E) StaticRootMap.staticClassMap.get("I_AOPM");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doI_AOPM_CaseFunction(new CallFunctionKey(callFunctionKey), string
    ...
    private static void doI_VECS_Case(Map<String, StaticClassMap> staticRootMap
        ...
        StaticFunctionMapI_VECS_E staticFunctionMapI_VECS_C
            = (StaticFunctionMapI_VECS_E) StaticRootMap.staticClassMap.get("I_VECS");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doI_VECS_CaseFunction(new CallFunctionKey(callFunctionKey), string
    ...
    private static void doD_AOPM_Case(Map<String, StaticClassMap> staticRootMap
        ...
        StaticFunctionMapD_AOPM_E staticFunctionMapD_AOPM_C
            = (StaticFunctionMapD_AOPM_E) StaticRootMap.staticClassMap.get("D_AOPM");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doD_AOPM_CaseFunction(new CallFunctionKey(callFunctionKey), string
    ...
    private static void doD_VECS_Case(Map<String, StaticClassMap> staticRootMap
        ...
        StaticFunctionMapD_VECS_E staticFunctionMapD_VECS_C
            = (StaticFunctionMapD_VECS_E) StaticRootMap.staticClassMap.get("D_VECS");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doD_VECS_CaseFunction(new CallFunctionKey(callFunctionKey), string
    ...
    private static void doQ_AOPM_Case(Map<String, StaticClassMap> staticRootMap
        ...
        StaticFunctionMapQ_AOPM_E staticFunctionMapQ_AOPM_C
            = (StaticFunctionMapQ_AOPM_E) StaticRootMap.staticClassMap.get("Q_AOPM");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doQ_AOPM_CaseFunction(new CallFunctionKey(callFunctionKey), string
    ...
    private static void doQ_VECS_Case(Map<String, StaticClassMap> staticRootMap
        ...
        StaticFunctionMapQ_VECS_E staticFunctionMapQ_VECS_C
            = (StaticFunctionMapQ_VECS_E) StaticRootMap.staticClassMap.get("Q_VECS");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doQ_VECS_CaseFunction(new CallFunctionKey(callFunctionKey), string
    ...
    private static void doU_AOPM_Case(Map<String, StaticClassMap> staticRootMap
        ...
        StaticFunctionMapU_AOPM_E staticFunctionMapU_AOPM_C
            = (StaticFunctionMapU_AOPM_E) StaticRootMap.staticClassMap.get("U_AOPM");
        //case 函数名接口
        ...
        while (callFunction.hasNext()) {
            ...
            String[] strings = string.split(" ");//精确冗余20230218 罗瑶光 稍后涉及成exception打分 模式匹配
            if (strings[3].equalsIgnoreCase(callFunctionKey)) {
                StaticFunctionMap.doU_AOPM_CaseFunction(new CallFunctionKey(callFunctionKey), string
