...
public class StaticFunctionMapP_VECS_E extends StaticFunctionMapCASE
	implements StaticFunctionMapP_VECS_C {
	...
	public String[][] aNNTest(App NE) {
		...
		String[][] preAnnMatrix = sensingTest.getMatrix(string._S_,
			NE);
		String[][] AnnMatrix = new DETA_ANN_HMM().summing_P(
			preAnnMatrix);
	...
	//测试成功了, 稍后优化。
	@SuppressWarnings("unused")
	public static void main() throws InstantiationException {
		App NE = new App();
		...
		String[][] string1 = new StaticFunctionMapP_VECS_E().aNNTest(
			NE);
		String[][] string2 = new StaticFunctionMapP_VECS_E().dNNTest(
			NE);
		String[][] string3 = new StaticFunctionMapP_VECS_E().rNNTest(
			NE);
		String[][] string4 = new StaticFunctionMapP_VECS_E()
			.sensingTest(NE);
	...
	@Override
	public Map<Double, List<AMV_MVS_VSQ_2D>> addNewPositionWithoutHeart(
		App NE) {
		...
		return Classification_X_addNewPositionWithoutHeart._E(groups,
			position2d, scaleDistance);
	}

	@Override
	public Map<Double, List<AMV_MVS_VSQ_2D>> addNewPositionWithHeart(
		App NE) {
		Map<Double, List<AMV_MVS_VSQ_2D>> groups = NE._I_U.groups2D;
		AMV_MVS_VSQ_2D position2d = NE._I_U.position2D;
		Map<Double, AMV_MVS_VSQ_2D> hearts = NE._I_U.hearts2D;
		double scaleDistance = NE._I_U.scaleDistance;
		return Classification_X_addNewPositionWithHeart._E(groups,
			position2d, hearts, scaleDistance);
	}

	@Override
	public Map<Double, List<AMV_MVS_VSQ_2D>> fissilePosition2D(
		App NE) {
	...
	@Override
	public Map<Double, List<AMV_MVS_VSQ_3D>> fissilePosition3D(
		App NE) {
	...
	@Override
	public Map<Double, List<AMV_MVS_VSQ_2D>> fusionPosition2DwithHeart(
		App NE) {
		Map<Double, List<AMV_MVS_VSQ_2D>> groups = NE._I_U.groups2DMap;
		Map<Double, AMV_MVS_VSQ_2D> groupsHeart = NE._I_U.groupsHeart;
		double scale = NE._I_U.scaleDouble;
		return Fusion_X_fusionPosition2DwithHeart._E(groups,
			groupsHeart, scale);
	}

	@Override
	public Map<Double, List<AMV_MVS_VSQ_3D>> fusionPosition3DwithHeart(
		App NE) {
		...
		double scale = NE._I_U.scaleDouble;
		return Fusion_X_fusionPosition3DwithHeart._E(groups,
			groupsHeart, scale);
	}

	@Override
	public Map<Double, List<AMV_MVS_VSQ_2D>> getTSPIsolationGroups2D(
		App NE) {
		List<AMV_MVS_VSQ_2D> groups = NE._I_U.groupsList;
		double scale = NE._I_U.scaleDouble;
	...
	@Override
	public Map<Double, List<AMV_MVS_VSQ_3D>> getTSPIsolationGroups3D(
		App NE) {
	...
	@Override
	public Map<Double, List<AMV_MVS_VSQ_2D>> getTSPForestIsolationGroups2D(
		App NE) {
		List<AMV_MVS_VSQ_2D> groups = NE._I_U.groupsList;
		double scale = NE._I_U.scaleDouble;
		return Forest_X_getTSPForestIsolationGroups2D._E(groups,
			scale);
	}

	@Override
	public Map<Double, List<AMV_MVS_VSQ_3D>> getTSPForestIsolationGroups3D(
		App NE) {
		List<AMV_MVS_VSQ_3D> groups = NE._I_U.groups3D;
		double scale = NE._I_U.scaleDouble;
		return Forest_X_getTSPForestIsolationGroups3D._E(groups,
			scale);
	}

	@Override
	public List<AMV_MVS_VSQ_2D> trackTracePosition2DHeartsWithSingerGroup(
		App NE) {
		List<AMV_MVS_VSQ_2D> coods = NE._I_U.coods;
		return Hearts_X_trackTracePosition2DHeartsWithSingerGroup._E(
			coods);
	}

	@Override
	public List<AMV_MVS_VSQ_3D> trackTracePosition3DHeartsWithSingerGroup(
		App NE) {
		List<AMV_MVS_VSQ_3D> coods = NE._I_U.coods3D;
		return Hearts_X_trackTracePosition3DHeartsWithSingerGroup._E(
			coods);
	}
	...
	@Override
	public Map<Double, List<AMV_MVS_VSQ_2D>> trackTracePosition2DHeartsWithFissileGroups(
		App NE) {
		List<AMV_MVS_VSQ_2D> coods = NE._I_U.coods;
		double distanceScale = NE._I_U.distanceScaleDouble;
		return Hearts_X_trackTracePosition2DHeartsWithFissileGroups
			._E(coods, distanceScale);
	}

	@Override
	public Map<Double, List<AMV_MVS_VSQ_3D>> trackTracePosition3DHeartsWithFissileGroups(
		App NE) {
		List<AMV_MVS_VSQ_3D> coods = NE._I_U.coods3D;
		double distanceScale = NE._I_U.distanceScaleDouble;
		return Hearts_X_trackTracePosition3DHeartsWithFissileGroups
			._E(coods, distanceScale);
	}
	...
	public double findMeanDistanceFromPositions2D(App NE) {
		...
		return Distance_X_findMeanDistanceFromPositions2D._E(
	...
	public double findMeanDistanceFromPositions3D(App NE) {
		...
		double observerPCAScale = NE._I_U.observerPCAScale;
		int sortRangeScale = NE._I_U.sortRangeScale;
		return Distance_X_findMeanDistanceFromPositions3D._E(
	...
	public double[] findPascalMeanDistanceByEachPositions2D(App NE) {
		...
		double observerPCAScale = NE._I_U.observerPCAScale;
		int sortRangeScale = NE._I_U.sortRangeScale;
		return Distance_X_findPascalMeanDistanceByEachPositions2D._E(
			position2Ds, observerPCAScale, sortRangeScale);
	}
	...
	public double[] findPascalMeanDistanceByEachPositions3D(App NE) {
		...
		double observerPCAScale = NE._I_U.observerPCAScale;
		int sortRangeScale = NE._I_U.sortRangeScale;
		return Distance_X_findPascalMeanDistanceByEachPositions3D._E(
			position3Ds, observerPCAScale, sortRangeScale);
	}

	@Override
	public Map<Double, AMV_MVS_VSQ_2D> getPosition2DsGroupPascalHearts(
		App NE) {
		ArrayList<AMV_MVS_VSQ_2D> groups = NE._I_U.groups;
		double scale = NE._I_U.scaleDouble;
		return GroupPascalHearts_X_getPosition2DsGroupPascalHearts._E(
			groups, scale);
	}

	@Override
	public Map<Double, AMV_MVS_VSQ_3D> getPosition3DsGroupPascalHearts(
		App NE) {
		ArrayList<AMV_MVS_VSQ_3D> groups = NE._I_U.groups3D;
		double scale = NE._I_U.scaleDouble;
		return GroupPascalHearts_X_getPosition3DsGroupPascalHearts._E(
			groups, scale);
	}

	@Override
	public Map<Double, AMV_MVS_VSQ_2D> getPosition2DsGroupPascalMids(
		App NE) {
		ArrayList<AMV_MVS_VSQ_2D> groups = NE._I_U.groups;
		double scale = NE._I_U.scaleDouble;
		return GroupPascalHearts_X_getPosition2DsGroupPascalMids._E(
			groups, scale);
	}

	@Override
	public Map<Double, AMV_MVS_VSQ_3D> getPosition3DsGroupPascalMids(
		App NE) {
		ArrayList<AMV_MVS_VSQ_3D> groups = NE._I_U.groups3D;
		double scale = NE._I_U.scaleDouble;
		return GroupPascalHearts_X_getPosition3DsGroupPascalMids._E(
			groups, scale);
	}

	@Override
	public Map<Double, Line2D> getPosition2DsGroupPascalDirection2DMap(
		App NE) {
		Map<Double, AMV_MVS_VSQ_2D> pascalHearts = NE._I_U.pascalHearts;
		Map<Double, AMV_MVS_VSQ_2D> pascalMids = NE._I_U.pascalMids;
		return GroupPascalHearts_X_getPosition2DsGroupPascalDirection
			._E(pascalHearts, pascalMids);
	}

	@Override
	public Map<Double, Line3D> getPosition3DsGroupPascalDirection3D(
		App NE) {
		Map<Double, AMV_MVS_VSQ_3D> pascalHearts = NE._I_U.pascalHearts3D;
		Map<Double, AMV_MVS_VSQ_3D> pascalMids = NE._I_U.pascalMids3D;
		return GroupPascalHearts_X_getPosition3DsGroupPascalDirection
			._E(pascalHearts, pascalMids);
	}

	@Override
	public Map<Double, Line3D> getPosition3DsGroupPascalDirection3DMap(
		App NE) {
		ArrayList<AMV_MVS_VSQ_3D> groups = NE._I_U.groups3D;
		double scale = NE._I_U.scaleDouble;
		return GroupPascalHearts_X_getPosition3DsGroupPascalDirection
	...
	@Override
	public Map<Double, Line2D> getPosition2DsGroupPascalDirection2D(
		App NE) {
		ArrayList<AMV_MVS_VSQ_2D> groups = NE._I_U.groups;
		double scale = NE._I_U.scaleDouble;
		return GroupPascalHearts_X_getPosition2DsGroupPascalDirection
	...
	public List<Line2D> getYaoguangLuo2DEulerRingTSP2D(App NE) {
		List<AMV_MVS_VSQ_2D> AMV_MVS_VSQs = NE._I_U.AMV_MVS_VSQs;
		return TSP2D_X_getYaoguangLuo2DEulerRingTSP2D._E(
			AMV_MVS_VSQs);
	}
	...
	public List<Line3D> getYaoguangLuo3DEulerRingTSP2D(App NE) {
		List<AMV_MVS_VSQ_3D> AMV_MVS_VSQs = NE._I_U.AMV_MVS_VSQs3D;
		return TSP2D_X_getYaoguangLuo3DEulerRingTSP2D._E(
			AMV_MVS_VSQs);
	}
	...
	public int[][] getImagePix2DGroupFilter(App NE) {
		...
		return Filter_X_getImagePix2DGroupFilter._E(inputPixMatrix,
			RBG, distanceScale, max, min);
	}
	...
	public int[][][] getImagePix3DGroupFilter(App NE) {
		...
		return Filter_X_getImagePix3DGroupFilter._E(inputPixMatrix,
			RBG, distanceScale, max, min);
	}
	...
	public String NLPBestSentenceMatch(App NE) {
		...
		return NLPTopicMatch_X_NLPBestSentenceMatch._E(
			searchString._S_, sampleSentences, NE);
	}
	...
	public List<String> NLPBestSentencesMatch(App NE) {
		...
		return NLPTopicMatch_X_NLPBestSentencesMatch._E(
			searchString._S_, sampleSentences, sortStackRange,
			filterRate, NE);
	}
	...
	public double[] getNLPBestSentencesMatchScore(App NE) {
		...
		return NLPTopicMatch_X_getNLPBestSentencesMatchScore._E(
			searchString._S_, sampleSentences, NE);
	}
	...
	public double findTotalIncrementWithScale(App NE) {
		...
		double scale = NE._I_U.scaleDouble;
		return FindIncrement.findTotalIncrementWithScale(value, times,
			scale);
	}
	...
	public double findMeanIncrementWithScale(App NE) {
		...
		double times = NE._I_U.timesDouble;
		double scale = NE._I_U.scaleDouble;
		return FindIncrement.findMeanIncrementWithScale(value, times,
			scale);
	}
	...
	public double findMeanOfFilterDoubleArrayWithScale(App NE) {
		...
		int sortRangeScale = NE._I_U.sortRangeScale;
		return FindMean.findMeanOfFilterDoubleArrayWithScale(input,
			filterScale, sortRangeScale);
	}
	...
	public boolean getErrorAsserts(App NE) {
		...
		double scale = NE._I_U.scaleDouble;
		return ErrorAsserts.getErrorAsserts(inputValue, matchValues,
			scale);
	}
	...
	public boolean getBinaryErrorAsserts(App NE) {
		...
		return ErrorAsserts.getBinaryErrorAsserts(inputValue,
			matchValues, scale, sortStackRange, isSort);
	}
	...
	public boolean encodeEstimateSumOfScoresList(App NE) {
		...
		return ProbabilityScore.encodeEstimateSumOfScoresList(scores,
			estimateValue);
	}
	...
	public boolean encodeEstimateSumOfScoresArray(App NE) {
		...
		double estimateValue = NE._I_U.estimateValue;
		return ProbabilityScore.encodeEstimateSumOfScoresArray(scores,
			estimateValue);
	}
	...
	public boolean getEstimateCartesianSumOfScoresArray(App NE) {
		...
		return ProbabilityScore.getEstimateCartesianSumOfScoresArray(
	...
	public boolean getEstimateCartesian1DSumOfScoresArray(App NE) {
		...
		return ProbabilityScore
			.getEstimateCartesian1DSumOfScoresArray(inputs,
	...
	public double[] getRightsEstimateScore(App NE) {
		...
		return ProbabilityScore.getRightsEstimateScore(inputs,
			rights);
	}
	...
	public RatioMatrix getSimilarFuzzSetWithScale(App NE) {
		...
		double scale = NE._I_U.scaleDouble;
		return PCAMeanOfFuzzPC.getSimilarFuzzSetWithScale(input,
			groups, scale);
	}

	@Override
	public List<AMV_MVS_VSQ_2D> getShortestSamplePosition2DGroup(
		App NE) {
		AMV_MVS_VSQ_2D inputHeart = NE._I_U.inputHeart;
		Map<Double, List<AMV_MVS_VSQ_2D>> groups = NE._I_U.groups2D;

		return HeartsSample_X_getShortestSamplePosition2DGroup._E(
			inputHeart, groups);
	}

	@Override
	public Map<Double, List<AMV_MVS_VSQ_2D>> getShorterSamplePosition2DGroupsWithScale(
		App NE) {
		AMV_MVS_VSQ_2D inputHeart = NE._I_U.inputHeart;
		Map<Double, List<AMV_MVS_VSQ_2D>> groups = NE._I_U.groups2D;
		double scale = NE._I_U.scaleDouble;
		return HeartsSample_X_getShorterSamplePosition2DGroupsWithScale
			._E(inputHeart, groups, scale);
	}

	@Override
	public List<AMV_MVS_VSQ_3D> getShortestSamplePosition3DGroup(
		App NE) {
		AMV_MVS_VSQ_3D inputHeart = NE._I_U.inputHeart3D;
		Map<Double, List<AMV_MVS_VSQ_3D>> groups = NE._I_U.groupsMap3D;
		return HeartsSample_X_getShortestSamplePosition3DGroup._E(
			inputHeart, groups);
	}

	@Override
	public Map<Double, List<AMV_MVS_VSQ_3D>> getShortestSamplePosition3DGroupsWithScale(
		App NE) {
		AMV_MVS_VSQ_3D inputHeart = NE._I_U.inputHeart3D;
		Map<Double, List<AMV_MVS_VSQ_3D>> groups = NE._I_U.groupsMap3D;
		double scale = NE._I_U.scaleDouble;
		return HeartsSample_X_getShortestSamplePosition3DGroupsWithScale
			._E(inputHeart, groups, scale);
	}
	...
	public List<RatioMatrix> getSimilarFuzzSetListWithScale(App NE) {
		...
		List<RatioMatrix> groups = NE._I_U.groupsRatioList;
		double scale = NE._I_U.scaleDouble;
		return Fuzz_X_getSimilarFuzzSetListWithScale._E(input, groups,
			scale);
	}
	...
	public double findTotalIncrementRatioWithScale(App NE) {
		...
		double times = NE._I_U.timesDouble;
		double scale = NE._I_U.scaleDouble;
		return IncrementRatio.findTotalIncrementRatioWithScale(value,
			times, scale);
	}
	...
	public double findMeanIncrementRatioWithScale(App NE) {
		...
		double times = NE._I_U.timesDouble;
		double scale = NE._I_U.scaleDouble;
		return IncrementRatio.findMeanIncrementRatioWithScale(value,
			times, scale);
	}
	...
	public double[] frequencyUpSplit(App NE) {
		...
		return CorrelationICA_X_frequencyUpSplit._E(originFrequency,
			compareFrequency);
	}
	...
	public double[] frequencyDownSplit(App NE) {
		double[] originFrequency = NE._I_U.originFrequency;
		double[] compareFrequency = NE._I_U.compareFrequency;
		return CorrelationICA_X_frequencyDownSplit._E(originFrequency,
			compareFrequency);
	}
	...
	public double[] frequencyUpSplitWithScale(App NE) {
		...
		double[] compareFrequency = NE._I_U.compareFrequency;
		double scale = NE._I_U.scaleDouble;
		return CorrelationICA_X_frequencyUpSplitWithScale._E(
	...
	public double[] frequencyDownSplitWithScale(App NE) {
		...
		double[] compareFrequency = NE._I_U.compareFrequency;
		double scale = NE._I_U.scaleDouble;
		return CorrelationICA_X_frequencyDownSplitWithScale._E(
			originFrequency, compareFrequency, scale);
	}
	...
	public String predictionMatrixResult(App NE) {
		...
		double scale = NE._I_U.scaleDouble;
		return Classification_X_predictionMatrixResult._E(input,
			groups);
	}

	@Override
	public Map<Integer, ArrayList<AMV_MVS_VSQ_2D>> getImagePixClassificationMap(
		App NE) {
		int[][] pixMap = NE._I_U.pixMap;
		return ImagePixClassification.getImagePixClassificationMap(
			pixMap);
	}

	@Override
	public Map<Integer, ArrayList<AMV_MVS_VSQ_3D>> getImagePixClassificationMap3D(
		App NE) {
	...
	public double getPixPercentByDeterPix(App NE) {
		...
		return Percentage_X_getPixPercentByDeterPix._E(imagePix,
			scaleRBG);
	}
	...
	public double getClusterPercentByDeterPixGroup(App NE) {
		...
		return Percentage_X_getClusterPercentByDeterPixGroup._E(
			imagePix, scaleSUM);
	}
	...
	public double getPixPercentByDeterPixGroup(App NE) {
		Map<Double, List<AMV_MVS_VSQ_2D>> imagePix = NE._I_U.imagePix2D;
		int scaleSUM = NE._I_U.scaleSUM;
		return Percentage_X_getPixPercentByDeterPixGroup._E(imagePix,
			scaleSUM);
	}
	...
	public Map<Double, List<AMV_MVS_VSQ_2D>> filterFusion2DSetsWithCountScale(
		...
		return Filter_X_filterFusion2DSetsWithCountScale._E(groups,
			countScale);
	}
	...
	public Map<Double, List<AMV_MVS_VSQ_3D>> filterFusion3DSetsWithCountScale(
		...
		Map<Double, List<AMV_MVS_VSQ_3D>> groups = NE._I_U.groupsMap3D;
		double countScale = NE._I_U.countScale;
		return Filter_X_filterFusion3DSetsWithCountScale._E(groups,
			countScale);
	}

	//PCA_AMV_MVS_VSQ_Filter
	@Override
	public List<AMV_MVS_VSQ_2D> filterPosition2DsWithScaledDistance(
		App NE) {//
		...
		return AMV_MVS_VSQ_Filter_X_filterPosition2DsWithScaledDistance
			._E(input, heart, scaleDistacne);
	}

	@Override
	public List<AMV_MVS_VSQ_3D> filterPosition3DsWithScaledDistance3DList(
		App NE) {
		List<AMV_MVS_VSQ_3D> input = NE._I_U.input3D;
		AMV_MVS_VSQ_3D heart = NE._I_U.inputHeart3D;
		double scaleDistacne = NE._I_U.distanceScaleDouble;
		return AMV_MVS_VSQ_Filter_X_filterPosition3DsWithScaledDistance
			._E(input, heart, scaleDistacne);
	}

	@Override
	public Map<Double, List<AMV_MVS_VSQ_2D>> filterPosition2DsWithScaledDistanceMap2D(
		App NE) {
	...
	@Override
	public Map<Double, List<AMV_MVS_VSQ_3D>> filterPosition3DsWithScaledDistanceMap3D(
		App NE) {
