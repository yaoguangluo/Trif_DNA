...
public class StaticFunctionMapV_AOPM_E extends StaticFunctionMapCASE
	implements StaticFunctionMapV_AOPM_C {
	...
	public String PdeSwapPdcToPde(App NE) {
		...
		return X_PdcToPde.PdcToPde(pdc._S_, lock._S_, de._S_, ds._S_,
			ie._S_, is._S_);
	}
	...
	public String PdeSwapPdcToPds(App NE) {
		...
		AES_QMS_XSD_TIH ie = NE._I_U.ie;
		AES_QMS_XSD_TIH is = NE._I_U.is;
		return X_PdcToPds.PdcToPds(pdc._S_, lock._S_, de._S_, ds._S_,
			ie._S_, is._S_);
	}
	...
	public String PdeSwapPdeToPds(App NE) {
		...
		AES_QMS_XSD_TIH ie = NE._I_U.ie;
		AES_QMS_XSD_TIH is = NE._I_U.is;
		return X_PdeToPds.PdeToPds(pds._S_, de._S_, ds._S_, ie._S_,
			is._S_);
	}
	...
	public String PdeSwapPdsToPde(App NE) {
		...
		AES_QMS_XSD_TIH ie = NE._I_U.ie;
		AES_QMS_XSD_TIH is = NE._I_U.is;
		return X_PdsToPde.PdsToPde(pds._S_, de._S_, ds._S_, ie._S_,
			is._S_);
	}
	...
	public static void main() {
		...
		pDE_RNA_FullFormular.pdw = X_textToPdw.textToPdw(
	...
	public boolean withoutCulumnNameType(App NE) {
		...
		return DetaDBUtil_X_withoutCulumnNameType._E(
			culumnTypeString._S_);
	}
