...
public class StaticClassMap{
	public StaticClassMap(String string)  {
		if("A_VECS".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("A_VECS", staticFunctionMapA_VECS_E);//CE接口热化
		...
		if("A_IDUQ".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("A_IDUQ", staticFunctionMapA_IDUQ_E);//CE接口热化
		...
		if("O_VECS".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("O_VECS", staticFunctionMapO_VECS_E);//CE接口热化
		...
		if("O_IDUQ".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("O_IDUQ", staticFunctionMapO_IDUQ_E);//CE接口热化
		...
		if("P_VECS".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("P_VECS", staticFunctionMapP_VECS_E);//CE接口热化
		...
		if("P_IDUQ".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("P_IDUQ", staticFunctionMapP_IDUQ_E);//CE接口热化
		...
		if("M_VECS".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("M_VECS", staticFunctionMapM_VECS_E);//CE接口热化
		...
		if("M_IDUQ".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("M_IDUQ", staticFunctionMapM_IDUQ_E);//CE接口热化
		...
		if("V_AOPM".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("V_AOPM", staticFunctionMapV_AOPM_E);//CE接口热化
		...
		if("V_IDUQ".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("V_IDUQ", staticFunctionMapV_IDUQ_E);//CE接口热化
		...
		if("E_AOPM".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("E_AOPM", staticFunctionMapE_AOPM_E);//CE接口热化
		...
		if("E_IDUQ".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("E_IDUQ", staticFunctionMapE_IDUQ_E);//CE接口热化
		...
		if("C_AOPM".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("C_AOPM", staticFunctionMapC_AOPM_E);//CE接口热化
		...
		if("C_IDUQ".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("C_IDUQ", staticFunctionMapC_IDUQ_E);//CE接口热化
		...
		if("S_AOPM".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("S_AOPM", staticFunctionMapS_AOPM_E);//CE接口热化
		...
		if("S_IDUQ".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("S_IDUQ", staticFunctionMapS_IDUQ_E);//CE接口热化
		...
		if("I_AOPM".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("I_AOPM", staticFunctionMapI_AOPM_E);//CE接口热化
		...
		if("I_VECS".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("I_VECS", staticFunctionMapI_VECS_E);//CE接口热化
		...
		if("D_AOPM".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("D_AOPM", staticFunctionMapD_AOPM_E);//CE接口热化
		...
		if("D_VECS".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("D_VECS", staticFunctionMapD_VECS_E);//CE接口热化
		...
		if("U_AOPM".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("U_AOPM", staticFunctionMapU_AOPM_E);//CE接口热化
		...
		if("U_VECS".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("U_VECS", staticFunctionMapU_VECS_E);//CE接口热化
		...
		if("Q_AOPM".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("Q_AOPM", staticFunctionMapQ_AOPM_E);//CE接口热化
		...
		if("Q_VECS".equals(string)) {
			...
			StaticRootMap.staticClassMap.put("Q_VECS", staticFunctionMapQ_VECS_E);//CE接口热化
