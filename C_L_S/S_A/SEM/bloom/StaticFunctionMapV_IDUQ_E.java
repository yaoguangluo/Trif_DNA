...
public class StaticFunctionMapV_IDUQ_E extends StaticFunctionMapCASE
	...
	public MakeContainerSJFX initETL(App NE) {
		...
		MakeContainerSJFX makeContainerSJFX = new MakeContainerSJFX(
			app.app_S.tableData_old, app.app_S.text, containerPanel,
			NE);
	...
	public GUISample onlyInitETLWithInitons(App NE) {
		...
		Object[][] tableData_old = (Object[][]) inputValues.get(
			传参因子[因子++]);
	...
	public void demoETL(App NE) {
		...
		jFrame.setSize(WindowsUI.makeContainerWidth,
	...
	public String getOrigianlTextByLock(App NE) {
		...
		return File_X_getOrigianlTextByLock._E(inputString._S_,
			lockString._S_);
	}
	...
	public String getOrigianlTextByLockWithInitons(App NE) {
		...
		return File_X_getOrigianlTextByLock._E(inputString,
			lockString);
	}
	...
	public LinkNode LoadWithInitons(App NE) {
		...
		return File_X_Load._E((LinkNode) inputValues.get(传参因子[因子++]),
			(NodeShow) inputValues.get(传参因子[因子++]), (File) inputValues
				.get(传参因子[因子++]), (LinkList) inputValues.get(
					传参因子[因子++]), NE);
	}
