 ...
 * */
public class StaticReflectionMapP_IDUQ_C extends
	...
	public void callFunction(CallFunctionKey callFunctionKey,
		...
		if (callFunctionKey.contains("mutationCopy", NE)) {
			...
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "mutationCopy");
		}
		;
		...
		if (callFunctionKey.contains("inheritance", NE)) {
			...
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "inheritance");
		}
		;
