 ...
 * */
public class StaticReflectionMapO_IDUQ_C extends
	...
	public void callFunction(CallFunctionKey callFunctionKey,
		...
		if (callFunctionKey.contains("getRandomDNAkey", NE)) {
			...
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "getRandomDNAkey");
		}
		;
		...
		if (callFunctionKey.contains("BootNeroDoc", NE)) {
			...
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "BootNeroDoc");
		}
		;
		if (callFunctionKey.contains("vpcsRegister", NE)) {
			...
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "vpcsRegister");
		}
		;
