 ...
 * */
public class StaticReflectionMapP_VECS_C extends
	...
	public void callFunction(CallFunctionKey callFunctionKey,
		...
		if (callFunctionKey.contains("getSideEnd3D", NE)) {
			...
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "getSideEnd3D");
		} //, "getSideEnd3D");
		...
		if (callFunctionKey.contains("addNewPositionWithHeart", NE)) {
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.addNewPositionWithHeart(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "addNewPositionWithHeart");
		...
		if (callFunctionKey.contains("fissilePosition3D", NE)) {
			...
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "fissilePosition3D");
		} //, "fissilePosition3D");
		...
		if (callFunctionKey.contains("getTSPIsolationGroups3D", NE)) {
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getTSPIsolationGroups3D(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "getTSPIsolationGroups3D");
		...
		if (callFunctionKey.contains("getTSPForestIsolationGroups2D",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getTSPForestIsolationGroups2D(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains("getTSPForestIsolationGroups3D",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getTSPForestIsolationGroups3D(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains("trackTracePosition2DByHearts",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.trackTracePosition2DByHearts(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains("trackTracePosition3DByHearts",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.trackTracePosition3DByHearts(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains("getPosition2DsGroupPascalMids",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getPosition2DsGroupPascalMids(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains("getPosition3DsGroupPascalMids",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getPosition3DsGroupPascalMids(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains(
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getPosition2DsGroupPascalDirection2D(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains(
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getPosition3DsGroupPascalDirection3D(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains(
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getPosition3DsGroupPascalDirection3DMap(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
				"getPosition3DsGroupPascalDirection");
		...
		if (callFunctionKey.contains(
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getPosition2DsGroupPascalDirection2DMap(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
				"getPosition2DsGroupPascalDirection");
		...
		if (callFunctionKey.contains("getYaoguangLuo2DEulerRingTSP",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getYaoguangLuo2DEulerRingTSP(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains("getYaoguangLuo3DEulerRingTSP",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getYaoguangLuo3DEulerRingTSP(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains("getYaoguangLuo2DEulerRingTSP2D",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getYaoguangLuo2DEulerRingTSP2D(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains("getYaoguangLuo3DEulerRingTSP2D",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getYaoguangLuo3DEulerRingTSP2D(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains("getYaoguangLuo2DEulerRingTSP3D",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getYaoguangLuo2DEulerRingTSP3D(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains("getYaoguangLuo3DEulerRingTSP3D",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getYaoguangLuo3DEulerRingTSP3D(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains("getImagePix2DGroupFilter",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getImagePix2DGroupFilter(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "getImagePix2DGroupFilter");
		...
		if (callFunctionKey.contains("NLPBestSentencesMatch", NE)) {
			...
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "NLPBestSentencesMatch");
		...
		if (callFunctionKey.contains("getNLPBestSentencesMatchScore",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getNLPBestSentencesMatchScore(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains("getBinaryErrorAsserts", NE)) {
			...
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "getBinaryErrorAsserts");
		...
		if (callFunctionKey.contains("findTotalIncrementWithScale",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.findTotalIncrementWithScale(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains("findMeanOfDoubleArray", NE)) {
			...
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "findMeanOfDoubleArray");
		...
		if (callFunctionKey.contains("findMeanOfTwoDoubleArray",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.findMeanOfTwoDoubleArray(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "findMeanOfTwoDoubleArray");
		...
		if (callFunctionKey.contains("findMeanOfDoubleMatrix2D",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.findMeanOfDoubleMatrix2D(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "findMeanOfDoubleMatrix2D");
		...
		if (callFunctionKey.contains("findRowMeanOfDoubleMatrix2D",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.findRowMeanOfDoubleMatrix2D(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains("findCulumnMeanOfDoubleMatrix2D",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.findCulumnMeanOfDoubleMatrix2D(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains("findSumOfTwoDoubleArray", NE)) {
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.findSumOfTwoDoubleArray(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "findSumOfTwoDoubleArray");
		...
		if (callFunctionKey.contains("findSumOfDoubleMatrix2D", NE)) {
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.findSumOfDoubleMatrix2D(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "findSumOfDoubleMatrix2D");
		...
		if (callFunctionKey.contains("findCulumnSumOfDoubleMatrix2D",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.findCulumnSumOfDoubleMatrix2D(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains("getShareholdCount", NE)) {
			...
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "getShareholdCount");
		} //, "getShareholdCount");
		if (callFunctionKey.contains("encodeEstimateSumOfScoresList",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.encodeEstimateSumOfScoresList(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains("encodeEstimateSumOfScoresArray",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.encodeEstimateSumOfScoresArray(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains("getRightsEstimateScore", NE)) {
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getRightsEstimateScore(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "getRightsEstimateScore");
		...
		if (callFunctionKey.contains("getARCDistanceRatio2D", NE)) {
			...
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "getARCDistanceRatio2D");
		...
		if (callFunctionKey.contains("getDistanceRatio3D", NE)) {
			...
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "getDistanceRatio3D");
		} //, "getDistanceRatio3D");
		...
		if (callFunctionKey.contains("getPercentListByOuterKey",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getPercentListByOuterKeyDoubleList(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
		...
		if (callFunctionKey.contains("frequencyDownSplit", NE)) {
			...
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "frequencyDownSplit");
		} //, "frequencyDownSplit");
		...
		if (callFunctionKey.contains("frequencyDownSplitWithScale",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.frequencyDownSplitWithScale(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains("predictionMatrixResult", NE)) {
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.predictionMatrixResult(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "predictionMatrixResult");
		...
		if (callFunctionKey.contains("getImagePixClassificationMap",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getImagePixClassificationMap(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains("getPixPercentByDeterPix", NE)) {
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getPixPercentByDeterPix(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "getPixPercentByDeterPix");
		...
		if (callFunctionKey.contains("getPixPercentByDeterPixGroup",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getPixPercentByDeterPixGroup(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains(
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.filterPosition3DsWithScaledDistanceMap3D(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
		...
		if (callFunctionKey.contains(
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.filterPosition2DsWithScaledDistanceMap2D(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
				"filterPosition2DsWithScaledDistance");
		...
		if (callFunctionKey.contains(
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.filterPosition3DsWithScaledDistance3DList(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map,
				"filterPosition3DsWithScaledDistance");
		...
		if (callFunctionKey.contains("getEachPercentSetOfArray",
			...
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapP_VECS_C
					.getEachPercentSetOfArray(NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "getEachPercentSetOfArray");
