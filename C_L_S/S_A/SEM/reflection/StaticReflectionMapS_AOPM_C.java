 ...
 * */
public class StaticReflectionMapS_AOPM_C extends
	...
	public void callFunction(CallFunctionKey callFunctionKey,
		...
		if (callFunctionKey.contains("DropCellPLSQL", NE)) {
			...
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "DropCellPLSQL");
		}
		;
		if (callFunctionKey.contains("DropCellORM", NE)) {
			...
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "DropCellORM");
		}
		;
		if (callFunctionKey.contains("DeleteCellORM", NE)) {
			...
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "DeleteCellORM");
		}
		;
		if (callFunctionKey.contains("DeleteCellPLSQL", NE)) {
			...
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "DeleteCellPLSQL");
		}
		;
		if (callFunctionKey.contains("InsertCellORM", NE)) {
			...
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "InsertCellORM");
		}
		;
		if (callFunctionKey.contains("InsertCellPLSQL", NE)) {
			...
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "InsertCellPLSQL");
		}
		;
		if (callFunctionKey.contains("UpdateCellORM", NE)) {
			...
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "UpdateCellORM");
		}
		;
		if (callFunctionKey.contains("UpdateCellORMByRowId", NE)) {
			IMV_SQI inputValues = StaticFunctionMap.preValues(output,
				传参因子);
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapS_AOPM_C.UpdateCellORMByRowId(
					NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "UpdateCellORMByRowId");
		}
		;
		if (callFunctionKey.contains("UpdateCellORMByEquals", NE)) {
			IMV_SQI inputValues = StaticFunctionMap.preValues(output,
				传参因子);
			if (inputValues.getBoolean("find")) {
				map = staticFunctionMapS_AOPM_C.UpdateCellORMByEquals(
					NE);
			}
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "UpdateCellORMByEquals");
		}
		;
		if (callFunctionKey.contains("UpdateCellPLSQL", NE)) {
			...
			StaticFunctionMap.postValues(output, inputValues
				.getBoolean("find"), map, "UpdateCellPLSQL");
		}
		;
