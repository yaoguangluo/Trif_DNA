...
public class StaticRegisterO_VECS_C {
	public static void load(StaticFunctionMapO_VECS_E staticFunctionMapO_VECS_E) {	
		...
		StaticFunctionMapO_VECS_C.annotationMap.put("transactionRegister"
		...
		StaticFunctionMapO_VECS_C.annotationMap.put("selectRowsByAttribute"
				, "currentDB:tableName:culmnName:value");
		StaticFunctionMapO_VECS_C.annotationMap.put("XA_ShellQ_Rows_E_main", "args");
		StaticFunctionMapO_VECS_C.annotationMap.put("selectRowsByTablePath"
		...
		StaticFunctionMapO_VECS_C.annotationMap.put("getNewSearchShellTableSpecFromDefaultTableModel"
				, "defaultTableModel");
		StaticFunctionMapO_VECS_C.annotationMap.put("getNewSearchShellTableDataFromDefaultTableModel"
				, "defaultTableModel");
		StaticFunctionMapO_VECS_C.annotationMap.put("getNewSearchShellTableRowsFromDefaultTableModel"
				, "spec:defaultTableModel");
		
		StaticFunctionMapO_VECS_C.annotationMap.put("addNewSearchShellTable", "tableName:defaultTableModel");
		StaticFunctionMapO_VECS_C.annotationMap.put("addNewSearchShellTableWithObjectData"
				, "tableName:defaultTableModel:defaultTableData");
		StaticFunctionMapO_VECS_C.annotationMap.put("addNewSearchShellTable"
				, "tableName:defaultTableData:defaultTableDataSpec");
		StaticFunctionMapO_VECS_C.annotationMap.put("addNewSearchShellTableWithObjectDataReflectionDBRows"
				, "tableName:defaultTableModel:defaultTableData");
		StaticFunctionMapO_VECS_C.annotationMap.put("addNewSearchShellTableReflectionDBRows"
		...
		StaticFunctionMapO_VECS_C.annotationMap.put("ReadChinese", "detaButton:app:_A");
		...
		StaticFunctionMapO_VECS_C.annotationMap.put("forwardVPCBackEnd"
		...
		StaticFunctionMapO_VECS_C.annotationMap.put("P_YLJOperation", "acknowledge:output");
		...
		StaticFunctionMapO_VECS_C.annotationMap.put("replaceStringWithFileName"
				, "fileDirectroyPath:searchString:needReplaceString:fileName");
		StaticFunctionMapO_VECS_C.annotationMap.put("replaceStringWithFileType"
				, "fileDirectroyPath:searchString:needReplaceString:fileName");
		StaticFunctionMapO_VECS_C.annotationMap.put("replaceStringWithFileSize"
				, "fileDirectroyPath:searchString:needReplaceString:fileName");
		StaticFunctionMapO_VECS_C.annotationMap.put("replaceStringWithFileLines"
		...
		Iterator<String> iterators= StaticFunctionMapO_VECS_C.annotationMap.keySet().iterator();
		while(iterators.hasNext()) {//出现相同的函数需要区别开 20230219 罗瑶光
			...
			StaticRootMap.staticClass_XE_Map.put(temp, "O_VECS");
		}
	}
}
