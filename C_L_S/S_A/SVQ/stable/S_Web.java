...
public interface S_Web {
    ...
    public static final String HEADER_CONTENT_TYPE_PDF
        = "content-type: application/pdf \n\n";
    public static final String HEADER_CONTENT_TYPE_ZIP
        = "content-type: application/zip \n\n";
    public static final String HEADER_CONTENT_TYPE_RAR
        = "content-type: application/rar \n\n";
    public static final String HEADER_CONTENT_TYPE_XML
    ...
    public static final String HEADER_CONTENT_TYPE_FONT_WOFF
        = "Content-Type: image/font-woff \n\n";
    public static final String HEADER_CONTENT_TYPE_JS
    ...
    public static final String REST_PATH_DELETE_ROWS_BY_TABLE_PATH_AND_INDEX
        = "/deleteRowByTablePathAndIndex";
    public static final String REST_PATH_INSERT_ROW_BY_BASE_NAME = "/insertRowByBaseName";
    public static final String REST_PATH_INSERT_ROW_BY_TABLE_PATH
        = "/insertRowByTablePath";
    public static final String REST_PATH_SELECT_ROWS_BY_ATTRIBUTE
        = "/selectRowsByAttribute";
    public static final String REST_PATH_SELECT_ROWS_BY_TABLE_PATH
