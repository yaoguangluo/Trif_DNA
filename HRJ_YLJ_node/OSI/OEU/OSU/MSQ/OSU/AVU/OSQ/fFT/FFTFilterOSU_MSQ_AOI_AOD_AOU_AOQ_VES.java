...
public class FFTFilterOSU_MSQ_AOI_AOD_AOU_AOQ_VES extends OSU_AOU_AOQ_VES
{
	
	private FileDialog filedialog;
	public FFTFilterOSU_MSQ_AOI_AOD_AOU_AOQ_VES(final FFTFilterOSU_MSQ_OPE_OPC_ECI _SQ__OPE_OPC_ECI)
	{
		setLayout(null);
