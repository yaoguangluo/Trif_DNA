...
public class MaxMiniFilterOSU_MSQ_AOI_AOD_AOU_AOQ_VES extends OSU_AOU_AOQ_VES
{
	
	private FileDialog filedialog;
	public MaxMiniFilterOSU_MSQ_AOI_AOD_AOU_AOQ_VES(final MaxMiniFilterOSU_MSQ_OPE_OPC_ECI _SQ__OPE_OPC_ECI)
	{
		setLayout(null);
