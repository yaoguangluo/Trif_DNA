...
public class FFTFilterOSU_MSQ_AVQ_ASQ_OVQ_OSQ_VSQ extends OSU_OVQ_OSQ_VSQ {
        ...
        panel = new Panel() {
            ...
            public void paint(Graphics g) {
                ...
                if (lygout.adataFrame.audiofft != null) {
                    ...
                    BufferedImage image = new BufferedImage(lygout.fftmatrix[0].length
                        , lygout.fftmatrix.length, BufferedImage.TYPE_INT_RGB);
