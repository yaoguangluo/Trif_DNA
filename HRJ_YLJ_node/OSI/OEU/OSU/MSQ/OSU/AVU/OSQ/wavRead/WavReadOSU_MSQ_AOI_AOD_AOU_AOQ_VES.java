...
public class WavReadOSU_MSQ_AOI_AOD_AOU_AOQ_VES extends OSU_AOU_AOQ_VES
{
	
	private FileDialog filedialog;
	public WavReadOSU_MSQ_AOI_AOD_AOU_AOQ_VES(final WavReadOSU_MSQ_OPE_OPC_ECI _SQ__OPE_OPC_ECI)
	{
		setLayout(null);
