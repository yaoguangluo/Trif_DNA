...
public class AVItoLYGOSU_MSQ_AOI_AOD_AOU_AOQ_VES extends OSU_AOU_AOQ_VES {
	
	private FileDialog filedialog;
	public AVItoLYGOSU_MSQ_AOI_AOD_AOU_AOQ_VES(final AVItoLYGOSU_MSQ_OPE_OPC_ECI _SQ__OPE_OPC_ECI){
		setLayout(null);
