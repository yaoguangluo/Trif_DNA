...
public class MovieTransferOSU_MSQ_AVQ_ASQ_OVQ_OSQ_VSQ extends OSU_OVQ_OSQ_VSQ {
			...
			public void paint(Graphics g) {
				...
				if (lygout != null) {
					...
					for (int i= 1; i < lines.size(); i++) {
						...
						S_logger.Log.logger.info("" + "linenumber"+i+"codin->"+v.getX1()+"|"+v.getY1()+"|"+v.getX2()+"|"+v.getY2());
