...
public class LYGWriteOSU_MSQ_OPE_OPC_ECI extends OSU_OPE_OPC_ECI {

	public int value= 0;
	public String filepath;
	public LYGWriteOSU_MSQ_OPE_OPC_ECI(){
 	}
	public void run(final LYGWriteOSU_MSQ_AVQ_ASQ_OVQ_OSQ_VSQ _SQ__OVQ_OSQ_VSQ) 
			{
