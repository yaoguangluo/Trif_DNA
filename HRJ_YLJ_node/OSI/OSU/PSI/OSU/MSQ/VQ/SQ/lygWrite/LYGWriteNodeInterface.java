...
public class LYGWriteNodeInterface extends OSU_MCI_MCU_MSI
{	
	public LYGWriteNodeInterface()
 	{
		thisIcon= FastReadProjectFile.getDetaImageIconReader("imageread.jpg", "DetaResources/imgETL/");
		_SQ_OSU_MSQ_OSU_AVQ_ASQ_SQ_VPC_PCS=new String("LYGWrite");
	...
	{
		_SQ__OVQ_OSQ_VSQ=new LYGWriteOSU_MSQ_AVQ_ASQ_OVQ_OSQ_VSQ();
		_SQ__OPE_OPC_ECI=new LYGWriteOSU_MSQ_OPE_OPC_ECI();
		_SQ__AOU_AOQ_VES=new LYGWriteOSU_MSQ_AOI_AOD_AOU_AOQ_VES((LYGWriteOSU_MSQ_OPE_OPC_ECI) _SQ__OPE_OPC_ECI);
		_SQ__AOU_AOQ_VES.config();
		showed=false;
	}
	public void OPE_E(JTextPane jTextPane)  
	{
		((LYGWriteOSU_MSQ_OPE_OPC_ECI) _SQ__OPE_OPC_ECI).run((LYGWriteOSU_MSQ_AVQ_ASQ_OVQ_OSQ_VSQ) _SQ__OVQ_OSQ_VSQ);
	}
	...
	{  
	        _SQ_OSU_MSQ_OSU_MCI_MCU_MSI= new LYGWriteNodeInterface();   
