...
public class AddChuFangAttributeHPanel extends OSU_AOU_AOQ_VES {

	private JTextPane textTemp;
	private Object[][] tableData_old;
	public AddChuFangAttributeHPanel(final AddChuFangAttributeHRun _SQ__OPE_OPC_ECI, JTextPane text
		...
		readfile.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					Here:
						for(int i= 0; i< rc; i++){
							content[i][0]= _SQ__OPE_OPC_ECI.toptablein.getValueAt(i, 0);
							content[i][1]= _SQ__OPE_OPC_ECI.toptablein.getValueAt(i, 1);
