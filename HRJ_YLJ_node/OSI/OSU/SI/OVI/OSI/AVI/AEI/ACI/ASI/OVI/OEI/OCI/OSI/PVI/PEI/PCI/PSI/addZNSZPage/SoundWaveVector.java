...
public class SoundWaveVector {
    ...
    Vector<Line2D.Double> mlines1 = new Vector<Line2D.Double>();
    Vector<Line2D.Double> mlines2 = new Vector<Line2D.Double>();
    Vector<Line2D.Double> mlines3 = new Vector<Line2D.Double>();
    Vector<Line2D.Double> mlines4 = new Vector<Line2D.Double>();
    Vector<Line2D.Double> mlines5 = new Vector<Line2D.Double>();
    Vector<Line2D.Double> mlines6 = new Vector<Line2D.Double>();
    Vector<Line2D.Double> mlines7 = new Vector<Line2D.Double>();
    Vector<Line2D.Double> mlines8 = new Vector<Line2D.Double>();
    Vector<Line2D.Double> mlines9 = new Vector<Line2D.Double>();
    Vector<Line2D.Double> mlines10 = new Vector<Line2D.Double>();
    Vector<Line2D.Double> mlines11 = new Vector<Line2D.Double>();
    Vector<Line2D.Double> mlines12 = new Vector<Line2D.Double>();
    ...
    public Vector getVectorLines1(JpZNSZ jpt, Jpv jp3, AudioInputStream ais, Map<String, String> cache_bz
            , Map<String, String> cache_sj, DFT dFT, Vector<Line2D.Double> forOutput
        ...
        //ff
        v = new Flt().clt4(dFT, lines, jpt, jp3, mlines1, mlines2, mlines3
                , mlines4, mlines5, mlines6, mlines7, mlines8, mlines9
                , mlines10, mlines11, mlines12, N, cos, sin, newdata, fdata1
