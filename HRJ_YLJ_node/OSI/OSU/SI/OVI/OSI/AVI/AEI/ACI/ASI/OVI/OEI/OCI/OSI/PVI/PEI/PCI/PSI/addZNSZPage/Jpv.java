...
public class Jpv extends Panel implements Runnable{
	...
	public void paint1(Vector<Double> mlines) {
		...
		graphics2D.drawString("快速傅里叶虚数导变换", 0+10,  200+120);
		graphics.drawString("快速傅里叶虚数导变换", 0+10,  200+120);
	}
	...
	public void paint2(Vector<Double> mlines) {
		...
		graphics2D.drawString("虚数锐化熵", 0+10,  350+120-20);
		...
		graphics.drawString("虚数锐化熵", 0+10,  350+120-20);
	}
	...
	public void paint3(Vector<Double> mlines) {
		...
		//graphics2D.drawString("导数积分高斯过滤", 0+10,  500+120-20);
	...
	//	graphics.drawString("导数积分高斯过滤", 0+10,  500+120-20);
	}
	...
	public void paint4(Vector<Double> mlines) {
		...
		graphics2D.drawString("库里图基傅立叶", 260+10,  200+120);
		...
		graphics.drawString("库里图基傅立叶", 260+10,  200+120);
	}
	...
	public void paint5(Vector<Double> mlines) {
		...
		graphics2D.drawString("fft锐化", 260+10,  350+120-20);
		...
		graphics.drawString("fft锐化", 260+10,  350+120-20);
	}
	...
	public void paint6(Vector<Double> mlines) {
		...
		graphics2D.drawString("fft高斯", 260+10,  500+120-20);
		...
		graphics.drawString("fft高斯", 260+10,  500+120-20);
	}
	...
	public void paint8(Vector<Double> mlines) {
		...
		graphics2D.drawString("高阶高斯", 520+10,  350+120-20);
		...
		graphics.drawString("高阶高斯", 520+10,  350+120-20);
	}
	...
	public void paint9(Vector<Double> mlines) {
		...
		graphics2D.drawString("离散傅立叶dft", 520+10,  500+120-20);
		...
		graphics.drawString("离散傅立叶dft", 520+10,  500+120-20);
	}
