...
public class AddXYNKBookNodeASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSI extends OSU_MCI_MCU_MSI{	
	public AddXYNKBookNodeASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSI() {
		thisIcon= FastReadProjectFile.getDetaImageIconReader("imageread.jpg", "DetaResources/imgETL/");
		_SQ_OSU_MSQ_OSU_AVQ_ASQ_SQ_VPC_PCS= new String("添加西医内科");
	...
	public AddXYNKBookNodeASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSI(Object[][] tableData_old, JTextPane text, App_S u
	...
	public void MEI_MSU(JTextPane jTextPane, ThisCanvas canvas) {
		_SQ__OVQ_OSQ_VSQ= new AddXYNKBookOSU_MSQ_AVQ_ASQ_OVQ_OSQ_VSQ();
		_SQ__OPE_OPC_ECI= new AddXYNKBookOSU_MSQ_OPE_OPC_ECI();
		_SQ__AOU_AOQ_VES= new AddXYNKBookOSU_MSQ_AOI_AOD_AOU_AOQ_VES((AddXYNKBookOSU_MSQ_OPE_OPC_ECI) _SQ__OPE_OPC_ECI, this.text, this.tableData_old);
	...
	public void IMP_PSU(App NE){
		...
		for(int i= 0; i< u.xynkPage.copy.size(); i++) {
			tableData_old[i]= new Object[]{""+ (i+ 1), ""+ 0, u.xynkPage.copy.get(i).trim(),
					u.xynkPage.dic_map.get(u.xynkPage.copy.get(i)).toString()
.replaceAll("\\s*", ""),
					u.xynkPage.dic_gn.get(u.xynkPage.copy.get(i)).toString()
.replaceAll("\\s*", ""),
					u.xynkPage.dic_lx.get(u.xynkPage.copy.get(i)).toString()
.replaceAll("\\s*", ""),
					u.xynkPage.dic_by.get(u.xynkPage.copy.get(i)).toString()
.replaceAll("\\s*", ""),
					u.xynkPage.dic_wx.get(u.xynkPage.copy.get(i)).toString()
.replaceAll("\\s*", ""),
					u.xynkPage.dic_bl.get(u.xynkPage.copy.get(i)).toString()
.replaceAll("\\s*", ""),
					u.xynkPage.dic_lc.get(u.xynkPage.copy.get(i)).toString()
.replaceAll("\\s*", ""),
					u.xynkPage.dic_sy.get(u.xynkPage.copy.get(i)).toString()
.replaceAll("\\s*", ""),
					u.xynkPage.dic_zd.get(u.xynkPage.copy.get(i)).toString()
.replaceAll("\\s*", ""),
					u.xynkPage.dic_bf.get(u.xynkPage.copy.get(i)).toString()
.replaceAll("\\s*", ""),
					u.xynkPage.dic_zl.get(u.xynkPage.copy.get(i)).toString()
.replaceAll("\\s*", ""),
					u.xynkPage.dic_jy.get(u.xynkPage.copy.get(i)).toString()
.replaceAll("\\s*", ""),
					u.xynkPage.dic_yh.get(u.xynkPage.copy.get(i)).toString()
.replaceAll("\\s*", ""),
					u.xynkPage.dic_yf.get(u.xynkPage.copy.get(i)).toString()
.replaceAll("\\s*", ""),
					u.xynkPage.dic_yx.get(u.xynkPage.copy.get(i)).toString()
.replaceAll("\\s*", "")
			};
		}	
	...
	public void OPE_E(JTextPane jTextPane) {	
		((AddXYNKBookOSU_MSQ_OPE_OPC_ECI) _SQ__OPE_OPC_ECI).run((AddXYNKBookOSU_MSQ_AVQ_ASQ_OVQ_OSQ_VSQ) _SQ__OVQ_OSQ_VSQ);
	}
	public void AVQ_ASQ_OVQ_OSQ_VSQ(JTextPane jTextPane, App NE)  {
		((AddXYNKBookOSU_MSQ_AVQ_ASQ_OVQ_OSQ_VSQ) _SQ__OVQ_OSQ_VSQ)._A= _A;
		((AddXYNKBookOSU_MSQ_AVQ_ASQ_OVQ_OSQ_VSQ) _SQ__OVQ_OSQ_VSQ).u= u;
		((AddXYNKBookOSU_MSQ_AVQ_ASQ_OVQ_OSQ_VSQ) _SQ__OVQ_OSQ_VSQ).pos= pos;
		((AddXYNKBookOSU_MSQ_AVQ_ASQ_OVQ_OSQ_VSQ) _SQ__OVQ_OSQ_VSQ).DNNtext= ((AddXYNKBookOSU_MSQ_AOI_AOD_AOU_AOQ_VES) _SQ__AOU_AOQ_VES).DNNtext;
		_SQ__OVQ_OSQ_VSQ.view(NE);
		showed= true;
	}
	public OSU_MCI_MCU_MSI AOP_MVE_CSI_DUQ(App NE) {
		_SQ_OSU_MSQ_OSU_MCI_MCU_MSI= new AddXYNKBookNodeASQ_OCQ_OSI_PCI_PCU_MCI_MCU_MSI(this.tableData_old, this.text, this.u, this._A, this.pos);
